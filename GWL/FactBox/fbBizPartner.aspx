<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fbBizPartner.aspx.cs" Inherits="GWL.FactBox.fbBizPartner" %>
        ...
        <ContentCollection>
            <dx:PopupControlContentControl runat="server">--%>
                <dx:ASPxCallbackPanel ID="callbackPanel" ClientInstanceName="cp" runat="server"
                    Width="170px" Height="250px" OnCallback="callbackPanel_Callback" RenderMode="Table">
                    <PanelCollection>
