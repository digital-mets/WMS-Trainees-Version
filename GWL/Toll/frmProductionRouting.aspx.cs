...
namespace GWL
{
    public partial class frmProductionRouting : System.Web.UI.Page
    {
        ...
        {
            Session["ConnString"] = "Data Source=(local);Initial Catalog=GEARS-TOLL;Persist Security Info=True;User ID=sa;Password=mets123*;";
            ...
            Session["SKUCode"] = Request.QueryString["docnumber"].ToString();
            SKUCode.Value = Request.QueryString["docnumber"].ToString(); // Set SKUCode Value
            ...
            if (!IsPostBack)
            {
                ...
                //gvStepProcess.KeyFieldName = "SKUCode";
                ...
                //if (Request.QueryString["entry"].ToString() == "N")
                //{
                //    gvStepProcess.SettingsPager.Mode = GridViewPagerMode.ShowAllRecords;
                ...
                DataTable ProductionRouting = new DataTable();
                ...
                ProductionRouting = Gears.RetriveData2("SELECT top 1 SKUCode FROM Production.ProdRouting WHERE SKUCode ='" + Request.QueryString["docnumber"].ToString() + "'", Session["ConnString"].ToString());
                //gvStepProcess.DataSourceID = (ProductionRouting.Rows.Count > 0 ? "odsProductOrder" : "sdsProductOrder");
                ...
                gvStepProcess.EnableCallbackAnimation = false;
            }
        ...
        protected void lookup_Init(object sender, EventArgs e)
        {
            ...
            if (IsCallback && (Request.Params["__CALLBACKID"].Contains("gvStepProcess") && !Request.Params["__CALLBACKID"].Contains("glItemCode") && Request.Params["__CALLBACKID"].Contains(gridLookup.ID)))
            {
        ...
        public void gridView_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (e.Parameters.Contains("SizeCode"))
            {
                ...
                ASPxGridLookup lookup = (ASPxGridLookup)gvStepProcess.FindEditRowCellTemplateControl((GridViewDataTextColumn)gvStepProcess.Columns[8], "glSizeCode");
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.DocNumber = SKUCode.Value.ToString();
            ...
            switch (param)
            {
                ...
                case "SKUCode":
                    ...
                    string paramSKUCode = e.Parameter.Split('|')[1];

                    DataTable SKUCodedata = Gears.RetriveData2("SELECT FullDesc FROM Masterfile.Item WHERE ItemCode='" + paramSKUCode + "'", conn);

                    SKUDescription.Text = SKUCodedata.Rows[0]["FullDesc"].ToString();

                    Session["SKUCode"] = paramSKUCode;
                    sdsStepProcess.SelectCommand = "SELECT SKUCode, StepSequence, A.StepCode, B.Description AS StepDescription, SequenceDay FROM Production.ProdRoutingStep A LEFT JOIN Masterfile.Step B ON A.StepCode = B.StepCode WHERE SKUCode='" + paramSKUCode + "' ORDER BY StepSequence ASC";
                ...
                case "CustomerCode":
                    ...
                    string CustomerCode = e.Parameter.Split('|')[1];

                    DataTable CustomerCodedata = Gears.RetriveData2("SELECT Name FROM Masterfile.BizPartner WHERE BizPartnerCode='" + CustomerCode + "'", conn);
                ...
                case "StepCode":
                    string StepCode = e.Parameter.Split('|')[1];

                    DataTable StepCodedata = Gears.RetriveData2("SELECT Description FROM Masterfile.Item WHERE ItemCode='" + StepCode + "'", conn);
            ...
            switch (e.Parameter)
            {
                case "Add":
                    ...
                    if (error == false)
                    {
                        ...
                        //gvStepProcess.DataSourceID = "odsProductOrder";
        ...
        protected void gvStepProcess_BatchUpdate(object sender, ASPxDataBatchUpdateEventArgs e)
        {
        ...
        protected void StepProcess_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            if (!IsPostBack) return;

            var column = (GridViewDataColumn)gvStepProcess.Columns["StepCode"];
            var lookup = (ASPxGridLookup)gvStepProcess.FindEditRowCellTemplateControl(column, "glStepCode");

            sdsStepProcess.InsertParameters["SKUCode"].DefaultValue = SKUCode.Text;
            sdsStepProcess.InsertParameters["StepSequence"].DefaultValue = e.NewValues["StepSequence"].ToString();
            sdsStepProcess.InsertParameters["StepCode"].DefaultValue = lookup.Text;
            sdsStepProcess.InsertParameters["SequenceDay"].DefaultValue = e.NewValues["SequenceDay"].ToString();
        }

        protected void StepProcess_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            if (!IsPostBack) return;
            ...
            sdsStepProcess.UpdateParameters["USKUCode"].DefaultValue = e.OldValues["SKUCode"].ToString();
            sdsStepProcess.UpdateParameters["UStepSequence"].DefaultValue = e.NewValues["StepSequence"].ToString();
            sdsStepProcess.UpdateParameters["ParamUStepSequence"].DefaultValue = e.OldValues["StepSequence"].ToString();
            sdsStepProcess.UpdateParameters["UStepCode"].DefaultValue = (lookup.Text != "" ? lookup.Text : e.OldValues["StepCode"].ToString());
            sdsStepProcess.UpdateParameters["USequenceDay"].DefaultValue = e.NewValues["SequenceDay"].ToString();
        }

        protected void StepProcess_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            sdsStepProcess.DeleteParameters["DSKUCode"].DefaultValue = e.Values["SKUCode"].ToString();
            sdsStepProcess.DeleteParameters["DStepSequence"].DefaultValue = e.Values["StepSequence"].ToString();
        }
        ...
        protected void detailGrid_BeforePerformDataSelect(object sender, EventArgs e)
        {
            ...
            Session["SKUCode"] = grid.GetMasterRowFieldValues("SKUCode").ToString();
            Session["StepSequence"] = grid.GetMasterRowFieldValues("StepSequence").ToString();
        }
        ...
        protected void Lookup_Init1(object sender, EventArgs e)
        {
            ...
            if (container.Grid.IsEditing) return;
