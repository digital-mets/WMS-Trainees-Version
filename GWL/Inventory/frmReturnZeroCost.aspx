<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReturnZeroCost.aspx.cs" Inherits="GWL.frmReturnZeroCost" %>
...
<head runat="server">
    ...
    <title>MATERIAL RETURN WITH ZERO COST</title>
...
var module = getParameterByName("transtype");
        ...
        if (module === "INVJON")
        {
            ...
            document.title = "Material Return With Zero Cost";
...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function OnInitTrans(s, e) {
            ...
            var BizPartnerCode = glWorkCenter.GetText();
    ...
    <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
        <PanelCollection>
            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxLabel ID="HeaderText" runat="server" Text="Material Return With Zero Cost" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
            </dx:PanelContent>
        </PanelCollection>
    </dx:ASPxPanel>
                                        ...
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    ...
                                                    <dx:LayoutItem Caption="Issuance Number">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glIssuanceNumber" runat="server" DataSourceID="sdsIssuanceNumber" ClientInstanceName="issuanceno"
                                                                    AutoGenerateColumns="False" KeyFieldName="DocNumber" ReadOnly="true" TextFormatString="{0}" Width="170px" >
                                                                    <GridViewProperties>
...
<%--                                                                    <InvalidStyle BackColor="Pink">
                                                    ...
                                                    <dx:LayoutItem Caption="Returned By" Name="ReturnedBy" Visible="false">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtReturnedBy" Visible="false" runat="server" DataSourceID="sdsReturnedBy" 
...
<%--                                                    <dx:LayoutItem Caption="Cost Center">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtCostCenter" runat="server" Width="170px" ReadOnly="false">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>--%>
                                                    ...
                                                    <dx:LayoutItem Caption="Cost Center">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glCostCenter" runat="server" DataSourceID="sdsCostCenter" AutoGenerateColumns="False" KeyFieldName="CostCenterCode" OnLoad="LookupLoad" TextFormatString="{0}" Width="170px">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                                                    <Columns>
                                                                        <dx:GridViewDataTextColumn FieldName="CostCenterCode" Caption="Type" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                                                        </dx:GridViewDataTextColumn>
                                                                    </Columns>
                                                                </dx:ASPxGridLookup>
                                                            </dx:LayoutItemNestedControlContainer>
...
<%--                                                    <dx:LayoutItem Caption="Cost Center">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glCostCenter" runat="server" ClientInstanceName="glCostCenter" Width="170px" DataSourceID="sdsCostCenter" KeyFieldName="CostCenterCode" OnLoad="LookupLoad" TextFormatString="{0}">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
...
<SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                    ...
                                                    <dx:LayoutItem Caption="With Reference">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxCheckBox ID="cbxIsWithReference" runat="server" ClientEnabled="false" ClientInstanceName="cbxIsWithReference">
                                            ...
                                            <dx:LayoutGroup Caption="Samples" ColCount="2" Name="SamplesGroup">
                                                <Items>
                                            ...
                                            <dx:LayoutGroup Caption="JO Materials" ColCount="2" Name="JOMaterialGroup">
                                                <Items>
                                                    ...
                                                    <dx:LayoutItem Caption="Work Center">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glWorkCenter" runat="server" DataSourceID="sdsWorkCenter" ClientInstanceName="glWorkCenter"
                                                                    AutoGenerateColumns="False" KeyFieldName="WorkCenter" TextFormatString="{0}" Width="170px">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                                                    <Columns>
                                                                        <dx:GridViewDataTextColumn FieldName="WorkCenter" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
...
<%--                                                    <dx:LayoutItem Caption="WorkCenter">
                                                    ...
                                                    <dx:LayoutItem Caption="No Alloc">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxCheckBox ID="cbxNoAlloc" runat="server" CheckState="Checked" ReadOnly="true">
                                                                </dx:ASPxCheckBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
...
<PropertiesTextEdit DisplayFormatString="{0:N}"></PropertiesTextEdit>
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False"  Width="770px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="Cost" Name="Cost" ReadOnly="true" ShowInCustomizationForm="True" VisibleIndex="13" Caption="Cost" UnboundType="Decimal">
                                                            <PropertiesSpinEdit Increment="0" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00"  DisplayFormatString="{0:N}" SpinButtons-ShowIncrementButtons="false" AllowMouseWheel ="false" Width="100px" MaxValue="2147483647">
                                                                <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                <ClientSideEvents ValueChanged="autocalculate"></ClientSideEvents>
                                                            </PropertiesSpinEdit>
    ...
    <asp:SqlDataSource ID="sdsWorkCenter" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select WorkCenter,Description from Masterfile.WorkCenter where isnull(DeactivatedBy,'0') != 1" OnInit ="Connection_Init"></asp:SqlDataSource>
     <asp:SqlDataSource ID="sdsCostCenter" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="" OnInit ="Connection_Init"></asp:SqlDataSource>
