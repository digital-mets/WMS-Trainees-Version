...
<dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" ClientInstanceName="factbox" CloseAction="None" 
                                        ...
                                        <Items>
                                            <dx:LayoutItem Caption="Document Number">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtDocNumber" runat="server" Width="170px" AutoCompleteType="Disabled" ClientEnabled="False">
                                                        </dx:ASPxTextBox>
                                            ...
                                            <dx:LayoutItem Caption="Document Date">
                                             ...
                                             <dx:LayoutItem Caption="Old PO Document Number" Name="OldCustomerPONumber">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtOldCustomerPONumber" runat="server" Width="170px" ReadOnly="true" DataSourceID="OldCustomerPONumberlookup" KeyFieldName="CustomerPONo">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                                    ...
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glSODocNumber" runat="server" ClientInstanceName="CINSODocNumber" Width="170px" DataSourceID="SODocNumberlookup" AutoGenerateColumns="False" KeyFieldName="DocNumber" OnLoad="LookupLoad"  TextFormatString="{0}" AutoPostBack="False">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="Document Number" FieldName="DocNumber" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                                      ...
                                                      <%--  <dx:GridViewDataTextColumn FieldName="BulkQty" VisibleIndex="8" Width="80px" UnboundType="Decimal" PropertiesTextEdit-DisplayFormatString="{0:N}" Name="glpBulkQty" ReadOnly="True">
                                                        ...
                                                        <dx:GridViewCommandColumn ButtonType="Image" ShowInCustomizationForm="True" ShowNewButtonInHeader="True" VisibleIndex="1" Width="60px">
                                                         ...
                                                         <dx:GridViewDataSpinEditColumn FieldName="OldQty" Name="OldQty" ReadOnly="true" ShowInCustomizationForm="True" VisibleIndex="8">
                                                            <PropertiesSpinEdit Increment="0" ClientInstanceName="txtOldQty"  SpinButtons-ShowIncrementButtons="false" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}">
                                                            </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>

                                                         <dx:GridViewDataSpinEditColumn FieldName="NewQty" Name="NewQty" ShowInCustomizationForm="True" VisibleIndex="9">
                                                            <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}" MinValue="0" MaxValue="2147483647">
                                                       ...
                                                       <dx:GridViewDataSpinEditColumn FieldName="NewUnitPrice" Name="NewUnitPrice" ShowInCustomizationForm="True" VisibleIndex="11">
                                                           <PropertiesSpinEdit Increment="0" ClientInstanceName="txtNewUnitPrice" SpinButtons-ShowIncrementButtons="false" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}" MinValue="0" MaxValue="2147483647">
                                                           </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
                                                        ...
                                                        <dx:GridViewDataCheckColumn Caption="VAT Liable" FieldName="IsVAT" Name="glpIsVat" ShowInCustomizationForm="True" VisibleIndex="13" ReadOnly="true">
    ...
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select * from Sales.SalesOrderRevisionDetail where DocNumber is null">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsSalesOrderRevisionDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT A.DocNumber,LineNumber,ItemCode,ColorCode,ClassCode,SizeCode,OrderQty AS OldQty,0.00 AS NewQty, UnitPrice AS OldUnitPrice,0.00 AS NewUnitPrice,Unit,IsVAT,VATCode,Rate,DiscountRate,A.Field1,A.Field2,A.Field3,A.Field4,A.Field5,A.Field6,A.Field7,A.Field8,A.Field9 FROM Sales.SalesOrderDetail A INNER JOIN Sales.SalesOrder B ON A.DocNumber = B.DocNumber"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
