...
<head runat="server">
    ...
    <script>
        ...
        var counter = 0;
        var counterNew = 0;
        var deleteAllow = true;
        var IsReset = false;
        var IsNew = true;
        var stack = [];
        var stack2 = [];
        var hasRows = false;
        var ZeroIndexNotYetRemoved = false
        var IsEmptyGrid = false;
        //stack.push(2);       
        //stack.push(5);

        Array.prototype.remove = function () {//seph
        ...
        function ReAssembleStack() {//seph
            var indicies = gv1.batchEditHelper.GetDataRowIndices();
            var str = "";
            for (var i = 0; i < indicies.length; i++) {
                hasRows = true;
                field8 = gv1.batchEditApi.GetCellValue(indicies[i], "Field8");
                field9 = parseFloat(gv1.batchEditApi.GetCellValue(indicies[i], "Field9"));

                stack.push(i);
            }
        }

        function CheckHasRows() {//seph
            var indicies = gv1.batchEditHelper.GetDataRowIndices();
            var str = "";
            for (var i = 0; i < indicies.length; i++) {
                hasRows = true;
        ...
        function ProcessCells(selectedIndex, e, column, s) {
            ...
            if (hasRows) {
                stack.push(0);
                console.log("if (CINspeTerms.GetText() != null){");
                IsNew = false;
                counter++;
            }
            if (counter == 0) {
                CINspeTerms.SetText(temp[11]);
                counter++;
            }
            if (selectedIndex == 0) {
                ...
                if (column.fieldName == "Field9") {
                    s.batchEditApi.SetCellValue(e.visibleIndex, column.fieldName, temp[16]);
                    s.batchEditApi.SetCellValue(e.visibleIndex, "Field8", e.visibleIndex);
                    stack.push(e.visibleIndex);
                ...
                if (counter == 0) {
                    ...
                    //CINspeTerms.SetText(temp[11]);
                    //var i = stack.shift();
                    //CINspeTerms.SetText(s.batchEditApi.GetCellValue(i, "Field9"));
                }
            }
        }
        ...
        function OnCustomClick(s, e) {
            ...
            if (e.buttonID == "Delete") {
                if (entry == "N") {
                    console.log(e.visibleIndex);
                    stack.remove(e.visibleIndex);
                    gv1.DeleteRow(e.visibleIndex);
                    autocalculate();
                    detailautocalculate();
                    var i = stack.shift();
                    CINspeTerms.SetText(s.batchEditApi.GetCellValue(i, "Field9"));
                    if (s.batchEditApi.GetCellValue(0, "ItemCode") == null && s.batchEditApi.GetCellValue(-1, "ItemCode") == null) {
                        counter = 0;
                        IsNew = true;
                    }
                }
                if (entry == "E") {
                    switch (e.visibleIndex) {
                        case 0:
                            console.log(e.visibleIndex);
                            ZeroIndexNotYetRemoved = true;
                            stack.remove(e.visibleIndex);
                            gv1.DeleteRow(e.visibleIndex);
                            counter = 0;
                            IsNew = true;
                        ...
                        case -1:
                            ...
                            break;
                        default:
                            console.log(e.visibleIndex + "AAAAAA");
                            if (ZeroIndexNotYetRemoved) {
                                console.log(e.visibleIndex + "AAAAAA");
                                stack.remove(e.visibleIndex);
                                gv1.DeleteRow(e.visibleIndex);
                                autocalculate();
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False"  Width="850px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ItemCode" Name="glpItemCode" ShowInCustomizationForm="True" VisibleIndex="3" Width="80px">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glItemCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" ClientInstanceName="gl" 
                                                                    KeyFieldName="ItemCode" TextFormatString="{0}" Width="80px" OnInit="glItemCode_Init">
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="OrderQty" Name="glpOrderQty" ShowInCustomizationForm="True" UnboundType="Decimal" VisibleIndex="8">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="BulkQty" Name="glpBulkQty" ShowInCustomizationForm="True" UnboundType="Decimal" VisibleIndex="10" Width="80px">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="UnitPrice" Name="glpUnitPrice" ShowInCustomizationForm="True" VisibleIndex="12">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="DiscountRate" Name="glpDiscountRate" ShowInCustomizationForm="True" VisibleIndex="16">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="Field8" Width="0px" Name="glpDField8" ShowInCustomizationForm="True" VisibleIndex="32" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Field9" Width="0px" Name="glpDField9" ShowInCustomizationForm="True" VisibleIndex="33" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn PropertiesTextEdit-ClientInstanceName="CINspeTerms" FieldName="Version" Name="glpVersion" ShowInCustomizationForm="True" VisibleIndex="34" UnboundType="String" Width="0px">
                                                        </dx:GridViewDataTextColumn>
