...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function ShowSizeHorizontal(s, e) { 
            var hIndex = gv1.batchEditHelper.GetDataItemVisibleIndices();
        ...
        function CallbackSize(s, e) {
            ...
            var query = "";
            var cnt = 0;
            var gvIndex = gv1.batchEditHelper.GetDataItemVisibleIndices();
        ...
        function checkGrid() {
            ...
            for (var w = 0; w < indicies.length; w++) {
                if (gv1.batchEditHelper.IsNewItem(indicies[w])) {
        ...
        function detailautocalculate(s, e) {  
            ...
            setTimeout(function () {
                ...
                for (var a = 0; a < indicies.length; a++) {
                    if (gv1.batchEditHelper.IsNewItem(indicies[a])) {
