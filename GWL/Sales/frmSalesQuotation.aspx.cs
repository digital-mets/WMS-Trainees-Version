    ...
    public partial class frmSalesQuotation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                memTotalQty.Text = _Entity.TotalQty.ToString();
                ...
                speTerms.Text = _Entity.Terms.ToString();
                speExchangeRate.Text = _Entity.ExchangeRate.ToString();
        ...
        protected void WordStatus()
        {
            ...
            mod = Gears.RetriveData2("SELECT TOP 1 RTRIM(LTRIM(Status)) AS Status FROM Sales.Quotation WHERE DocNumber = '" + Request.QueryString["docnumber"].ToString() + "'", Session["ConnString"].ToString());//ADD CONN
        ...
        protected void lookup_Init(object sender, EventArgs e)
        {
            ...
            {
                gridLookup.GridView.CustomCallback += new ASPxGridViewCustomCallbackEventHandler(gridView_CustomCallback);
                if (Session["SQitemID"] != null)
                {
                    if (Session["SQitemID"].ToString() == glIDFinder(gridLookup.ID))
                    {
                        gridLookup.GridView.DataSourceID = "Masterfileitemdetail";
                        Masterfileitemdetail.SelectCommand = Session["SQsql"].ToString();
                        gridLookup.DataBind();
                    }
                }
            }
        ...
        public void gridView_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else
            {
                ...
                ASPxGridView grid = sender as ASPxGridView; 
                Session["SQsql"] = Masterfileitemdetail.SelectCommand;
                grid.DataSourceID = "Masterfileitemdetail";
                grid.DataBind();
            ...
            { 
                ...
                case "CustomerCodeCase":
                    ...
                    if (inb.Count > 0)
                    {
                        ...
                        speTerms.Text = inb[0][3].ToString();
                    }
                    break;
            }
        }
        ...
        protected void gv1_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            _Entity.TotalQty = memTotalQty.Text;
            ...
            _Entity.ExchangeRate = String.IsNullOrEmpty(speExchangeRate.Text) ? 1 : Convert.ToDecimal(speExchangeRate.Text);
