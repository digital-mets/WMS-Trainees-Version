...
namespace GWL
{
    public partial class frmPurchaseOrderRevision : System.Web.UI.Page
    {
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.PODocNumber = gvPODoc.Value.ToString();
        ...
        private DataTable GetSelectedVal()
        {
            ...
            sdsPODetail.FilterExpression = (GroupOperator.Combine(GroupOperatorType.And, selectionCriteria)).ToString();
            Session["RRses"] = sdsPODetail.FilterExpression;
            gv1.DataSourceID = sdsPODetail.ID;
            gv1.DataBind();
            Session["Datatable"] = "1";
        ...
        protected void gv1_Init(object sender, EventArgs e)
        {
            ...
            if (Session["RRses"] != null)
            {
                ...
                sdsPODetail.FilterExpression = Session["RRses"].ToString();
