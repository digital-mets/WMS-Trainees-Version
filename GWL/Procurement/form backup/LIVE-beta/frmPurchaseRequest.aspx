        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Purchase Request" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                            ...
                            <dx:PopupControlContentControl runat="server">
                                <dx:ASPxGridView ID="gvJODetails" runat="server" AutoGenerateColumns="False" Width="900px" OnInit="gvJODetails_Init"
                                            ...
                                            <Columns>
                                                    ...
                                                    <dx:GridViewDataSpinEditColumn Caption="RequestQty" FieldName="RequestQty" Name="RequestQty" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="6" PropertiesSpinEdit-DisplayFormatString="{0:#,0.00;(#,0.00);}"  PropertiesSpinEdit-AllowMouseWheel="False">
                                        ...
                                        <Items>
                                            ...
                                            <dx:LayoutGroup Caption="Information" ColCount="2" RowSpan="2">
                                                <Items>
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glCustomerCode" runat="server" ClientInstanceName="clBizPartnerCode" DataSourceID="CustomerCodelookup" KeyFieldName="BizPartnerCode" TextFormatString="{0}" Width="170px">
                                                                    ...
                                                                    <ClientSideEvents ValueChanged="function (s, e){ cp.PerformCallback('CustomerCodeCase');  e.processOnServer = false; loader.Hide();}"
                                                                        QueryCloseUp="function(s,e){ if(customerload != clBizPartnerCode.GetValue()) { loader.Show();}}" 
                                                                    GotFocus="function(s,e){ customerload = clBizPartnerCode.GetValue()}" />
                                                                </dx:ASPxGridLookup>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    ...
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                                            <dx:ASPxMemo ID="memoRemarks" runat="server" Width="170px">
                                                            </dx:ASPxMemo>
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>  
                                                        ...
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glJONumber" runat="server" Width="170px" DataSourceID="JobOrderNumberLookup" AutoGenerateColumns="False" KeyFieldName="DocNumber" SelectionMode="Multiple" TextFormatString="{0}"
                                                                        ClientInstanceName="CINJONumber">
                                                                    <GridViewProperties>
...
<Settings AutoFilterCondition="Contains"></Settings>
                            ...
                            <dx:LayoutGroup Caption="Purchase Request Detail">
                                <Items>
                                    <dx:LayoutItem Caption="">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="770px" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <PropertiesSpinEdit Increment="0" ClientInstanceName="CINRequestQty" SpinButtons-ShowIncrementButtons="false" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}" >
                                                            <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                        ...
                                                        <PropertiesSpinEdit Increment="0" SpinButtons-ShowIncrementButtons="false" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}">
                                                        <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                            </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
                            ...
                            <dx:LayoutGroup Caption="Purchase Request Service Detail">
                                <Items>
                                    <dx:LayoutItem Caption="">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
        ...
        <dx:ASPxLoadingPanel ID="ASPxLoadingPanel2" runat="server" Text="Calculating..."
            ClientInstanceName="loader" ContainerElementID="gv1" Modal="true">
        <LoadingDivStyle Opacity="0"></LoadingDivStyle>
   </dx:ASPxLoadingPanel>
    </form>
    ...
    <%--Job Order Look Up--%>
    <asp:SqlDataSource ID="JobOrderNumberLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT DocNumber FROM Production.JobOrder WHERE Status = 'N'"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
