...
<%--                                                        <dx:GridViewDataSpinEditColumn Caption="AverageCost" FieldName="AverageCost" ShowInCustomizationForm="True" VisibleIndex="15">
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gvService" runat="server" AutoGenerateColumns="False" Width="770px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Service" FieldName="Service" VisibleIndex="2" Width="140px" Name="glItemCode">
                                                        </dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataCheckColumn FieldName="VatLiable" Name="glpIsVat" ShowInCustomizationForm="True" VisibleIndex="9" ReadOnly="true">
                                                            </dx:GridViewDataCheckColumn>
    ...
    <asp:SqlDataSource ID="PODoc" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="Select DocNumber, SupplierCode, DocDate, Status, Remarks from Procurement.PurchaseOrder with (nolock) where isnull(SubmittedBy,'') !='' and Status = 'N'" OnInit = "Connection_Init"></asp:SqlDataSource>
