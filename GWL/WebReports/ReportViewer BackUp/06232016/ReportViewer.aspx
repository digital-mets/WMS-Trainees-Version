...
<body>
    ...
    <div>
        <dx:ASPxDocumentViewer ID="GWLReportViewer" ClientInstanceName="GWLReportViewer" runat="server" AutoHeight="false" Height="300px"
            ReportTypeName="" OnCustomizeParameterEditors="ASPxDocumentViewer1_CustomizeParameterEditors"
            >
            <ToolbarItems>
...
<%--            <ClientSideEvents ToolbarItemClick="function(s, e) {
        ...
        <script type="text/javascript">
            ...
            function ResizeReport() {
                GWLReportViewer.SetHeight(document.documentElement.clientHeight - 50);
            }
