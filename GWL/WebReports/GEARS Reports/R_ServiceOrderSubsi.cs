...
{
    public partial class R_ServiceOrderSubsi : DevExpress.XtraReports.UI.XtraReport
    {
        public R_ServiceOrderSubsi()
        {
            InitializeComponent();
        ...
        private void R_ServiceOrderSubsi_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            if (report.Parameters["SVODue"].Value.ToString() == "YES")
            {
                ...
                xrTableCell105.Text = "SVO Due Date";
            ...
            {
                xrTableCell106.Text = "SVO Due Date";
