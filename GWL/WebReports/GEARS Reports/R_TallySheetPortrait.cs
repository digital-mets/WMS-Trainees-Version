...
{
    public partial class R_TallySheetPortrait : DevExpress.XtraReports.UI.XtraReport
    {
        public R_TallySheetPortrait()
        {
            InitializeComponent();
        ...
        private void R_SubconLiquidation_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            this.xrLabel1.Text = "From " + Convert.ToDateTime(report.Parameters["DateFrom_Actual"].Value).ToShortDateString() + " to " + Convert.ToDateTime(report.Parameters["DateTo_Actual"].Value).ToShortDateString() + " / JobOrderNo: [Parameters.JobOrderNo] / Status: [Parameters.Status] / SummaryByJO: " + summarybyjo;
        }
