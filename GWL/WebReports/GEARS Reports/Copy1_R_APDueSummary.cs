...
{
    public partial class R_APDueSummary : DevExpress.XtraReports.UI.XtraReport
    {
        public R_APDueSummary()
        {
            InitializeComponent();
        ...
        private void R_APDueSummary_ParametersRequestBeforeShow(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {
        ...
        private void R_APDueSummary_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            xrLabel1.Text = "Cut-Off Date: [Parameters.CutOff!MMMM dd, yyyy] / BusinessSubClass:  " + businesssubclass + " / GLAPAccount:  " + glapaccount + " / Supplier:  " + supplier + " / SummaryBy:  [Parameters.SummaryBy]";
