...
{
    public partial class R_InventoryAdjustment : DevExpress.XtraReports.UI.XtraReport
    {
        // 05 - 23 - 2016 LGE Add Page Header Band.
        public R_InventoryAdjustment()
        {
            InitializeComponent();
        ...
        private void R_InventoryAdjustment_DataSourceDemanded(object sender, EventArgs e)
        {
            XtraReport report = (XtraReport)Report;
