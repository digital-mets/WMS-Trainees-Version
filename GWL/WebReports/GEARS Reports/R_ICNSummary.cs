...
{
    public partial class R_ICNSummary : DevExpress.XtraReports.UI.XtraReport
    {
        public R_ICNSummary()
        {
            InitializeComponent();
        ...
        private void R_ICNSummary_DataSourceDemanded(object sender, EventArgs e)
        {
            XtraReport report = (XtraReport)Report;

            if (String.IsNullOrEmpty(report.Parameters["ExpectedDeliveryDate"].Value.ToString()))
            {
                report.Parameters["ExpectedDeliveryDate"].Value = "01/01/0001";
            }
