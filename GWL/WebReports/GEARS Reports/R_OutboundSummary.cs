...
{
    public partial class R_OutboundSummary : DevExpress.XtraReports.UI.XtraReport
    {
        public R_OutboundSummary()
        {
            InitializeComponent();
        ...
        private void R_OutboundSummary_DataSourceDemanded(object sender, EventArgs e)
        {
            XtraReport report = (XtraReport)Report;
