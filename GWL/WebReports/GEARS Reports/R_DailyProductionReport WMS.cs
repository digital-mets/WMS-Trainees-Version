...
{
    public partial class R_DailyProductionReport2 : DevExpress.XtraReports.UI.XtraReport
    {
        public R_DailyProductionReport2()
        {
            InitializeComponent();
        ...
        private void R_DailyProductionReport_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            if (report.Parameters["ReportSummary"].Value.ToString() == "True")
            {
