...
{
    public partial class R_APDueDetail : DevExpress.XtraReports.UI.XtraReport
    {
        public R_APDueDetail()
        {
            InitializeComponent();
        ...
        private void xrTableCell3_HtmlItemCreated_1(object sender, HtmlEventArgs e)
        {
            e.ContentCell.Style.Add("border-right", "1px solid #000000 !important");  
        }
    }
