...
{
    public partial class R_CashDisbursementSummary : DevExpress.XtraReports.UI.XtraReport
    {
        public R_CashDisbursementSummary()
        {
            InitializeComponent();
        ...
        private void xrTableCell13_HtmlItemCreated(object sender, HtmlEventArgs e)
        {
