...
{
    public partial class R_EmptyLocation : DevExpress.XtraReports.UI.XtraReport
    {
        public R_EmptyLocation()
        {
            InitializeComponent();
        ...
        CustomSqlQuery query = sqlDataSource1.Queries[8] as CustomSqlQuery;
