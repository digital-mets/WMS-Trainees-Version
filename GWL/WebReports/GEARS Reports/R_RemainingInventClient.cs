...
{
    public partial class R_RemainingInventClient : DevExpress.XtraReports.UI.XtraReport
    {
        public R_RemainingInventClient()
        {
            InitializeComponent();
        ...
        private void R_RemainingInvent_DataSourceDemanded(object sender, EventArgs e)
        {
            XtraReport report = (XtraReport)Report;
