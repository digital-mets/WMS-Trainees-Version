...
{
    public partial class R_SubConSum : DevExpress.XtraReports.UI.XtraReport
    {
        public R_SubConSum()
        {
            InitializeComponent();
        ...
        private void R_APDueDetail_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            //Business Sub Class
            string[] paramValues = report.Parameters["StepCode2"].Value as string[];
            ...
            //GL AP Account
            string[] paramValues2 = report.Parameters["JobOrder2"].Value as string[];
            ...
            if (report.Parameters["StepCode2"].Value.ToString() == "System.String[]")
            {
                report.Parameters["StepCode2"].Value = businesssubclass;
            }

            if (report.Parameters["JobOrder2"].Value.ToString() == "System.String[]")
            {
                report.Parameters["JobOrder2"].Value = glapaccount;
            }
