...
{
    public partial class R_DailyProductionReportTEST : DevExpress.XtraReports.UI.XtraReport
    {
        public R_DailyProductionReportTEST()
        {
            InitializeComponent();
        ...
        private void R_InboundSummary_DataSourceDemanded(object sender, EventArgs e)
        {
            XtraReport report = (XtraReport)Report;
