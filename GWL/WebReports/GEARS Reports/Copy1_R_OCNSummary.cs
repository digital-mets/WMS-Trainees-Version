...
{
    public partial class R_OCNSummary : DevExpress.XtraReports.UI.XtraReport
    {
        public R_OCNSummary()
        {
            InitializeComponent();
        ...
        private void R_OCNSummary_DataSourceDemanded(object sender, EventArgs e)
        {
            XtraReport report = (XtraReport)Report;

            if (String.IsNullOrEmpty(report.Parameters["TargetDate"].Value.ToString()))
            {
                report.Parameters["TargetDate"].Value = "01/01/0001";
            }
