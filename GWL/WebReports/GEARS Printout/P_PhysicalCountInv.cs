...
{
    public partial class P_PhysicalCountInv : DevExpress.XtraReports.UI.XtraReport
    {
        public P_PhysicalCountInv()
        {
            InitializeComponent();
        ...
        private void P_PhysicalCountInv_AfterPrint(object sender, EventArgs e)
        {
            //After();
        }
