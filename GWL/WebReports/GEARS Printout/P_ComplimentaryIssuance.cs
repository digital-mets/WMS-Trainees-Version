...
{
    public partial class P_ComplimentaryIssuance : DevExpress.XtraReports.UI.XtraReport
    {
        public P_ComplimentaryIssuance()
        {
            InitializeComponent();
        ...
        private void P_ComplimentaryIssuance_AfterPrint(object sender, EventArgs e)
        {
            //After();
        }
