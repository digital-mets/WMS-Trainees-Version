...
{
    public partial class P_FGDailyDispatchingMonitoring : DevExpress.XtraReports.UI.XtraReport
    {
        public P_FGDailyDispatchingMonitoring()
        {
            InitializeComponent();
            ...
            report.Parameters["ProductionDate"].Value = today.ToShortDateString();
        }
