...
{
    public partial class P_OfficeIssuance : DevExpress.XtraReports.UI.XtraReport
    {
        public P_OfficeIssuance()
        {
            InitializeComponent();
        ...
        private void P_OfficeIssuance_AfterPrint(object sender, EventArgs e)
        {
            //After();
        }
