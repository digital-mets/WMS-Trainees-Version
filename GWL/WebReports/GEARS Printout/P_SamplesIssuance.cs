...
{
    public partial class P_SamplesIssuance : DevExpress.XtraReports.UI.XtraReport
    {
        public P_SamplesIssuance()
        {
            InitializeComponent();
        ...
        private void P_SamplesIssuance_AfterPrint(object sender, EventArgs e)
        {
            //After();
        }
