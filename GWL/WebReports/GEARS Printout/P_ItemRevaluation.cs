...
{
    public partial class P_ItemRevaluation : DevExpress.XtraReports.UI.XtraReport
    {
        public P_ItemRevaluation()
        {
            InitializeComponent();
        ...
        private void P_ItemRevaluation_AfterPrint(object sender, EventArgs e)
        {
            //After();
        }
