<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmFSData.aspx.cs" Inherits="GWL.frmFSData" %>
...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function ValidateTotal(s, e) { // Validation of Year
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="F/S Data" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="Main" ColCount="2">
                                        <Items>
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxComboBox ID="cbxMonth" Width="170px" runat="server" OnLoad="Combobox_Load" >
                                                            ...
                                                            <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorText="Please select a valid month">
                                                                <RequiredField IsRequired="True" />
                                                            </ValidationSettings>
                                                            <InvalidStyle BackColor="Pink">
                                                            </InvalidStyle>
                                            ...
                                            <dx:LayoutItem Caption="Asset" ColSpan="1">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtAsset" ClientInstanceName="txtAsset" runat="server"
                                                            DisplayFormatString="#,0.00" HorizontalAlign="Right" NullText="0.00" Number="0.00" 
                                                            OnLoad="SpinEdit_Load" Width="170px">
                                                            <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorText="Asset must be equal to sum of Liability and Equity">
                                                            </ValidationSettings>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
