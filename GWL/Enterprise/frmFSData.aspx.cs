...
namespace GWL
{
    public partial class frmFSData : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["entry"].ToString() != "N")
                {
                    ...
                    if (intResult == 0)
                    {
                        ...
                        cbxMonth.SelectedItem = cbxMonth.Items.FindByValue(_Entity.Month.ToString());
        ...
        {
            if (Convert.ToDecimal(txtAsset.Text) != Convert.ToDecimal(txtLiability.Text)+Convert.ToDecimal(txtEquity.Text))
            {
                txtAsset.IsValid = false;
                txtLiability.IsValid = false;
                txtEquity.IsValid = false;
