<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreditLine.aspx.cs" Inherits="GWL.frmCreditLine" %>
...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function ValidateAmount(s, e) { // Validation Loan Amount
            e.isValid = false;
            if (e.value <= 0) {
                isValid = false;
            }
...
<body style="height: 565px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="Credit Line" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="Main" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Bank Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="aglBankCode" runat="server" Onload="Lookup_Load" Width="170px"
                                                            DataSourceID="sdsBankCode" KeyFieldName="BankCode" TextFormatString="{0}">
                                                            <ClearButton Visibility="True" ></ClearButton>
                                                            <Columns>
                                                                <dx:GridViewDataTextColumn FieldName="BankCode" Width="50px" /> 
                                                            ...
                                                            <ValidationSettings ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True"  ErrorText="Please select an existing bank"/>
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="Company" ColSpan="2" Width="400px">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="aglCompanyCode" runat="server" Onload="Lookup_Load" Width="280px"
                                            ...
                                            <dx:LayoutItem Caption="Loan Type">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtLoanType" runat="server" OnLoad="Textbox_Load" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                            <dx:LayoutItem Caption="Max. Loan Amount">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtMaxLoanAmount" runat="server"
                                                            DisplayFormatString="#,0.00" HorizontalAlign="Right" NullText="0.00" Number="0.00" 
                                                            OnLoad="SpinEdit_Load" Width="170px">
                                                            <ClientSideEvents Validation="ValidateAmount" /> 
                                                            <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorText="Loan amount must be greater than zero">
                                                            </ValidationSettings>
                                                            <InvalidStyle BackColor="Pink" />
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
        ...
        <dx:ASPxPopupControl ID="DeleteControl" runat="server" Width="250px" Height="100px" HeaderText="Warning!"
            ...
            <ContentCollection>
                <dx:PopupControlContentControl runat="server">
                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Are you sure you want to delete this record?" />
                    <table>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
    ...
    <asp:SqlDataSource ID="sdsBankCode" runat="server" SelectCommand="SELECT BankCode, Description FROM Masterfile.Bank WHERE IsNull(IsInactive,0) = 0" OnInit="Connection_Init"></asp:SqlDataSource>
    <!--#endregion-->
</body>
</html>
