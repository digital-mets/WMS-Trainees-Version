...
namespace GWL
{
    public partial class frmBankLoan : System.Web.UI.Page
    {
        Boolean error = false;      //Boolean for grid validation
        Boolean view = false;       //Boolean for view state

        MasterBankLoan _Entity = new MasterBankLoan();
            ...
            if (!IsPostBack)
            {
                ...
                switch (Request.QueryString["entry"].ToString())
                {
                    ...
                    case "E":
                        ...
                        dteReferenceDate.ClientEnabled = false;
                        break;
                    case "V":
                ...
                {
                    dteReferenceDate.Value = Convert.ToDateTime(Request.QueryString["docnumber"], new System.Globalization.CultureInfo("en-US"));

                    odsDetail.SelectParameters["_ReferenceDate"].DefaultValue = Convert.ToDateTime(dteReferenceDate.Value).ToString("yyyy-MM-dd");
        ...
        {
            Entity.MasterBankLoan _entity = e.InputParameters["_Record"] as Entity.MasterBankLoan;
            _entity.ReferenceDate = Convert.ToDateTime(dteReferenceDate.Value);
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            switch (e.Parameter)
            {
                ...
                case "Delete":
                    ...
                    break;
                case "ConfDelete":
                    _Entity.DeleteRecords(Convert.ToDateTime(dteReferenceDate.Value).ToString("yyyy-MM-dd"),Session["userid"].ToString());
                    cp.JSProperties["cp_close"] = true;
