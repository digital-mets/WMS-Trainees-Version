...
namespace GWL
{
    public partial class frmCreditLine : System.Web.UI.Page
    {
        Boolean view = false;       //Boolean for view state

        MasterCreditLine _Entity = new MasterCreditLine();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["entry"].ToString() != "N")
                {
                    ...
                    if (intResult == 0)
                    {
                        aglBankCode.Value = _Entity.BankCode;
                        aglCompanyCode.Value = _Entity.CompanyCode;
                        txtLoanType.Text = _Entity.LoanType;
                        txtMaxLoanAmount.Value = _Entity.MaxLoanAmount;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.BankCode = aglBankCode.Text.ToUpper();
            _Entity.CompanyCode = (aglCompanyCode.Value == null) ? "" : aglCompanyCode.Value.ToString();
            _Entity.LoanType = txtLoanType.Text.ToUpper();
            _Entity.MaxLoanAmount = Convert.ToDecimal(txtMaxLoanAmount.Text);
