        ...
        (t.prototype.initMenu = function () {
            ...
            (t.prototype.initSearch = function () {
                ...
                a(document).on("click", function (t) {
                    return 0 === a(t.target).closest("#search-dropdown").length && a("#search-dropdown").removeClass("d-block"), !0;
                }),
        ...
        (t.prototype._selectOptionsFromConfig = function () {
            ...
            if (t) {
                ...
                t.isBoxed ? a("#boxed-check").prop("checked", !0) : a("#fluid-check").prop("checked", !0),
                    ...
                    t.isDarkModeEnabled || (a("#light-mode-check").prop("checked", !0), "vertical" === t.layout && a("input[type=radio][name=theme]").prop("disabled", !1)),
                    t.isDarkModeEnabled && (a("#dark-mode-check").prop("checked", !0), "vertical" === t.layout && a("input[type=radio][name=theme]").prop("disabled", !1));
            }
        }),
            ...
            (t.prototype.init = function () {
                ...
                a(document).on("click", ".right-bar-toggle", function () {
                    ...
                    a("input[type=radio][name=color-scheme-mode]").change(function () {
                        switch (a(this).val()) {
                            case "light":
                                a.App.deactivateDarkMode(), a.App.activateDefaultSidebarTheme(), a("#default-check").prop("checked", !0), a("input[type=radio][name=theme]").prop("disabled", !1);
                                break;
                            case "dark":
            ...
            (t.prototype.initSyntaxHighlight = function () {
                e(document).ready(function (t) {
                    document.querySelectorAll("pre span.escape").forEach(function (t, e) {
                        for (var a = 1 / 0, i = (t.classList.contains("escape"), t.innerText).replace(/^\n/, "").trimRight().split("\n"), o = 0; o < i.length; o++) i[o].trim() && (a = Math.min(i[o].search(/\S/), a));
                        for (var n = [], o = 0; o < i.length; o++) n.push(i[o].replace(new RegExp("^ {" + a + "}", "g"), ""));
                        t.innerText = n.join("\n");
                    }),
