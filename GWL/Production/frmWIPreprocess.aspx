<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWIPreprocess.aspx.cs" Inherits="GWL.frmPreProductionOut" %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="WIP Reprocess" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                                      <dx:LayoutItem Caption="Reprocess No." Name="DocNumber" >
                                           ...
                                           <dx:LayoutItem Caption="Year:">
                                            ...
                                            <dx:LayoutItem Caption="Re-Process Step:">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox6" runat="server"  OnLoad="TextboxLoad"  Width="170px" Text="BAADER">
                                            ...
                                            <dx:LayoutItem Caption="Re-Process Machine:">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox11" runat="server"  OnLoad="TextboxLoad"  Width="170px" Text="BAADER">
                                            ...
                                            <dx:LayoutItem Caption="Re-Process Scrap code:">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox12" runat="server"  OnLoad="TextboxLoad"  Width="170px" Text="RS-GR-0001">
                                            ...
                                            <dx:LayoutItem Caption="Re-Process Qty(KG):">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox13" runat="server"  OnLoad="TextboxLoad"  Width="170px" >
