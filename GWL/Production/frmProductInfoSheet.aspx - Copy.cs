    ...
    public partial class frmProductInfoSheet : System.Web.UI.Page
    {
        ...
        protected void AddColumns()
        {
            ...
            foreach (DataRow dt in getSizeCode.Rows)
            {
                ...
                text.PropertiesTextEdit.ClientSideEvents.ValueChanged = "computesizesvalue";
        ...
        protected void SetColor()
        {
            ...
            {
                cp.JSProperties["cp_colorerror"] = "Base size not found in size list.";
            }
        ...
        public void ProductCategory_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                ProductCategoryLookup.SelectCommand = "SELECT ProductCategoryCode, Description FROM Masterfile.ProductCategory WHERE ISNULL(IsInactive,0)=0 AND ISNULL(ProductCategoryCode,'')!='' AND ItemCategoryCode = '" + productcategorycode + "' ";
