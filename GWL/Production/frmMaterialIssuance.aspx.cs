...
namespace GWL
{
    public partial class frmMaterialIssuance : System.Web.UI.Page
    {
        ...
        Entity.MaterialIssuance _Entity = new MaterialIssuance();//Calls entity KPIRef
        Entity.MaterialIssuance.MaterialIssuanceDetail _EntityDetail = new MaterialIssuance.MaterialIssuanceDetail();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sdsReferenceDetail.SelectCommand = "SELECT DocNumber,A.ItemCode,RequestQty,A.UnitBase,ProductCategoryCode,BatchNumber "+
            ...
            if (!IsPostBack)
            {
                switch (Request.QueryString["entry"].ToString())
                {
                    case "N":
                        updateBtn.Text = "Add";
                        txtTransactionType.Text = "ISSUANCE";
                        break;
                    case "E":
                ...
                speQty.Text= _Entity.TotalQty.ToString();
                //spePrice.Value= _Entity.Price.ToString();
                //speAmount.Value = _Entity.Amount.ToString();

                memoremarks.Text = _Entity.Remarks.ToString();
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.IssuedTo = aglIssuedTo.Text;
            _Entity.TotalQty = Convert.ToDecimal(Convert.IsDBNull(speQty.Value) ? "0" : speQty.Value);
        ...
        private DataTable GetSelectedVal()
        {
            ...
            CriteriaOperator selectionCriteria = new InOperator(aglRefNum.KeyFieldName, selectedValues);

            sdsReferenceDetail.FilterExpression = (GroupOperator.Combine(GroupOperatorType.And, selectionCriteria)).ToString();
            Session[Request.QueryString["docnumber"].ToString() + "materialissuance"] = sdsReferenceDetail.FilterExpression;
            gvRefC.DataSource = sdsReferenceDetail;
            gvRefC.DataBind();
