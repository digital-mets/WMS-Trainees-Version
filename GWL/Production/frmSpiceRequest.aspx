<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSpiceRequest.aspx.cs" Inherits="GWL.frmSpiceRequest" %>
...
<head runat="server">
    ...
    <script src="../js/Production/SpiceRequest.js" type="text/javascript"></script>
    <script src="../js/keyboardNavi.js" type="text/javascript"></script>
    <title>Spice Request</title>
    ...
    <dx:ASPxPanel ID="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
        <PanelCollection>
            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxLabel runat="server" ID="FormTitle" Text="Spice Request" Font-Bold="true" ForeColor="White" Font-Size="X-Large"></dx:ASPxLabel>
            </dx:PanelContent>
        </PanelCollection>
    </dx:ASPxPanel>
...
<LoadingPanelStyle Border-BorderStyle="None" BackColor="Transparent"></LoadingPanelStyle>
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="400px" Width="900px" style="margin-left: -20px" SettingsAdaptivity-AdaptivityMode="SingleColumnWindowLimit" SettingsAdaptivity-SwitchToSingleColumnAtWindowInnerWidth="800">
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Spice Request Number">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtSRNumber" ClientInstanceName="txtSRNumber" runat="server" Width="170px"  AutoCompleteType="Disabled" ClientEnabled="False">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem Caption="Requesting Department Company">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtRequestingDeptCompany" ClientInstanceName="txtRequestingDeptCompany" runat="server" Width="170px"  AutoCompleteType="Disabled" ClientEnabled="False">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem Caption="Warehouse Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup runat="server" Width="170px" ID="ctl271">
                                                            <GridViewProperties>
                                            ...
                                            <dx:LayoutItem Caption="Customer Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup runat="server" Width="170px" ID="ctl281">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                <Settings ShowFilterRow="True" />
                                            ...
                                            <dx:LayoutItem Caption="Required Loading Time">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtRequiredLoadingTime" runat="server" OnLoad="TextboxLoad" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem Caption="Type of Shipment">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtShipmentType" runat="server" OnLoad="TextboxLoad" Width="170px" Enabled="false">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem>
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox Visible="false" ID="txtItemCode" runat="server" OnLoad="TextboxLoad" Width="170px" Enabled="false">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutGroup Caption="Spice Request Detail" Name="SpiceRequestDetail">
                                                <Items>
                                                    <dx:LayoutItem Caption="">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                
                                                                <dx:ASPxGridView id="gv1" runat="server" Width="770px" >
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="Manufacturing Date" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="2" Width="120px">
                                                                            <PropertiesTextEdit ConvertEmptyStringToNull="False">
                                                                            </PropertiesTextEdit>
                                                                        </dx:GridViewDataTextColumn>
    ...
    <!--<asp:ObjectDataSource ID="odsDetail" runat="server" DataObjectTypeName="Entity.SpiceRequest+SpiceRequestDetail" SelectMethod="getdetail" UpdateMethod="UpdateSpiceRequestDetail" TypeName="Entity.SpiceRequest+SpiceRequestDetail" DeleteMethod="DeleteSpiceRequestDetail" InsertMethod="AddSpiceRequestDetail">
        <SelectParameters>
    ...
    -->
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select * from Production.SpiceRequestDetail where DocNumber is null"   OnInit = "Connection_Init">
    </asp:SqlDataSource>
