<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWorkOrderAmendment.aspx.cs" Inherits="GWL.frmWorkOrderAmendment" %>
...
<title>Work Order Amendment</title>
...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function gridView_EndCallback(s, e) {//End callback function if (s.cp_success) {
            ...
            if (s.cp_WOP) {
                delete (s.cp_WOP);
                alert('New work order price is not within the range of rates set for the step.');
            }
...
<form id="form1" runat="server" class="Entry">
    <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel ID="HeaderText" runat="server" Text="Work Order Amendment" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="General">
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    ...
                                                    <dx:LayoutItem Caption="Reference JO" RequiredMarkDisplayMode="Required">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="aglReferenceJO" runat="server" AutoGenerateColumns="False" DataSourceID="sdsReferenceJO" KeyFieldName="DocNumber;RecordID" 
                                                                    OnLoad="LookupLoad" TextFormatString="{1}" Width="170px" ClientInstanceName ="aglRefJO">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowSelectSingleRowOnly="True" />
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                                                    <Columns>
                                                                        <dx:GridViewDataTextColumn Caption="Record ID" FieldName="RecordID" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0" Width="100">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn Caption="Document Number" FieldName="DocNumber" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataDateColumn FieldName="DocDate" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="2" Width="100px">
                                                                        ...
                                                                        <dx:GridViewDataTextColumn Caption="Step Code" FieldName="StepCode" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="3">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="Sequence" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="4">
                                                                            <PropertiesTextEdit DisplayFormatString="{0:N}">
                                                                            </PropertiesTextEdit>
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn Caption="Work Center" FieldName="WorkCenter" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="5">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="INQty" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="6">
                                                                            <PropertiesTextEdit DisplayFormatString="{0:N}">
                                                                            </PropertiesTextEdit>
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="WorkOrderPrice" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="7">
                                                                            <PropertiesTextEdit DisplayFormatString="{0:N}">
                                                                            </PropertiesTextEdit>
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="WorkOrderQty" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="8">
                                                                            <PropertiesTextEdit DisplayFormatString="{0:N}">
                                                                            </PropertiesTextEdit>
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataDateColumn FieldName="WorkOrderDate" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="9" Width="100px">
                                                                            <PropertiesDateEdit AllowMouseWheel="False" DisplayFormatString="MM/dd/yyyy">
                                                                                <DropDownButton ClientVisible="False" Enabled="False">
                                                                                </DropDownButton>
                                                                            </PropertiesDateEdit>
                                                                        ...
                                                                        <dx:GridViewDataDateColumn FieldName="DateCommitted" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="10" Width="100px">
                                                                            <PropertiesDateEdit AllowMouseWheel="False" DisplayFormatString="MM/dd/yyyy">
                                                                                <DropDownButton ClientVisible="False" Enabled="False">
                                                                                </DropDownButton>
                                                                            </PropertiesDateEdit>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="Status" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="11" Width="200px">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataDateColumn FieldName="DateCompleted" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="12" Width="100px">
                                                                            <PropertiesDateEdit AllowMouseWheel="False" DisplayFormatString="MM/dd/yyyy">
                                                                                <DropDownButton ClientVisible="False" Enabled="False">
                                                                                </DropDownButton>
                                                                            </PropertiesDateEdit>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="Remarks" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="13" Width="200px">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                    </Columns>
                                                    ...
                                                    <dx:LayoutItem Caption="Step">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtStep" runat="server" Width="170px" ReadOnly="true" >
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    ...
                                                    <%--<dx:LayoutItem Caption="Step" RequiredMarkDisplayMode="Required">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="aglStep" runat="server" DataSourceID="sdsSteps" AutoGenerateColumns="False" KeyFieldName="StepCode" 
                                                                    OnLoad="LookupLoad" TextFormatString="{0}" Width="170px" OnInit="aglStep_Init">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                                        ...
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <dx:ASPxTextBox ID="txtRecordID" runat="server" ClientInstanceName="txtRecordID" ClientEnabled="false" ClientVisible="false" Width="170px">
                                                                        </dx:ASPxTextBox>
                                                                    </tr>
                                                                </table>
                                                            </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutGroup Caption="Amendment Details" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Old Work Order Qty">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxSpinEdit ID="speOldWorkOrderQty" runat="server" Width="170px" Number="0.00" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00"  
                                                                             DisplayFormatString="{0:N}" SpinButtons-ShowIncrementButtons="false" ClientInstanceName ="speOldWorkOrderQty" AllowMouseWheel="False"
                                                                             MaxValue="9999999999" MinValue ="0.1" ReadOnly="true">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="New Work Order Qty">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxSpinEdit ID="speNewWorkOrderQty" runat="server" Width="170px" Number="0.00" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00"  
                                                                             DisplayFormatString="{0:N}" SpinButtons-ShowIncrementButtons="false" ClientInstanceName ="speNewWorkOrderQty" AllowMouseWheel="False"
                                                                             MaxValue="9999999999" MinValue ="0.1">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Old Work Order Price">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxSpinEdit ID="speOldWorkOrderPrice" runat="server" Width="170px" Number="0.00" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00"  
                                                                             DisplayFormatString="{0:N}" SpinButtons-ShowIncrementButtons="false" ClientInstanceName ="speOldWorkOrderPrice" AllowMouseWheel="False"
                                                                             MaxValue="9999999999" MinValue ="0.1" ReadOnly="true">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                    ...
                                                    <dx:LayoutItem Caption="New Work Order Price">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxSpinEdit ID="speNewWorkOrderPrice" runat="server" Width="170px" Number="0.00" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00"  
                                                                             DisplayFormatString="{0:N}" SpinButtons-ShowIncrementButtons="false" ClientInstanceName ="speNewWorkOrderPrice" AllowMouseWheel="False"
                                                                             MaxValue="9999999999" MinValue ="0.1">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                    <ClientSideEvents LostFocus ="function(s,e){cp.PerformCallback('CallbackWOP');}" />
                                                                </dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Old Commitment Date">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit ID="dtpOldCommitment" runat="server" Width="170px" ReadOnly="true" DropDownButton-ClientVisible="false">
                                                                </dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="New Commitment Date">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit ID="dtpNewCommitment" runat="server" OnInit="dtpNewCommitment_Init" Width="170px" OnLoad="Date_Load">
                                                                    <ClientSideEvents Validation="OnValidation" />
                                                                    <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                        <RequiredField IsRequired="True" />
                                                                    </ValidationSettings>
                                                    ...
                                                    <dx:LayoutItem Caption="Old WO Date">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit ID="dtpOldWODate" runat="server" Width="170px" ReadOnly="true" DropDownButton-ClientVisible="false">
                                                                </dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="New WO Date">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit ID="dtpNewWODate" runat="server" OnInit="dtpNewWODate_Init" Width="170px" OnLoad="Date_Load">
                                                                    <ClientSideEvents Validation="OnValidation" />
                                                                    <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                        <RequiredField IsRequired="True" />
                                                                    </ValidationSettings>
    ...
    <asp:SqlDataSource ID="sdsReferenceJO" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT RecordID, A.DocNumber, A.StepCode, A.Sequence, A.WorkCenter, A.INQty, A.WorkOrderPrice, A.WorkOrderQty, A.WorkOrderDate,
        A.DateCommitted, DocDate, Status, DateCompleted, Remarks FROM Production.JOStepPlanning A INNER JOIN Production.JobOrder B ON A.DocNumber = B.DocNumber WHERE B.Status IN ('N','W') AND ISNULL(ProdSubmittedBy,'') != '' AND ISNULL(A.PreProd,0) = 0 ORDER BY A.DocNumber, DocDate, RecordID ASC" OnInit ="Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsReasons" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT DISTINCT ReasonCode AS Code, Description FROM Masterfile.Reason WHERE ISNULL(IsInactive,0) = 0 AND TransactionType = 'PRDWOA'" OnInit ="Connection_Init"></asp:SqlDataSource>  
    <!--#endregion-->
</body>
</html>
