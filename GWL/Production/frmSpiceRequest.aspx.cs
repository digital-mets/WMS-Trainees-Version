...
namespace GWL
{
    public partial class frmSpiceRequest : System.Web.UI.Page
    {
        ...
        Entity.SpiceRequest _Entity = new SpiceRequest();
        Entity.SpiceRequest.SpiceRequestDetail _EntityDetail = new SpiceRequest.SpiceRequestDetail();
        string access1 = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            /*
            _Entity.getdata(txtSRNumber.Text, Session["ConnString"].ToString()); //Method for retrieving data from entity

            DataTable checkCount = _EntityDetail.getdetail(txtSRNumber.Text, Session["ConnString"].ToString());
            ...
            */
            ...
            DataTable checkCount = _EntityDetail.getdetail(DocNumber.Text, Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.SRNumber = txtSRNumber.Text;
            _Entity.DocDate = dtpDocDate.Text;

            _Entity.RequestingDeptCompany = txtRequestingDeptCompany.Text;
            //_Entity.WarehouseCode = glPayTo.Text;
            ...
            switch (param) //Renats
            {
                ...
                case "Add":
                    ...
                    if (error == false)
                    {
                        ...
                        odsDetail.SelectParameters["DocNumber"].DefaultValue = txtSRNumber.Text;
                        gv1.UpdateEdit();
                        //Validate(); Post();
                ...
                case "Update":
                    if (error == false)
                    {
                        ...
                        strError = Functions.Submitted(_Entity.SRNumber, "Production.SpiceRequest", 1, Session["ConnString"].ToString());//NEWADD factor 1 if submit, 2 if approve
