...
var module = getParameterByName("transtype");
       ...
       function OnUpdateClick(s, e) { //Add/Edit/Close button function
           ...
           var indicies = CINSizeDetail1.batchEditHelper.GetDataItemVisibleIndices();
           for (var i = 0; i < indicies.length; i++) {
               if (CINSizeDetail1.batchEditHelper.IsNewItem(indicies[i])) {
                   CINSizeDetail1.batchEditApi.ValidateRow(indicies[i]);
               }
               else {
                   var key = CINSizeDetail1.GetRowKey(indicies[i]);
                   if (CINSizeDetail1.batchEditHelper.IsDeletedItem(key))
       ...
       function computestepprice(s, e) {
           ...
           setTimeout(function () { //New Rows
               var indicies = CINgvStepDetail.batchEditHelper.GetDataItemVisibleIndices();

               for (var i = 0; i < indicies.length; i++) {
                   if (CINgvStepDetail.batchEditHelper.IsNewItem(indicies[i])) {
                       ...
                       if (CINgvStepDetail.batchEditHelper.IsDeletedItem(key)) {
                           console.log("deleted row " + indicies[i]);
       ...
       function BOMandCOSTING(s, e) {
           ...
           setTimeout(function () { //New Rows
               var indicies = CINgvStyleDetail.batchEditHelper.GetDataItemVisibleIndices();

               for (var i = 0; i < indicies.length; i++) {
                   if (CINgvStyleDetail.batchEditHelper.IsNewItem(indicies[i])) {
                       ...
                       if (CINgvStyleDetail.batchEditHelper.IsDeletedItem(key)) {
                           console.log("deleted row " + indicies[i]);
                           //gv1.batchEditHelper.EndEdit();
                       }
                       else {
       ...
       function computeTotalItemCost1(s, e) {
           ...
           setTimeout(function () { //New Rows
               //// -- -- -- -- -- STYLE -- -- -- -- -- ////
               var Styleindicies = CINgvStyleDetail.batchEditHelper.GetDataItemVisibleIndices();
               for (var i = 0; i < Styleindicies.length; i++) {
                   if (CINgvStyleDetail.batchEditHelper.IsNewItem(Styleindicies[i])) {
               ...
               //// -- -- -- -- -- END OF STYLE -- -- -- -- -- ////
               //// -- -- -- -- -- STEPS -- -- -- -- -- ////
               var Stepindicies = CINgvStepDetail.batchEditHelper.GetDataItemVisibleIndices();
               for (var i = 0; i < Stepindicies.length; i++) {
                   if (CINgvStepDetail.batchEditHelper.IsNewItem(Stepindicies[i])) {
       ...
       function autoToleranceNew(s, e) {
           ...
           setTimeout(function () {
               ...
               var indicies = CINgvGradeBracket.batchEditHelper.GetDataItemVisibleIndices();
               for (var i = 0; i < indicies.length; i++) {
                   var key = CINgvGradeBracket.GetRowKey(indicies[i]);
                   if (!CINgvGradeBracket.batchEditHelper.IsDeletedItem(key)) {
