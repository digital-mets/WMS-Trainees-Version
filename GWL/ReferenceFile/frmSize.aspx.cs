...
namespace GWL
{
    public partial class frmSize : System.Web.UI.Page
    {
        ...
        Entity.Size _Entity = new Size();//Calls entity odsHeader
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtSize.Value = Request.QueryString["docnumber"].ToString(); //sets docnumber from session

                    _Entity.getdata(txtSize.Text, Session["ConnString"].ToString()); //ADD CONN //Method for retrieving data from entity

                    txtSize.Text = _Entity.SizeCode;
                    txtDesc.Text = _Entity.Description;

                    cboType.Value = _Entity.SizeType;
                    txtSort.Value = _Entity.SortOrder;
        ...
        private void Validate()
        {
            ...
            //string strresult =GWarehouseManagement.Size_Validate(gparam);
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.SizeType = cboType.Value.ToString();
            _Entity.SortOrder = txtSort.Text;
        ...
        protected void Connection_init(object sender, EventArgs e)
        {
            ...
            SizeType.ConnectionString = Session["ConnString"].ToString();
        }
    }
}