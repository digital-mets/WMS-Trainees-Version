<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSilhouette.aspx.cs" Inherits="GWL.frmSilhouette" %>
...
<head runat="server">
    ...
    <title>Silhouette MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Silhouette" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
