<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmGenericLookup.aspx.cs" Inherits="GWL.frmGenericLookup" %>
                                    ...
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtCode" runat="server" AutoCompleteType="Disabled" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
