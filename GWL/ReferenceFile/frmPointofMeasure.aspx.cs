...
namespace GWL
{
    public partial class frmPointofMeasure : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.POM _Entity = new POM();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    chkIsMajor.Value = _Entity.IsMajor;
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select POMCode from MasterFile.POM where POMCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.POMCode = txtCode.Text;
            _Entity.IsMajor = Convert.ToBoolean(chkIsMajor.Value);
