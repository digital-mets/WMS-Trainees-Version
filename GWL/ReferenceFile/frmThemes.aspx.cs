...
namespace GWL
{
    public partial class frmThemes : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.Themes _Entity = new Themes();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select ThemeCode from MasterFile.Themes where ThemeCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ThemeCode = txtCode.Text;
            _Entity.Description = txtDescription.Text;
            _Entity.Year = Convert.ToDecimal(String.IsNullOrEmpty(spinYear.Value.ToString()) ? 0.00 : spinYear.Value);
