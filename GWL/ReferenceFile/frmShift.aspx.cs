...
namespace GWL
{
    public partial class frmShift : System.Web.UI.Page
    {
        ...
        Entity.Shift _Entity = new Shift();//Calls entity ICN
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtShiftCode.Text = _Entity.ShiftCode;
                    txtShiftName.Text = _Entity.ShiftName;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            DataTable shiftcode = Gears.RetriveData2("SELECT ShiftCode FROM MasterFile.Shift WHERE ShiftCode = '" + txtShiftCode.Text + "'", Session["ConnString"].ToString());
            if (shiftcode.Rows.Count > 0 && updateBtn.Text == "Add")
            {
                cp.JSProperties["cp_message"] = "Shift Code:'" + txtShiftCode.Text + "' already Exist!";
                cp.JSProperties["cp_success"] = true;
                return;
            }

            _Entity.ShiftCode = txtShiftCode.Text;
            _Entity.ShiftName = txtShiftName.Text;
