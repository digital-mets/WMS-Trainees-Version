...
namespace GWL
{
    public partial class frmProductionSiteMaster : System.Web.UI.Page
    {
        ...
        Entity.ProductionSiteMaster _Entity = new ProductionSiteMaster();//Calls entity ICN
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtProductionSiteCode.ReadOnly = true;
                    txtProductionSiteCode.Value = Request.QueryString["docnumber"].ToString();


                    _Entity.getdata(txtProductionSiteCode.Text, Session["ConnString"].ToString());

                    txtProductionSiteCode.Text = _Entity.ProductionSiteCode;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ProductionSiteCode = txtProductionSiteCode.Text;
