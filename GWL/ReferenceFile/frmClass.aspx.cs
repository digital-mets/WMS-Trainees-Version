...
namespace GWL
{
    public partial class frmClass : System.Web.UI.Page
    {
        ...
        Entity.Class _Entity = new Class();//Calls entity ICN
            ...
            if (!IsPostBack)
            {
               ...
               //sets docnumber from session
                ...
                else
                {
                    ...
                    txtclasscode.Value = Request.QueryString["docnumber"].ToString();

                    _Entity.getdata(txtclasscode.Text, Session["ConnString"].ToString());
                    
                    txtclasscode.Text  =  _Entity.ClassClassCode;       //ClassCode
                    txtclassdescription.Text  =  _Entity.ClassDescription;     //ClassDescription
                    chckClassIsInactive.Value = _Entity.ClassIsInactive;      //ClassIsInactive
                    txtclassstepcode.Text =  _Entity.ClassStepCode;        //ClassStepCode      
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ClassClassCode = txtclasscode.Text;
            _Entity.ClassDescription = txtclassdescription.Text;
            _Entity.ClassIsInactive = Convert.ToBoolean(chckClassIsInactive.Value);
            _Entity.ClassStepCode = txtclassstepcode.Text;
