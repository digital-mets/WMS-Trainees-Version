<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmFuncGroupClosing.aspx.cs" Inherits="GWL.frmFuncGroupClosing" %>
...
<form id="form1" runat="server" class="Entry">
    ...
    <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Functional Group" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Functional Group ID" Name="FunctionalGroupID">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtFunctionalGroupID" runat="server" AutoCompleteType="Disabled" Width="170px">
                                            ...
                                            <dx:LayoutItem Caption="Assigned Head" Name="AssignedHead">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup Width="170px" ID="txtAssignedHead" runat="server" AutoGenerateColumns="True" DataSourceID="MasterfileEmp" KeyFieldName="EmployeeCode" OnLoad="LookupLoad" TextFormatString="{2} {3}">
                                                            <ClientSideEvents Validation="OnValidation"/>
                                            ...
                                            <dx:LayoutItem Caption="Date Closed" Name="DateClosed">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtDateClosed" runat="server" Width="170px" ReadOnly="true">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Days" Name="Days" ColSpan="2" RowSpan="2">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtDays" runat="server" AutoCompleteType="Disabled" OnLoad="TextboxLoad" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
    ...
    <asp:SqlDataSource ID="Masterfilebiz" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT BizPartnerCode, Name FROM Masterfile.[BPSupplierInfo]" OnInit="Connection_Init"></asp:SqlDataSource>
