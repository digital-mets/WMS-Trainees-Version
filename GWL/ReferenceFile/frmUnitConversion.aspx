<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUnitConversion.aspx.cs" Inherits="GWL.frmUnitConversion" %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Unit Conversion" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                    ...
                    <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="565px" Width="850px" style="margin-left: -3px" ClientInstanceName="frmlayout">
                        ...
                        <Items>
                          ...
                          <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="Generic Tab">
                                        <Items>
                                            <dx:LayoutItem Caption="Conversion Code:" Name="txtconversioncode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtconversioncode" runat="server" Width="170px">
                                            ...
                                            <dx:LayoutItem Caption="Description" Name="txtdescription">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                             ...
                                             <dx:LayoutItem Caption="Unit Conversion From:">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glConversion" runat="server" DataSourceID="sdsUnit" KeyFieldName="UnitCode" OnLoad="LookupLoad" TextFormatString="{0}"  Width="170px">
                                                            <GridViewProperties>
                                             ...
                                             <dx:LayoutItem Caption="Unit Conversion To:">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glConversionTo" runat="server" DataSourceID="sdsUnit1" KeyFieldName="UnitCode" OnLoad="LookupLoad" TextFormatString="{0}" Width="170px">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                <Settings ShowFilterRow="True" />
                                                            </GridViewProperties>
                                               ...
                                               <dx:LayoutItem Caption="Unit Conversion Factor:" Name="txtfactor">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtfactor" runat="server" DisplayFormatString="{0:G}" DecimalPlaces="4" OnLoad="TextboxLoad" Width="170px">
                                                            <MaskSettings Mask="&lt;0..999g&gt;.&lt;00..99g&gt;" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
...
<dx:ASPxPanel id="BottomPanel" runat="server" fixedposition="WindowBottom" backcolor="#FFFFFF" Height="30px">
    ...
    <asp:SqlDataSource ID="sdsUnit1" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select UnitCode,Description from Masterfile.Unit where ISNULL(IsInactive,0) = 0" OnInit = "Connection_Init" ></asp:SqlDataSource>

    <!--#region Region Datasource-->
    <%-- <!--#endregion --> --%><%--<!--#region Region Details --> --%>
     <!--#endregion-->
</body>
</html>
