...
namespace GWL
{
    public partial class frmEmbroidery : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.Embroidery _Entity = new Embroidery();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    spinHeight.Value = _Entity.Height;
                    spinWidth.Value = _Entity.Width;
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select EmbroideryCode from MasterFile.Embroidery where EmbroideryCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.EmbroideryCode = txtCode.Text;
            _Entity.Description = txtDescription.Text;
            _Entity.Height = Convert.ToDecimal(String.IsNullOrEmpty(spinHeight.Value.ToString()) ? 0.00 : spinHeight.Value);
            _Entity.Width = Convert.ToDecimal(String.IsNullOrEmpty(spinWidth.Value.ToString()) ? 0.00 : spinWidth.Value);
