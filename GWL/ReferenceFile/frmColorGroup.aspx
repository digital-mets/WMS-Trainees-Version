<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmColorGroup.aspx.cs" Inherits="GWL.frmColorGroup"  %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Color Group" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="General Information">
                                                <Items>
                                                    <dx:LayoutItem Caption="Color Group Code" Name="RoleID">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtColorGroup" runat="server" Width="170px">
                                                    ...
                                                    <dx:LayoutItem Caption="Description" Name="txtPanel" RequiredMarkDisplayMode="Required">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
