<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSizeUnit.aspx.cs" Inherits="GWL.frmSizeUnit" %>
...
<head runat="server">
    ...
    <title>Size Unit MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Size Unit" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
