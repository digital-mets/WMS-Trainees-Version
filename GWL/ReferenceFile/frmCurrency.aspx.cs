...
namespace GWL
{
    public partial class frmCurrency : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.Currency _Entity = new Currency();//Calls entity ICN
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               //sets docnumber from session
                ...
                {
                    txtcurrency.Value = Request.QueryString["docnumber"].ToString();

                    _Entity.getdata(txtcurrency.Text, Session["ConnString"].ToString());//ADD CONN
                    txtcurrency.Text = _Entity.CurrencyCurrency;
                    txtCurrencyName.Text  =  _Entity.CurrencyName ;
                    txtSymbol.Text = _Entity.Symbol;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.CurrencyCurrency = txtcurrency.Text;
            _Entity.CurrencyName = txtCurrencyName.Text;
            _Entity.Symbol = txtSymbol.Text;
