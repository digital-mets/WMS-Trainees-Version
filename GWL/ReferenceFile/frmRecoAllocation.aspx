<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRecoAllocation.aspx.cs" Inherits="GWL.frmRecoAllocation" %>
...
<head runat="server">
    ...
    <title>Recomended Allocation MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Recomended Allocation" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
