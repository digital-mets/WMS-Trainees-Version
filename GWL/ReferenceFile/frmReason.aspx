<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReason.aspx.cs" Inherits="GWL.frmReason" %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Reason" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                                      <dx:LayoutItem Caption="ReasonCode:" Name="Code" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtReasonCode" runat="server" Width="170px" ReadOnly="true">
                                                ...
                                                <LayoutItemNestedControlCollection> <%--here jay--%>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glTransactionType" runat="server" AutoGenerateColumns="False" Width="170px" DataSourceID="dsTransactionType" OnLoad="LookupLoad" TextFormatString="{0}" KeyFieldName="ModuleID">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="False" />
                                                                <Settings ShowFilterRow="True" />
                                                            </GridViewProperties>
                                                            <Columns>
                                                                <dx:GridViewDataTextColumn FieldName="ModuleID" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
...
<dx:ASPxPanel id="BottomPanel" runat="server" fixedposition="WindowBottom" backcolor="#FFFFFF" Height="30px">
       ...
       <dx:ASPxPopupControl ID="DeleteControl" runat="server" Width="250px" Height="100px" HeaderText="Warning!"
        ...
        <asp:SqlDataSource ID="dstransactionType" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select ModuleID,Prompt from IT.MAINMENU WHERE  commandString not like 'GEARS_Reports%' " OnInit = "Connection_Init"></asp:SqlDataSource>
