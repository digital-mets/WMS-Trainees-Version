...
namespace GWL
{
    public partial class frmUnitConversion : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.UnitConversion _Entity = new UnitConversion();//Calls entity ICN
      //  Entity.ItemMaster.ItemDetail _EntityDetail = new ItemMaster.ItemDetail();//Call entity POdetails
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                 //  gv1.DataSourceID = "odsDetail";
                    txtconversioncode.ReadOnly = true;
                    txtconversioncode.Value = Request.QueryString["docnumber"].ToString();
                    _Entity.getdata(txtconversioncode.Text, Session["ConnString"].ToString());
                    
                    glConversion.Value = _Entity.UnitCodeFrom;
                    glConversionTo.Value = _Entity.UnitCodeTo;
                    txtdescription.Text = _Entity.Description;
                    txtfactor.Text = _Entity.ConversionFactor.ToString();
        ...
        {
            _Entity.ConversionCode = txtconversioncode.Text;
            _Entity.UnitCodeFrom = glConversion.Text;
            _Entity.UnitCodeTo = glConversionTo.Text;
            _Entity.Description=txtdescription.Text;
            _Entity.ConversionFactor = String.IsNullOrEmpty(txtfactor.Text) ? 0 : Convert.ToDecimal(txtfactor.Text);
        ...
        protected void Connection_Init(object sender, EventArgs e)
        {
            ...
            sdsUnit1.ConnectionString = Session["ConnString"].ToString();
