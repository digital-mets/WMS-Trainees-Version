<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProductType.aspx.cs" Inherits="GWL.frmProductType" %>
...
<body style="height: 400px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Product Type" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="SKU Type Code" Name="SKUTypeCode">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtProductTypeCode" runat="server" ClientInstanceName="CINProductTypeCode" MaxLength="20" Width="170px">
                                                    ...
                                                    <dx:LayoutGroup ColCount="2" ColSpan="2" Width="100%" Caption="Counterplan Reference">
                                                        <Items>
                                                            <dx:LayoutItem Caption="Font Color">
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                                        <dx:ASPxColorEdit ID="txtFontColor" runat="server" OnLoad="ColorEditLoad" Width="170px">
                                                                        </dx:ASPxColorEdit>
                                                                    </dx:LayoutItemNestedControlContainer>
                                                                </LayoutItemNestedControlCollection>
                                                            </dx:LayoutItem>
    ...
    <%--<!--#region Region Header --> --%>
    <asp:ObjectDataSource ID="odsHeader" runat="server" SelectMethod="getdata" TypeName="Entity.ProductType" DataObjectTypeName="Entity.ProductType" InsertMethod="InsertData" UpdateMethod="UpdateData">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="" Name="SKUTypeCode" SessionField="SKUTypeCode" Type="String" />
        </SelectParameters>
