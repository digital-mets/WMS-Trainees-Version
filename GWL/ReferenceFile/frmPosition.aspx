<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPosition.aspx.cs" Inherits="GWL.frmPosition" %>
...
<head runat="server">
   ...
   <script>
       ...
       //function Acheck() {
       //    var Agency = document.getElementById("cbAgency");
       //    var Direct = document.getElementById("cbDirect");
       //    if (Agency.checked == true) {
...
<body style="height: 400px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Position Master" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption=" Code" Name="ShiftCode">
                                                    ...
                                                    <dx:LayoutItem Caption=" Name" Name="ShiftName">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                    ...
                                                    <dx:LayoutItem Caption="Standard Rate" Name="Rate">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtRate" runat="server" ClientInstanceName="CINRate" OnLoad="TextboxLoad" Width="170px">
                                                                    
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Standard Unit" Name="Unit">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup Width="170px" ID="txtUnit" runat="server" AutoGenerateColumns="False" DataSourceID="sdsUnit"
                                                                    KeyFieldName="UnitCode" OnLoad="LookupLoad" TextFormatString="{0}" ClientInstanceName="CINUnit">
                                                                    <GridViewProperties>
                                                                    ...
                                                                    <ClientSideEvents Validation="OnValidation" />
                                                                    <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                        <ErrorImage ToolTip="Standard Unit is required">
                                                                        </ErrorImage>
                                                                        <RequiredField IsRequired="True" />
                                                                    </ValidationSettings>
                                                                    <InvalidStyle BackColor="Pink">
                                                        ...
                                                        <%--<LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtUnit" runat="server" ClientInstanceName="CINUnit" OnLoad="TextboxLoad" Width="170px">
                                                     ...
                                                     <dx:LayoutItem Caption="Direct">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxCheckBox ID="cbDirect" runat="server" CheckState="Unchecked" ClientInstanceName="CDirect">
                                                                    <ClientSideEvents CheckedChanged="function(s, e) {CAgency.SetChecked(!s.GetChecked()); }" />
                                                                </dx:ASPxCheckBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="Shift" ClientInstanceName="Shift" runat="server"
                                                            ...
                                                            DataSourceID="sdsShift" KeyFieldName="ShiftCode" TextFormatString="{0}" OnLoad="LookupLoad" Width="100">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                    ...
                                                    <dx:LayoutItem Caption="Agency">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxCheckBox ID="cbAgency" runat="server" CheckState="Unchecked" ClientInstanceName="CAgency">
                                                                    <ClientSideEvents CheckedChanged="function(s, e) {CDirect.SetChecked(!s.GetChecked()); }" />
    ...
    <asp:SqlDataSource ID="sdsUnit" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select UnitCode,Description from Masterfile.Unit WHERE ISNULL(IsInactive,0) =0"
