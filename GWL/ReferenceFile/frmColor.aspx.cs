...
namespace GWL
{
    public partial class frmColor : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
               ...
               //sets docnumber from session
                ...
                else
                {
                    ...
                    txtcolorcode.Value = Request.QueryString["docnumber"].ToString();
                    

                    _Entity.getdata(txtcolorcode.Text, Session["ConnString"].ToString());
                   
                    txtcolorcode.Text = _Entity.ColorColorCode;
                    txtcolordescription.Text = _Entity.ColorDescription;
                    glColorGroup.Text = _Entity.ColorColorGroup;
                    txtcolorsource.Text = _Entity.ColorSource;
                    txtcolormnemonics.Text = _Entity.ColorMnemonics;

                    glItemCatCode.Text = _Entity.ColorItemCategory;
                    glProductCategory.Text = _Entity.ColorProductCategory;
                    glProductSubCategory.Text = _Entity.ColorProductSubCategory;

                    txtcolorr.Text = _Entity.ColorR;
                    txtcolorg.Text = _Entity.ColorG;
                    txtcolorb.Text = _Entity.ColorB;
                    txtcolorreferencecode.Text = _Entity.ColorReferenceCode;

                    ItemCat = _Entity.ColorItemCategory.ToString();
                    ProdCat = _Entity.ColorProductCategory.ToString();
                    SubCat = _Entity.ColorProductSubCategory.ToString();
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ColorColorCode = txtcolorcode.Text;
            _Entity.ColorDescription = txtcolordescription.Text;
            _Entity.ColorColorGroup = glColorGroup.Text;
            _Entity.ColorSource = txtcolorsource.Text;
            _Entity.ColorMnemonics = txtcolormnemonics.Text;
            _Entity.ColorItemCategory = glItemCatCode.Text;
            _Entity.ColorProductCategory = glProductCategory.Text;
            _Entity.ColorProductSubCategory = glProductSubCategory.Text;
            _Entity.ColorR = txtcolorr.Text;
            _Entity.ColorG = txtcolorg.Text;
            _Entity.ColorB = txtcolorb.Text;
