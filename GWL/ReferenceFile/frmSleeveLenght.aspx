<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSleeveLenght.aspx.cs" Inherits="GWL.frmSleeveLenght" %>
...
<head runat="server">
    ...
    <title>Sleeve Lenght MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Sleeve Length" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
