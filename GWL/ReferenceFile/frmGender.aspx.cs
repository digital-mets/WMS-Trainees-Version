...
namespace GWL
{
    public partial class frmGender : System.Web.UI.Page
    {
        ...
        Entity.Gender _Entity = new Gender();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select GenderCode from MasterFile.Gender where GenderCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.GenderCode = txtCode.Text;
