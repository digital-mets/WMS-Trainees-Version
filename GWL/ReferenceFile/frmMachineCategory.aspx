<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMachineCategory.aspx.cs" Inherits="GWL.frmMachineCategory" %>
...
<head runat="server">
   ...
   <script>
       ...
       function UpdateCapacityUnit(value) {
           txtCapacityUnit.SetText(value);
       }

       function UpdateLocationCode(value) {
       ...
       function gridView_EndCallback(s, e) {//End callback function if (s.cp_success) {
           ...
           if (s.cp_close) {
               ...
               if (glcheck.GetChecked()) {
                   delete (cp_close);
                   var docno = document.getElementById("cp_frmlayout1_PC_0_txtMachineCategoryCode_I").value;

                   window.location.replace('../ReferenceFile/frmMachineCategory.aspx?entry=E&transtype=REFMACC&parameters=&iswithdetail=null&docnumber=' + docno + '');
               }
               else {
                   delete (cp_close);
...
<body style="height: 400px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Machine Type" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Machine Type" Name="MachineType">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtMachineCategoryCode" runat="server" ClientInstanceName="CINMachineCategoryCode" MaxLength="20" Width="170px">
                                                    ...
                                                    <dx:LayoutItem Caption="Description" Name="Description">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtDescription" runat="server" ClientInstanceName="CINDescription" OnLoad="TextboxLoad" Width="170px">
                                                                    <ClientSideEvents Validation="OnValidation" />
                                                                    <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                        <RequiredField IsRequired="True" />
                                                                    </ValidationSettings>
                                                    ...
                                                    <dx:LayoutItem Caption="Location" Name="Location">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="txtLocation" runat="server" DataSourceID="sdsLocation" Width="170px" KeyFieldName="LocationCode" 
                                                                        TextFormatString="{0}" AutoGenerateColumns="False" ClientInstanceName="CINLocation" OnLoad="LookupLoad">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True"/>
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                                                    <Columns>
                                                                        <dx:GridViewDataTextColumn FieldName="LocationCode" Caption="Code" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                                                    ...
                                                                    <ClientSideEvents ValueChanged="function(s,e){ 
                                                                        var g = txtLocation.GetGridView();
                                                                        g.GetRowValues(g.GetFocusedRowIndex(), 'LocationCode', UpdateLocationCode); 
                                                                    }"/>
                                                                </dx:ASPxGridLookup>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Capacity Qty" Name="CapacityQty">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxSpinEdit ID="txtCapacityQty" ClientInstanceName="CINCapacityQty" runat="server" Width="170px" SpinButtons-ShowIncrementButtons="False" DisplayFormatString="G" OnLoad="SpinEdit_Load">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Capacity Unit" Name="Capacity Unit">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="txtCapacityUnit" runat="server" DataSourceID="sdsBaseUnit" Width="170px" KeyFieldName="UnitCode" 
                                                                        TextFormatString="{0}" AutoGenerateColumns="False" ClientInstanceName="CINCapacityUnit" OnLoad="LookupLoad">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True"/>
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                                                    ...
                                                                    <ClientSideEvents ValueChanged="function(s,e){ 
                                                                        var g = txtCapacityUnit.GetGridView();
                                                                        g.GetRowValues(g.GetFocusedRowIndex(), 'UnitCode', UpdateCapacityUnit); 
                                                                    }"/>
                                                                </dx:ASPxGridLookup>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
    ...
    <%--<!--#region Region Header --> --%>
    <asp:ObjectDataSource ID="odsHeader" runat="server" SelectMethod="getdata" TypeName="Entity.MachineCategory" DataObjectTypeName="Entity.MachineCategory" InsertMethod="InsertData" UpdateMethod="UpdateData">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="" Name="MachineCategoryCode" SessionField="MachineCategoryCode" Type="String" />
        </SelectParameters>
    ...
    <asp:SqlDataSource ID="Masterfileitemdetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT [ItemCode], [PMType], [ClassCode],[SizeCode] FROM Masterfile.[ItemDetail] where isnull(IsInactive,'')=0" OnInit="Connection_Init"></asp:SqlDataSource>
   ...
   <asp:SqlDataSource ID="ItemAdjustment" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT AdjustmentCode,TransType FROM Masterfile.[AdjustmentType]" OnInit="Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="Masterfilebiz" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT BizPartnerCode, Name FROM Masterfile.[BizPartner] where isnull(IsInactive,'')=0" OnInit="Connection_Init"></asp:SqlDataSource>
     ...
     <%-- Base Unit Lookup --%>
    <asp:SqlDataSource ID="sdsBaseUnit" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT UnitCode,Description FROM Masterfile.Unit WHERE ISNULL([IsInactive],0) = 0" OnInit = "Connection_Init"></asp:SqlDataSource>

    <%-- Location Lookup --%>
    <asp:SqlDataSource ID="sdsLocation" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT LocationCode, LocationDescription AS Description FROM Masterfile.Location " OnInit = "Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="ItemCategoryCodeLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT RTRIM(LTRIM(ItemCategoryCode)) As ItemCategoryCode,Description FROM Masterfile.ItemCategory WHERE ISNULL([IsInactive],0) = 0"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>

    <%--Product Category Look Up--%>
    <asp:SqlDataSource ID="ProductCategoryLookUp" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT RTRIM(LTRIM(ProductCategoryCode)) As ProductCategoryCode,Description FROM Masterfile.ProductCategory WHERE ISNULL([IsInactive],0) = 0"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>

    <%--Product Sub Category Look Up--%>
    <asp:SqlDataSource ID="ProductSubCategoryLookUp" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT RTRIM(LTRIM(ProductSubCatCode)) As ProductSubCatCode,Description FROM Masterfile.ProductCategorySub WHERE ISNULL([IsInactive],0) = 0"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
