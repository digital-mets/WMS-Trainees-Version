<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmScrapMaster.aspx.cs" Inherits="GWL.frmScrapMaster" %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Scrap Master" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Scrap Code:" Name="ScrapCode" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtCode" runat="server" Width="170px" ReadOnly="true" ClientInstanceName="txtDocnumber">
                                            ...
                                            <dx:LayoutItem Caption="Weight:" Name="spWeight" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="spWeight" runat="server" Width="170px" ClientInstanceName="spWeight">
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                            <dx:LayoutItem Caption="Unit:" Name="glUnit">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup Width="170px" ID="glUnit" runat="server" AutoGenerateColumns="False" DataSourceID="sdsUOM" ClientInstanceName="glUnit"
                                                            KeyFieldName="UnitCode" OnLoad="LookupLoad" TextFormatString="{0}">
                                                            <GridViewProperties>
                                            ...
                                            <dx:LayoutItem Caption="Shelf Life">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                         <dx:ASPxSpinEdit ID="speShelfLife" runat="server" Width="170px" ClientInstanceName="spWeight">
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Classification:" Name="glClassification">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup Width="170px" ID="glClassification" runat="server" AutoGenerateColumns="False" DataSourceID="sdsClassification" ClientInstanceName="glClassification"
                                                            KeyFieldName="SKUCode" OnLoad="LookupLoad" TextFormatString="{0}">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                            </GridViewProperties>
                                                            <Columns>
                                                                <dx:GridViewDataTextColumn FieldName="SKUCode" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                                                </dx:GridViewDataTextColumn>
...
<dx:ASPxPanel id="BottomPanel" runat="server" fixedposition="WindowBottom" backcolor="#FFFFFF" Height="30px">
    ...
    <asp:SqlDataSource ID="sdsUOM" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM  masterfile.Unit where ISNULL(IsInactive,0)=0 "
            OnInit="Connection_Init"></asp:SqlDataSource>

    <asp:SqlDataSource ID="sdsClassification" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM  Masterfile.FGSKU where ISNULL(IsInactive,0)=0"
            OnInit="Connection_Init"></asp:SqlDataSource>
    <%--<!--#region Region Header --> --%>
</body>
</html>
