<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLocationMaster.aspx.cs" Inherits="GWL.frmLocationMaster" %>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                                      <dx:LayoutItem Caption="Location Code:" Name="Code" >
                                                <LayoutItemNestedControlCollection>
                                                 ...
                                                 <dx:LayoutItem Caption="Location Name">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtLocName" runat="server"  OnLoad="TextboxLoad"  Width="170px">
                                                                <ClientSideEvents Validation="OnValidation" />
                                                            <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True" />
                                                            </ValidationSettings>
