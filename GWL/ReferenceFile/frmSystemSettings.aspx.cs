...
namespace GWL
{
    public partial class frmSystemSettings : System.Web.UI.Page
    {
        ...
        Entity.SystemSettingsEntity _Entity = new SystemSettingsEntity();//Calls entity ICN
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                switch (Request.QueryString["entry"].ToString())
                {
                   case "N":
                    ...
                    case "E":
                        ...
                        txtsystemsettingscode.ReadOnly = true;
                        break;
                    case "V":
               ...
               //sets docnumber from session
                ...
                {
                     txtsystemsettingscode.Value = Request.QueryString["docnumber"].ToString();
                     _Entity.getdata(txtsystemsettingscode.Text, Session["ConnString"].ToString());


                     txtsystemsettingscode.ReadOnly = true;
                     txtsystemsettingscode.Text =        _Entity.SystemSettingsCode;
                     txtsystemsettingssequencenumber.Text = _Entity.SystemSettingsSequenceNumber;
                     txtsystemsettingsdescription.Text = _Entity.SystemSettingsDescription;
                     txtsystemsettingsvalue.Text = _Entity.SystemSettingsValue;
                     chksystemsettingsisuser.Value = Convert.ToBoolean(_Entity.SystemSettingsIsUser.ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.SystemSettingsCode = txtsystemsettingscode.Text;
            _Entity.SystemSettingsSequenceNumber = txtsystemsettingssequencenumber.Text;
            _Entity.SystemSettingsDescription = txtsystemsettingsdescription.Text;
            _Entity.SystemSettingsValue = txtsystemsettingsvalue.Text;
            _Entity.SystemSettingsIsUser = Convert.ToBoolean(chksystemsettingsisuser.Value.ToString());
