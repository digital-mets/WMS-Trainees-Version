...
namespace GWL
{
    public partial class frmNeckLine : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.NeckLine _Entity = new NeckLine();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select NeckLineCode from MasterFile.NeckLine where NeckLineCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.NeckLineCode = txtCode.Text;
