...
namespace GWL
{
    public partial class frmProductClass : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.ProductClass _Entity = new ProductClass();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtLeadTime.Text = _Entity.LeadTime.ToString();
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select ProductClassCode from MasterFile.ProductClass where ProductClassCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ProductClassCode = txtCode.Text;
            _Entity.Description = txtDescription.Text;
            _Entity.LeadTime = String.IsNullOrEmpty(txtLeadTime.Text) ? 0 : Convert.ToDecimal(txtLeadTime.Text);
