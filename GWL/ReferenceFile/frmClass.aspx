<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmClass.aspx.cs" Inherits="GWL.frmClass" %>
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Class" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Class Code" Name="ClassCode" ColSpan="2">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <%-- OnKeyPress="return RestrictSpace()"--%>
                                                        <dx:ASPxTextBox ID="txtclasscode" runat="server" Width="170px" ClientInstanceName="CINColorCode">
                                            ...
                                            <dx:LayoutItem Caption="Class Description" Name="ClassDescription">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtclassdescription" runat="server" OnLoad="TextboxLoad" UnboundType="Decimal" Width="170px">
                                            ...
                                            <dx:LayoutItem Caption="Class Step Code" Name="ClassStepCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtclassstepcode" runat="server" Width="170px" OnLoad="TextboxLoad">
                                            ...
                                            <dx:LayoutItem Caption="IsInActive" Name="IsInActive">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxCheckBox ID="chckClassIsInactive" runat="server" CheckState="Unchecked" OnLoad="CheckBoxLoad">
                                                        </dx:ASPxCheckBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
