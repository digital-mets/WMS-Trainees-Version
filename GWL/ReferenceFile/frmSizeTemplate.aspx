<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSizeTemplate.aspx.cs" Inherits="GWL.frmSizeTemplate" %>
...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
       ...
       function OnStartEditing(s, e) {//On start edit grid function     
           ...
           itemc = s.batchEditApi.GetCellValue(e.visibleIndex, "SizeCode"); //needed var for all lookups; this is where the lookups vary for
...
<body style="height: 910px">
            ...
            <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="SizeTemplate" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="General">
                                       <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                            <dx:LayoutItem Caption="Size Template Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtSizeTempCode" runat="server" Width="170px" OnLoad="TextboxLoad">
                                            ...
                                            <dx:LayoutItem Caption="Size Type">
                                                               <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                     ...
                                     <dx:LayoutGroup Caption="Size Details" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem ShowCaption="False">
                                                <LayoutItemNestedControlCollection>
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn FieldName="SizeTemplateCode" Visible="False"
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="SizeCode" VisibleIndex="2" Width="120px"  ReadOnly="True">
                                                             <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glSizeCode" runat="server" AutoGenerateColumns="true" AutoPostBack="false" 
                                                                    DataSourceID="sdsSizeCode" KeyFieldName="SizeCode" ClientInstanceName="gl4" TextFormatString="{0}" Width="80px">
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="SizeName" FieldName="SizeName" Name="SizeName" ShowInCustomizationForm="True" VisibleIndex="3"  Width="170px">
                                                                </dx:GridViewDataTextColumn>
                                                                <dx:GridViewDataTextColumn Caption="Length" FieldName="Length" Name="Length" ShowInCustomizationForm="True"  VisibleIndex="4" Width="170px" UnboundType="Bound">
                                                                </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataSpinEditColumn Caption="SortNumber" FieldName="SortNumber" Name="SortNumber" ShowInCustomizationForm="True" VisibleIndex="13">
    ...
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM  Masterfile.SizeTemplateDetail where SizeTemplateCode  is null " OnInit = "Connection_Init" >
    </asp:SqlDataSource>
    <asp:ObjectDataSource ID="odsDetail" runat="server" SelectMethod="getdetail" TypeName="Entity.SizeTemplate+SizeTemplateDetail" DataObjectTypeName="Entity.SizeTemplate+SizeTemplateDetail" DeleteMethod="DeleteSizeTemplateDetail" InsertMethod="AddSizeTemplateDetail" UpdateMethod="UpdateSizeTemplateDetail">
        <SelectParameters>
