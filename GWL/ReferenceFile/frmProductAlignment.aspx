<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProductAlignment.aspx.cs" Inherits="GWL.frmProductAlignment" %>
...
<head runat="server">
    ...
    <title>Product Aligment MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Product Alignment" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
