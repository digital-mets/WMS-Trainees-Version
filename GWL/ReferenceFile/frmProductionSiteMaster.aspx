<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProductionSiteMaster.aspx.cs" Inherits="GWL.frmProductionSiteMaster" %>
...
<head runat="server">
    ...
    <title>Production Site Master</title>
   ...
   <script>
       ...
       //#endregion
       function autoCalc() {
           var BatchWeight = CINBatchWeight.value;
           var YieldPercent = CINYieldPercentage.value;
           var YieldedBatchWeight = CINYieldedBatchWeight;
           var product = BatchWeight * YieldPercent;
...
<body style="height: 400px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Production Site Master" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Production Site Code" Name="ProductionSiteCode">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtProductionSiteCode" runat="server" ClientInstanceName="CINProductionSiteCode" MaxLength="20" Width="170px">
    ...
    <%--<!--#region Region Header --> --%>
    <asp:ObjectDataSource ID="odsHeader" runat="server" SelectMethod="getdata" TypeName="Entity.ProductionSiteMaster" DataObjectTypeName="Entity.ProductionSiteMaster" InsertMethod="InsertData" UpdateMethod="UpdateData">
        <SelectParameters>
