...
namespace GWL
{
    public partial class frmPrintProcess : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.PrintProcess _Entity = new PrintProcess();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select ProcessCode from MasterFile.PrintProcess where ProcessCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ProcessCode = txtCode.Text;
