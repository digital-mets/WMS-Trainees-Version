<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmNeckLine.aspx.cs" Inherits="GWL.frmNeckLine" %>
...
<head runat="server">
    ...
    <title>NeckLine MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Neck Line" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
