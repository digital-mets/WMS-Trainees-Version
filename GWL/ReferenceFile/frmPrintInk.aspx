<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPrintInk.aspx.cs" Inherits="GWL.frmPrintInk" %>
...
<head runat="server">
    ...
    <title>Print Ink MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Print Ink" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
