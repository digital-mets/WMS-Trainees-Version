<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmServiceType.aspx.cs" Inherits="GWL.frmServiceType" %>
...
<body style="height: 910px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="Service Type" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Service Type" Name="ServiceType" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtServiceType" runat="server" Width="170px" >
                                            ...
                                            <dx:LayoutItem Caption="Sequence Number" Name="SequenceNumber" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtSequenceNumber" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                          <ClientSideEvents Validation="OnValidation"/>
                                                            <ValidationSettings Display="None" ValidateOnLeave="true" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True"/>
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="Type:" Name="Type" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtType" runat="server" OnLoad="TextboxLoad" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem Caption="Service Rate:" Name="ServiceRate">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="seServiceRate" runat="server" Width="170px" Number="0.00" DisplayFormatString="{0:N}" OnLoad="SpinEdit_Load">
                                                            <SpinButtons ShowIncrementButtons="false"/>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Service Type Category Code:" Name="ServiceTypeCategoryCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtServiceTypeCategoryCode" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Sales GL Code:" Name="SalesGLCode" >
                                                <LayoutItemNestedControlCollection>
                                                     <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glGL" ClientInstanceName="glGL" runat="server"  Width="170px" 
                                                            DataSourceID="sdsCOA" AutoGenerateColumns="True" KeyFieldName="AccountCode" OnLoad="LookupLoad" 
                                                            TextFormatString="{0}" >
                                                            <GridViewProperties>
                                                            ...
                                                            <%--<ClientSideEvents Validation="OnValidation" ValueChanged="function(s, e) 
                                                                {
                                                                glSubsi.GetGridView().PerformCallback(s.GetInputElement().value);
                                                                }" 
                                                            />--%>
                                                            <ClientSideEvents Validation="OnValidation" ValueChanged="function(s, e) 
                                                                {
                                                                cp.PerformCallback('GL'); e.processOnServer = false;
                                                                }" 
                                                            />
                                            ...
                                            <dx:LayoutItem Caption="Sales GL Subsi Code" Name="SalesGLSubsiCode" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                         <dx:ASPxGridLookup ID="glSubsi" runat="server" AutoGenerateColumns="True" KeyFieldName="SubsiCode"  DataSourceID="sdsGLSubsi"
                                                             OnLoad="LookupLoad" TextFormatString="{0}" ClientInstanceName="glSubsi" Width="170px">
                                                            <GridViewProperties>
                                            ...
                                            <dx:LayoutItem Caption="ARGL Code:" Name="ARGL Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                         <dx:ASPxGridLookup ID="glARGL" ClientInstanceName="glARGL" runat="server"  Width="170px"
                                                             DataSourceID="sdsCOA" KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" AllowSelectByRowClick="True" />
                                                            </GridViewProperties>
                                                            <%--<ClientSideEvents Validation="OnValidation" ValueChanged="function(s, e) 
                                                                   {glARGLSubsi.GetGridView().PerformCallback(s.GetInputElement().value);}" />--%>
                                                             <ClientSideEvents Validation="OnValidation" ValueChanged="function(s, e) 
                                                                {
                                                                cp.PerformCallback('ARGL'); e.processOnServer = false;
                                                                }" 
                                                            />
                                                              <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True" />
                                            ...
                                            <dx:LayoutItem Caption="ARGL Subsi Code:" Name="ARGLSubsiCode" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                         <dx:ASPxGridLookup ID="glARGLSubsi" runat="server" AutoGenerateColumns="True" KeyFieldName="SubsiCode" DataSourceID="sdsARGLSubsi"
                                                             OnLoad="LookupLoad" TextFormatString="{0}" ClientInstanceName="glARGLSubsi" Width="170px">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                            </GridViewProperties>
                                                                      <ClientSideEvents Validation="OnValidation" />
                                            ...
                                            <dx:LayoutItem Caption="Is Standard" Name="IsStandard" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxCheckBox ID="chckStandard" runat="server" CheckState="Unchecked">
                                                        </dx:ASPxCheckBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
    ...
    <asp:SqlDataSource ID="sdsGLSubsi" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT  SubsiCode, Description, AccountCode FROM Accounting.[glsubsicode] WHERE ISNULL (IsInactive, '') =0"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsARGLSubsi" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT  SubsiCode, Description, AccountCode FROM Accounting.[glsubsicode] WHERE ISNULL (IsInactive, '') =0"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsCOA" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT AccountCode, Description FROM Accounting.[ChartOfAccount] WHERE ISNULL (IsInactive, '')=0"></asp:SqlDataSource>
    <!--#endregion-->
</body>         
</html>
