<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmShift.aspx.cs" Inherits="GWL.frmShift" %>
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Shift Master" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Shift Code" Name="ShiftCode">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtShiftCode" runat="server" ClientInstanceName="CINShiftCode" MaxLength="20" Width="170px">
                                                    ...
                                                    <dx:LayoutItem Caption="Shift Name" Name="ShiftName">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtShiftName" runat="server" ClientInstanceName="CINShiftName" OnLoad="TextboxLoad" Width="170px">
