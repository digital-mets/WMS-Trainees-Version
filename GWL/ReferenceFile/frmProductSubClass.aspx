<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProductSubClass.aspx.cs" Inherits="GWL.frmProductSubClass" %>
...
<head runat="server">
    ...
    <title>Product Sub Class MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Product Sub Class" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
