<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPrintProcess.aspx.cs" Inherits="GWL.frmPrintProcess" %>
...
<head runat="server">
    ...
    <title>Print Process MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Print Process" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
