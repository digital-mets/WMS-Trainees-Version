...
namespace GWL
{
    public partial class frmStep : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.Step _Entity = new Step();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    glOverhead.Value = _Entity.OverheadCode.ToString();
                    glParentStepCode.Value = _Entity.ParentStepCode.ToString();
                    spinEstWOPrice.Value = _Entity.EstimatedWOPrice;
                    spinMaxWOPrice.Value = _Entity.MaximumWOPrice;
                    spinMinWOPrice.Value = _Entity.MinimumWOPrice;
                    chkIsPreProd.Value = _Entity.IsPreProductionStep;
                    ...
                    txtHAddedDate.Text = _Entity.ActivatedDate;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.StepCode = txtCode.Text;
            _Entity.OverheadCode = glOverhead.Value.ToString();
            _Entity.ParentStepCode = glParentStepCode.Value.ToString();
            _Entity.Description = txtDescription.Text;
            _Entity.Mnemonics = txtMnemonics.Text;
            _Entity.EstimatedWOPrice = Convert.ToDecimal(String.IsNullOrEmpty(spinEstWOPrice.Value.ToString())? 0.00 : spinEstWOPrice.Value);
            _Entity.MaximumWOPrice = Convert.ToDecimal(String.IsNullOrEmpty(spinMaxWOPrice.Value.ToString()) ? 0.00 : spinMaxWOPrice.Value);
            _Entity.MinimumWOPrice = Convert.ToDecimal(String.IsNullOrEmpty(spinMinWOPrice.Value.ToString()) ? 0.00 : spinMinWOPrice.Value);
            _Entity.IsPreProductionStep = Convert.ToBoolean(chkIsPreProd.Value);
            _Entity.IsInhouse = Convert.ToBoolean(chkIsInHouse.Value);
