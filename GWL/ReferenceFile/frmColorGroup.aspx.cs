...
namespace GWL
{
    public partial class frmColorGroup : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.ColorGroupMasterfile _Entity = new ColorGroupMasterfile();//Calls entity PO
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtColorGroup.Value = Request.QueryString["docnumber"].ToString();
                    _Entity.getdata(txtColorGroup.Text, Session["ConnString"].ToString()); //Method for retrieving data from entity
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ColorGroup = txtColorGroup.Text.ToUpper();
