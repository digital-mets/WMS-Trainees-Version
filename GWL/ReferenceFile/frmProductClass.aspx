<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProductClass.aspx.cs" Inherits="GWL.frmProductClass" %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Product Class" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                             ...
                                             <dx:LayoutItem Caption="Lead Time">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtLeadTime" runat="server" ClientInstanceName="mbal" MaxValue="999999999" Number="0.0" OnLoad="SpinEdit_Load" Width="170px">
