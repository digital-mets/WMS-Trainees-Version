...
namespace GWL
{
    public partial class frmUnits : System.Web.UI.Page
    {
        ...
        Entity.Units _Entity = new Units();//Calls entity ICN
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               //sets docnumber from session
                ...
                {
                     txtunitcode.ReadOnly = true;
                     txtunitcode.Value = Request.QueryString["docnumber"].ToString();
                     _Entity.getdata(txtunitcode.Text, Session["ConnString"].ToString());

                     txtunitcode.Text =        _Entity.UnitUnitCode;
                     txtunitdescription.Text = _Entity.UnitDescription;
                     chkisinactive.Value = Convert.ToBoolean(_Entity.UnitIsInactive.ToString());
                     chkisrounded.Value = Convert.ToBoolean(_Entity.UnitIsRounded.ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.UnitUnitCode = txtunitcode.Text;
            _Entity.UnitDescription = txtunitdescription.Text;
            _Entity.UnitIsInactive = Convert.ToBoolean(chkisinactive.Value.ToString());
            _Entity.UnitIsRounded = Convert.ToBoolean(chkisrounded.Value.ToString());
