...
namespace GWL
{
    public partial class frmWIPAdjustmentType : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.WIPAdjustmentType _Entity = new WIPAdjustmentType();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dtrr1 = Gears.RetriveData2("Select AdjustmentCode from MasterFile.WIPAdjustmentType where AdjustmentCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.AdjustmentCode = txtCode.Text;
