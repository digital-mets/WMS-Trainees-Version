<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmColor.aspx.cs" Inherits="GWL.frmColor" %>
...
<body style="height: 910px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Color" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Color Code" Name="colorcode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolorcode" runat="server" Width="170px" MaxLength="20" ClientInstanceName="CINColorCode">
                                            ...
                                            <dx:LayoutItem Caption="Color Description" Name="colordescription">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolordescription" runat="server" ClientInstanceName="CINDescription" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Color Group" Name="colorgroup">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup AutoGenerateColumns="true" ID="glColorGroup" runat="server" Width="170px" DataSourceID="ColorGroupLookup" 
                                                            KeyFieldName="ColorGroup" OnLoad="LookupLoad" TextFormatString="{0}">
                                                            <GridViewProperties>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="Color Group" FieldName="ColorGroup" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                       ...
                                       <dx:LayoutItem Caption="Source" Name="colorsource">
                                                  <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                            <dx:ASPxTextBox ID="txtcolorsource" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                            </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Mnemonics" Name="colormnemonics">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolormnemonics" runat="server" Width="170px"  OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Reference Code" Name="colorreferencecode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolorreferencecode" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                            <dx:LayoutItem Caption="Item Category" Name="ItemCategoryCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup AutoGenerateColumns="false" ID="glItemCatCode" runat="server" Width="170px" DataSourceID="ItemCategoryCodeLookUp" KeyFieldName="ItemCategoryCode" OnLoad="LookupLoad" TextFormatString="{0}" SelectionMode="Multiple">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" />
                                                                <Settings ColumnMinWidth="50" ShowFilterRow="True" />
                                                            </GridViewProperties>
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="Item Category Code" FieldName="ItemCategoryCode" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                                                </dx:GridViewDataTextColumn>
                                                            </Columns>
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="R" Name="colorr">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolorr" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                            <dx:LayoutItem Caption="Product Category" Name="ProductCategory">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup AutoGenerateColumns="true" ID="glProductCategory" runat="server" Width="170px" DataSourceID="ProductCategoryLookUp" KeyFieldName="ProductCategoryCode" OnLoad="LookupLoad" TextFormatString="{0}" SelectionMode="Multiple">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" />
                                                                <Settings ColumnMinWidth="50" ShowFilterRow="True" />
                                                            </GridViewProperties>
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="Product Category Code" FieldName="ProductCategoryCode" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                                                </dx:GridViewDataTextColumn>
                                                                <dx:GridViewDataTextColumn Caption="Description" FieldName="Description" ShowInCustomizationForm="True" VisibleIndex="2" Width="50px">
                                                                </dx:GridViewDataTextColumn>
                                                            </Columns>
                                            ...
                                            <dx:LayoutItem Caption="G" Name="colorg">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolorg" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                            <dx:LayoutItem Caption="Product Sub Category" Name="ProductSubCategory">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup AutoGenerateColumns="true" ID="glProductSubCategory" runat="server" Width="170px" DataSourceID="ProductSubCategoryLookUp" KeyFieldName="ProductSubCatCode" OnLoad="LookupLoad" TextFormatString="{0}" SelectionMode="Multiple">
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" />
                                                                <Settings ColumnMinWidth="50" ShowFilterRow="True" />
                                                            </GridViewProperties>
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="Product Sub CatCode" FieldName="ProductSubCatCode" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                                                </dx:GridViewDataTextColumn>
                                                                <dx:GridViewDataTextColumn Caption="Description" FieldName="Description" ShowInCustomizationForm="True" VisibleIndex="2" Width="50px">
                                                                </dx:GridViewDataTextColumn>
                                                            </Columns>
                                            ...
                                            <dx:LayoutItem Caption="B" Name="colorb">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtcolorb" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                            <dx:LayoutItem Caption="Inactive" Name="colorisinactive">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
   ...
   <asp:SqlDataSource ID="ItemAdjustment" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT AdjustmentCode,TransType FROM Masterfile.[AdjustmentType]" OnInit="Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="ItemCategoryCodeLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT ItemCategoryCode,Description FROM Masterfile.ItemCategory WHERE ISNULL([IsInactive],0) = 0"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
