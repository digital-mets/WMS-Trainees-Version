...
namespace GWL
{
    public partial class frmBrand : System.Web.UI.Page
    {
        ...
        Entity.Brand _Entity = new Brand();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtBrandCode.Value = Request.QueryString["docnumber"].ToString(); //sets docnumber from session
                    _Entity.getdata(txtBrandCode.Text, Session["ConnString"].ToString()); //Method for retrieving data from entity
                    txtBrandName.Text = _Entity.BrandName;
                ...
                DataTable dtrr1 = Gears.RetriveData2("Select BrandCode from MasterFile.Brand where BrandCode = '" + txtBrandCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.BrandCode = txtBrandCode.Text;
            _Entity.BrandName = txtBrandName.Text;
