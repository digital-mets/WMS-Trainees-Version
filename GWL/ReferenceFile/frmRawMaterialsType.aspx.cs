...
namespace GWL
{
    public partial class frmRawMaterialsType : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.RawMaterialsType _Entity = new RawMaterialsType();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select RawMaterialTypeCode from MasterFile.RawMaterialsType where RawMaterialTypeCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            DataTable stepcode = Gears.RetriveData2("Select RawMaterialTypeCode from MasterFile.RawMaterialsType where RawMaterialTypeCode ='" + txtCode.Text + "'", Session["ConnString"].ToString());
            if (stepcode.Rows.Count > 0 && updateBtn.Text == "Add")
            {
                cp.JSProperties["cp_message"] = "RawMaterialTypeCode:'" + txtCode.Text + "' already Exist!";
                cp.JSProperties["cp_success"] = true;
                return;
            }


            _Entity.RawMaterialTypeCode = txtCode.Text;
