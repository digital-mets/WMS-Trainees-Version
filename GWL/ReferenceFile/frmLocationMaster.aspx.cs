...
namespace GWL
{
    public partial class frmLocationMaster : System.Web.UI.Page
    {
        ...
        Entity.LocationMaster _Entity = new LocationMaster();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtLocName.Text = _Entity.LocationName;
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select RawMaterialTypeCode from MasterFile.LocationMaster where RawMaterialTypeCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            DataTable stepcode = Gears.RetriveData2("Select RawMaterialTypeCode from MasterFile.LocationMaster where RawMaterialTypeCode ='" + txtCode.Text + "'", Session["ConnString"].ToString());
            ...
            _Entity.LocationCode = txtCode.Text;
            _Entity.LocationName = txtLocName.Text;
