<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDepartment.aspx.cs" Inherits="GWL.frmDepartment"  %>
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Department" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="Header">
                                        <Items>
                                            <dx:LayoutGroup Caption="General Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Department" Name="DeptCode">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="hDepartmentCode" runat="server" Width="170px">
                                                    ...
                                                    <dx:LayoutItem Caption="Dept Name" Name="txtPanel" RequiredMarkDisplayMode="Required">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="hDepartmentName" runat="server" Width="170px">
                                                   ...
                                                   <dx:LayoutItem Caption="Default Department" Name="hdefDep">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxCheckBox ID="hdefDep" runat="server" CheckState="Unchecked" >
                                                                </dx:ASPxCheckBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
    ...
    <%--<!--#region Region Header --> --%>    
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM Masterfile.ColorGroup WHERE ColorGroup IS NULL " OnInit="Connection_Init"></asp:SqlDataSource>
