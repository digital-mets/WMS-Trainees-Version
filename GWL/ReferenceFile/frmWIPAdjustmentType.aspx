<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWIPAdjustmentType.aspx.cs" Inherits="GWL.frmWIPAdjustmentType" %>
...
<head runat="server">
    ...
    <title>WIP Adjustment Type MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="WIP Adjustment Type" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
