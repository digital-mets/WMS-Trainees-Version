...
namespace GWL
{
    public partial class frmRecoAllocation : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.RecoAllocation _Entity = new RecoAllocation();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select AllocationCode from MasterFile.RecoAllocation where AllocationCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.AllocationCode = txtCode.Text;
