...
namespace GWL
{
    public partial class frmProductGroup : System.Web.UI.Page
    {
        ...
        Entity.ProductGroup _Entity = new ProductGroup();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    spinSortOrder.Value = _Entity.SortOrder;
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select CategoryCode from MasterFile.DesignCategory where CategoryCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ProductGroupCode = txtCode.Text;
            _Entity.ProductCategoryCode = glProductCategory.Value.ToString();
            _Entity.Description = txtDescription.Text;
            _Entity.SortOrder = Convert.ToDecimal(String.IsNullOrEmpty(spinSortOrder.Value.ToString())? 0.00 : spinSortOrder.Value);
