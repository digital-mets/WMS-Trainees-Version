                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                            ...
                                            <dx:LayoutItem Caption="Employee Code:">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="aglBizPartnerCode" runat="server" DataSourceID="sdsBizPartner" KeyFieldName="EmployeeCode" OnLoad="LookupLoad" TextFormatString="{0}"  Width="170px">
                                                            <GridViewProperties>
