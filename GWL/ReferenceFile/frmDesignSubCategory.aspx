<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDesignSubCategory.aspx.cs" Inherits="GWL.frmDesignSubCategory" %>
...
<head runat="server">
    ...
    <title>Design Sub Category MasterFile</title>
    <!--#region Region CSS-->
    <style type="text/css">
...
<form id="form1" runat="server" class="Entry">
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Design Sub Category" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                    ...
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Product Category">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glProductCategory" DataSourceID="sdsProdCat"  runat="server" AutoGenerateColumns="False" ClientInstanceName="glProductCategory" KeyFieldName="ProductCategoryCode"  OnLoad="LookupLoad"  TextFormatString="{0}" Width="170px">
                                                            <ClientSideEvents Validation="OnValidation"  />
                                                            <GridViewProperties>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="ProductCategoryCode" FieldName="ProductCategoryCode" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                             ...
                                             <dx:LayoutItem Caption="Product Group">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glProductGroup" DataSourceID="sdsProdGroup"  runat="server" AutoGenerateColumns="False" ClientInstanceName="glProductGroup" KeyFieldName="ProductGroupCode"  OnLoad="LookupLoad"  TextFormatString="{0}" Width="170px">
                                                            <ClientSideEvents Validation="OnValidation" />
                                                            <GridViewProperties>
                                                                <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" />
                                                                <Settings ColumnMinWidth="50" ShowFilterRow="True" />
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn Caption="ProductGroupCode" FieldName="ProductGroupCode" ShowInCustomizationForm="True" VisibleIndex="1" Width="50px">
                                                                </dx:GridViewDataTextColumn>
                                                                <dx:GridViewDataTextColumn Caption="Description" FieldName="Description" ShowInCustomizationForm="True" VisibleIndex="2" Width="50px">
                                                                </dx:GridViewDataTextColumn>
...
<dx:ASPxPanel id="BottomPanel" runat="server" fixedposition="WindowBottom" backcolor="#FFFFFF" Height="30px">
    ...
    <asp:SqlDataSource ID="sdsProdCat" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="
select ProductCategoryCode,Description from Masterfile.ProductCategory where ISNULL(IsInactive,0)=0"   OnInit = "Connection_Init">
    </asp:SqlDataSource>

        <asp:SqlDataSource ID="sdsProdGroup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="
Select ProductGroupCode,Description from MasterFile.ProductGroup where ISNULL(IsInactive,0)=0"   OnInit = "Connection_Init">
    </asp:SqlDataSource>
    <%--<!--#region Region Header --> --%>
</body>
</html>
