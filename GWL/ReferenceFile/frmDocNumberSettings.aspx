<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDocNumberSettings.aspx.cs" Inherits="GWL.frmDocNumberSettings" %>
...
#form1 {
height: 370px; /*Change this whenever needed*/
}
    ...
    <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="DocNumber Settings" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
        ...
        <dx:ASPxCallbackPanel ID="cp" runat="server" Width="1050px" Height="338px" ClientInstanceName="cp" OnCallback="cp_Callback">
            ...
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxFormLayout ID="form1_layout" runat="server" Height="294px" Width="850px" style="margin-left: -20px">
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Module">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="gvModule" runat="server" Width="170px" AutoGenerateColumns="False" OnLoad="LookupLoad" DataSourceID="module" TextFormatString="{0}" KeyFieldName="ModuleID">
                                                            ...
                                                            <Columns>
                                                                <dx:GridViewDataTextColumn FieldName="ModuleID" ShowInCustomizationForm="True" VisibleIndex="0">
                                                                </dx:GridViewDataTextColumn>
                                                                <dx:GridViewDataTextColumn FieldName="Prompt" ShowInCustomizationForm="True" VisibleIndex="1">
                                                                </dx:GridViewDataTextColumn>
                                                            </Columns>
                                                        </dx:ASPxGridLookup>
                                            ...
                                            <dx:LayoutItem Caption="Counter">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtCounter" runat="server" Onload="SpinEdit_Load" Width="170px" MinValue="0" MaxValue="999999999999">
                                            ...
                                            <dx:LayoutItem Caption="Prefix" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtPrefix" runat="server" Width="170px" OnLoad="TextboxLoad">
                                            ...
                                            <dx:LayoutItem Caption="Series Width">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtWidth" runat="server" Onload="SpinEdit_Load" Width="170px" MinValue="0" MaxValue="999999999999">
                                                            <ClientSideEvents Validation="OnValidation" />
                                                            <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True" />
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="Series Number">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtSeries" runat="server" Onload="SpinEdit_Load" Width="170px" MinValue="0" MaxValue="999999999999">
                                                            <ClientSideEvents Validation="OnValidation" />
                                                            <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True" />
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="IsDefault">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxCheckBox ID="chkDefault" runat="server" CheckState="Unchecked" Text=" " OnLoad="CheckboxLoad">
                                                        </dx:ASPxCheckBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="IsInactive">
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtId" runat="server" OnLoad="TextboxLoad" Width="170px"  ReadOnly="true" >
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
...
<dx:ASPxPanel id="BottomPanel" runat="server" fixedposition="WindowBottom" backcolor="#FFFFFF" Height="30px">
    ...
    <%--<Settings ShowFilterRow="True"></Settings>--%>
    <asp:ObjectDataSource ID="odsHeader" runat="server" DataObjectTypeName="Entity.DocNumberSettings" InsertMethod="InsertData" SelectMethod="getdata" TypeName="Entity.DocNumberSettings" UpdateMethod="UpdateData">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="" Name="DocNumber" SessionField="DocNumber" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsDetail" runat="server" DataObjectTypeName="Entity.DocNumberSettings+TransactionDetail" SelectMethod="getdetail" UpdateMethod="UpdateTransactionDetail" TypeName="Entity.Transaction+TransactionDetail" DeleteMethod="DeleteTransactionDetail" InsertMethod="AddTransactionDetail">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="module" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select ModuleID, Prompt from it.mainmenu where MenuID != '_REF'">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="PlantCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT PlantCode, PlantDescription from Masterfile.Plant "></asp:SqlDataSource>
  <asp:SqlDataSource ID="RoomCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT RoomCode, RoomDescription from Masterfile.Room "></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="DocNumberSettingsType" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select Code,Description from It.GenericLookup where LookUpKey = 'LOCTY'" OnInit = "Connection_Init"></asp:SqlDataSource>
