<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStockStatus.aspx.cs" Inherits="GWL.frmStockStatus" %>
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="Stock Status" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Status Code" Name="StatusCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtStatusCode" runat="server" Width="170px">
                                            ...
                                            <dx:LayoutItem Caption="Status Type:" Name="StatusType">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtStatusType" runat="server" Width="170px" MaxLength="1" ToolTip="One character input only!">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Mark Down Rate:" Name="MarkDownRate" >
                                                  <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="seMarkDownRate" runat="server" Width="170px" NullValue="0.00" DisplayFormatString="{0:N}" OnLoad="SpinEdit_Load">
                                                            <SpinButtons ShowIncrementButtons="false"/>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Sequence" Name="Sequence">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="seSequence" runat="server" Width="170px" NullValue="0" DisplayFormatString="{0}" OnLoad="SpinEdit_Load">
                                                            <SpinButtons ShowIncrementButtons="false"/>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Modulus:" Name="Modulus" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="seModulus" runat="server" Width="170px" VullValue="0" DisplayFormatString="{0}" OnLoad="SpinEdit_Load">
                                                            <SpinButtons ShowIncrementButtons="false"/>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Adjustment:" Name="Adjustment" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glAdjustment" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Outright Sales:" Name="OutrightSales">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glOutrightSales" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Cost Of Sales:" Name="CostOfSales">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glCostOfSales" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Sales Return:" Name="SalesReturn">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glSalesReturn" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Gross Sales Retail:" Name="GrossSalesRetail">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glGrossSalesRetail" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Retail Discount:" Name="RetailDiscount">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glRetailDiscount" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                        </dx:ASPxGridLookup>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Outlet Margin:" Name="OutletMargin">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="seOutletMargin" runat="server" Width="170px" NullValue="0" DisplayFormatString="{0}" OnLoad="SpinEdit_Load">
                                                            <SpinButtons ShowIncrementButtons="false"/>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
