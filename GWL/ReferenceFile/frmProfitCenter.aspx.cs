...
namespace GWL
{
    public partial class frmProfitCenter : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.ProfitCenter _Entity = new ProfitCenter();//Calls entity odsHeader
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtProfit.Value = Request.QueryString["docnumber"].ToString(); //sets docnumber from session

                    _Entity.getdata(txtProfit.Text, Session["ConnString"].ToString());//ADD CONN //Method for retrieving data from entity

                    txtProfit.Text = _Entity.ProfitCenterCode;
                    txtDesc.Text = _Entity.Description;
                    txtUnit.Text = _Entity.BusinessUnit;
                    chkHeadOffice.Value = _Entity.IsHeadOffice;
        ...
        private void Validate()
        {
            ...
            //string strresult =GWarehouseManagement.ProfitCenter_Validate(gparam);
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.ProfitCenterCode = txtProfit.Text;
            _Entity.Description = txtDesc.Text;
            _Entity.BusinessUnit = txtUnit.Text;
            _Entity.IsHeadOffice = Convert.ToBoolean(chkHeadOffice.Checked);
