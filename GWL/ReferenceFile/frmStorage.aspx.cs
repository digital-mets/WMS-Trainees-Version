...
namespace GWL
{
    public partial class frmStorage : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.Storage _Entity = new Storage();//Calls entity ICN
            ...
            if (!IsPostBack)
            {
               ...
               //sets docnumber from session
                ...
                else
                {
                    ...
                    txtstoragetype.ReadOnly = true;
                     txtstoragetype.Value = Request.QueryString["docnumber"].ToString();
                     _Entity.getdata(txtstoragetype.Text, Session["ConnString"].ToString());

                     txtstoragetype.Text =        _Entity.StorageStorageType;
                     txtstoragedescription.Text = _Entity.StorageStorageDescription;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.StorageStorageType = txtstoragetype.Text;
            _Entity.StorageStorageDescription = txtstoragedescription.Text;
