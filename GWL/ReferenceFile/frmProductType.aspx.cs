...
namespace GWL
{
    ...
    public partial class frmProductType : System.Web.UI.Page
    {
        ...
        Entity.ProductType _Entity = new ProductType();//Calls entity ICN
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtProductTypeCode.Value = Request.QueryString["docnumber"].ToString();


                    _Entity.getdata(txtProductTypeCode.Text, Session["ConnString"].ToString());

                    txtProductTypeCode.Text = _Entity.SKUTypeCode;
                    txtDescription.Text = _Entity.Description;
                    txtFontColor.Text = _Entity.FontColor;
        ...
        protected void ColorEditLoad(object sender, EventArgs e)//Control for all coloredit JCB 8/9/2021
        {
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            DataTable ptcode = Gears.RetriveData2("SELECT SKUTypeCode FROM MasterFile.ProductType WHERE SKUTypeCode = '" + txtProductTypeCode.Text + "'", Session["ConnString"].ToString());
            if (ptcode.Rows.Count > 0 && updateBtn.Text == "Add")
            {
                cp.JSProperties["cp_message"] = "SKU Type Code:'" + txtProductTypeCode.Text + "' already Exist!";
                cp.JSProperties["cp_success"] = true;
                return;
            }
            _Entity.SKUTypeCode = txtProductTypeCode.Text;
            _Entity.Description = txtDescription.Text;
            _Entity.FontColor = txtFontColor.Text;
            ...
            //_Entity.ColorItemCategory = convertToSPC(glItemCatCode.Text);
            //_Entity.ColorProductCategory = convertToSPC(glProductCategory.Text);
            //_Entity.ColorProductSubCategory = convertToSPC(glProductSubCategory.Text);
