...
namespace GWL
{
    public partial class frmDesignSubCategory : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.DesignSubCategory _Entity = new DesignSubCategory();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    glProductCategory.Value = _Entity.ProductCategoryCode.ToString();
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select SubCategoryCode from MasterFile.DesignSubCategory where SubCategoryCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.SubCategoryCode = txtCode.Text;
            _Entity.ProductGroup = glProductGroup.Value.ToString();
            _Entity.ProductCategoryCode = glProductCategory.Value.ToString();
        ...
        protected void Connection_Init(object sender, EventArgs e)
        {
            ...
            sdsProdGroup.ConnectionString = Session["ConnString"].ToString();
        }
