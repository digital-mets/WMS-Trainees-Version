<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmItemMasterfileWMS.aspx.cs" Inherits="GWL.frmItemMasterfileWMS" %>
...
<PropertiesTextEdit DisplayFormatString="{0:M/d/yyyy}"></PropertiesTextEdit>
   ...
   <asp:SqlDataSource ID="customer" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select BizPartnerCode,Name from  Masterfile.BizPartner WHERE ISNULL(IsInactive,0)=0"
       OnInit = "Connection_Init">
   </asp:SqlDataSource>
