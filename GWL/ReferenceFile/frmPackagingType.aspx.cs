...
namespace GWL
{
    public partial class frmPackagingType : System.Web.UI.Page
    {
        Boolean error = false;//Boolean for grid validation
        Boolean view = false;//Boolean for view state
        Boolean check = false;//Boolean for grid validation

        Entity.PackagingType _Entity = new PackagingType();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    //txtCounterplanRef.Text = _Entity.CounterplanRef.ToString();
                    txtFontColor.Text = _Entity.FontColor.ToString();
                    txtBackColor.Text = _Entity.BackColor.ToString();
                    ...
                    DataTable dtrr1 = Gears.RetriveData2("Select PackagingTypeCode from MasterFile.PackagingType where PackagingTypeCode = '" + txtCode.Text + "' and ISNULL(LastEditedBy,'')!='' ", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            DataTable stepcode = Gears.RetriveData2("Select PackagingTypeCode from MasterFile.PackagingType where PackagingTypeCode ='" + txtCode.Text + "'", Session["ConnString"].ToString());
            if (stepcode.Rows.Count > 0 && updateBtn.Text == "Add")
            {
                cp.JSProperties["cp_message"] = "PackagingTypeCode:'" + txtCode.Text + "' already Exist!";
                cp.JSProperties["cp_success"] = true;
                return;
            }


            _Entity.PackagingTypeCode = txtCode.Text;
            _Entity.Description = txtDescription.Text;
            //_Entity.CounterplanRef = txtCounterplanRef.Text;
