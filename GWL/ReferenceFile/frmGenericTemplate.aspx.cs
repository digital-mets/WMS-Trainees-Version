...
namespace GWL
{
    public partial class frmGenericTemplate : System.Web.UI.Page
    {
        Boolean view = false;//Boolean for view state

        Entity.GenericTemplate _Entity = new GenericTemplate();
            ...
            if (!IsPostBack)
            {
                ...
                switch (Request.QueryString["entry"].ToString())
                {
                    ...
                    case "E":
                        ...
                        txtLookUpKey.ReadOnly = true;
                        txtCodeLabel.ReadOnly = true;
                        break;
                    case "V":
                ...
                {
                    txtLookUpKey.Value = Request.QueryString["docnumber"].ToString();
                    _Entity.getdata(txtLookUpKey.Text,Session["ConnString"].ToString());
                    txtDescription.Value = _Entity.Description;
                    txtCodeLabel.Value = _Entity.CodeLabel;
                    txtDescriptionLabel.Value = _Entity.DescriptionLabel;
        ...
        {
            _Entity.LookupKey = txtLookUpKey.Text;
            _Entity.Description = txtDescription.Text;
            _Entity.CodeLabel = txtCodeLabel.Text;
            _Entity.DescriptionLabel = txtDescriptionLabel.Text;
