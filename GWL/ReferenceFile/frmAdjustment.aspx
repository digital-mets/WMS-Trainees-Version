<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAdjustment.aspx.cs" Inherits="GWL.frmAdjustment" %>
...
<head runat="server">
    ...
    <!--#region Region CSS-->
    <style type="text/css">/*Stylesheet for separate forms (All those which has comments are the ones that can only be changed)*/
        #form1 {
            height: 250px;
        }
        .Entry {
...
<body style="height: 910px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="Adjustment Type" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                    ...
                    <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="565px" Width="806px" Style="margin-left: -3px; margin-right: 0px;">
                        ...
                        <Items>
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="3">
                                        <Items>
                                            <dx:LayoutItem Caption="Adjustment Code" Name="AdjustmentCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server" >
                                                        <dx:ASPxTextBox ID="txtAdjustmentCode" runat="server" Width="170px">
                                            ...
                                            <dx:LayoutItem Caption="Trans Type:" Name="TransType" ColSpan="2">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <%-- <dx:ASPxTextBox ID="txtTransType" runat="server" Width="170px" OnLoad="TextboxLoad">--%>
                                                        <dx:ASPxGridLookup ID="glTransType" runat="server" Width="170px" DataSourceID="sdsTransType" 
                                                            KeyFieldName="TransType" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                            <ClientSideEvents Validation="OnValidation"/>
                                                            <ValidationSettings Display="None" ValidateOnLeave="true" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True"/>
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="Account Code:" Name="AccountCode" ColSpan="2">
                                                  <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glAccountCode" runat="server" Width="170px" DataSourceID="sdsAccountCode" 
                                                            KeyFieldName="AccountCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                            <ClientSideEvents Validation="OnValidation"/>
                                                            <ValidationSettings Display="None" ValidateOnLeave="true" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True"/>
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="Subsi Code" Name="SubsiCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glSubsiCode" runat="server" Width="170px" DataSourceID="sdsSubsiCode" 
                                                            KeyFieldName="SubsiCode" OnLoad="LookupLoad" TextFormatString="{0}" >
                                                            <ClientSideEvents Validation="OnValidation"/>
                                                            <ValidationSettings Display="None" ValidateOnLeave="true" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True"/>
                                                            </ValidationSettings>
    ...
    <asp:SqlDataSource ID="sdsAccountCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT AccountCode, Description FROM Accounting.ChartOfAccount WHERE ISNULL(IsInactive,0) = 0" OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsSubsiCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT SubsiCode, Description FROM Accounting.GLSubsiCode WHERE ISNULL(IsInactive,0) = 0" OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsTransType" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT TransType, Prompt FROM IT.MainMenu WHERE ISNULL(TransType,'') != ''" OnInit="Connection_Init"></asp:SqlDataSource>
