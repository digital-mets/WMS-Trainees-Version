<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCashReimbursement.aspx.cs" Inherits="GWL.frmCashReimbursement" %>
...
<head runat="server">
    ...
    <title>Cash Reimbursement</title>
...
<body style="height: 910px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="Cash Reimbursement" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                ...
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    ...
                    <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="600" />
                        <Items>
                                    ...
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Requestor" Name="Requestor">
                                                <LayoutItemNestedControlCollection>
                                                     <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glRequestor" ClientInstanceName="glRequestor" runat="server" DataSourceID="sdsEmployee" 
                                            ...
                                            <dx:LayoutItem Caption="Replenish Number:" Name="ReplenishNumber">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                            ...
                                            <dx:LayoutItem Caption="Expend Amount:" Name="ExpendAmount">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server" >
                            ...
                            <dx:LayoutGroup Caption="Cash Reimbursement Detail">
                                <Items>
                                    <dx:LayoutItem Caption="" ShowCaption="False">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="985px" OnCustomButtonInitialize="gv1_CustomButtonInitialize"
                                                    ...
                                                    <ClientSideEvents BatchEditConfirmShowing="OnConfirm" BatchEditStartEditing="OnStartEditing" BatchEditEndEditing="OnEndEditing" CustomButtonClick="OnCustomClick" Init="OnInitTrans"/>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="DocNumber" Visible="False" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ExpenseCode" VisibleIndex="5" Width="120px" Name="glExpenseCode" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False">
                                                             <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glExpenseCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" 
                                                                    DataSourceID="sdsExpense" KeyFieldName="ExpenseCode" ClientInstanceName="gl" TextFormatString="{0}" Width="120px" OnLoad="gvLookupLoad" >
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ExpenseDescription" VisibleIndex="6" Width="200px" Caption="ExpenseDescription" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False">   
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glExpenseDescription" runat="server" AutoGenerateColumns="False" AutoPostBack="false" ReadOnly ="true"
                                                                    KeyFieldName="ExpenseDescription" ClientInstanceName="gl2" TextFormatString="{0}" Width="200px" OnLoad="gvLookupLoad" OnInit="lookup_Init">
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ProfitCenterCode" Name="ProfitCenterCode" ShowInCustomizationForm="True" VisibleIndex="7" Width="100px" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False">
                                                            <EditItemTemplate>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="CostCenterCode" Name="CostCenterCode" ShowInCustomizationForm="True" VisibleIndex="8" Width="100px" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glCostCenterCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" 
                                                                    DataSourceID="sdsCostCenter" KeyFieldName="CostCenterCode" ClientInstanceName="gl4" TextFormatString="{0}" 
                                                                    Width="100px" OnLoad="gvLookupLoad" >
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" />
                                                                    </GridViewProperties>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="ExpenseAmount" VisibleIndex="9" Width="120px" Caption="ExpenseAmount" ReadOnly="false" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False">
                                                        ...
                                                        <dx:GridViewDataTextColumn Width="200px" Caption="Remarks" Name="Remarks" ShowInCustomizationForm="True" VisibleIndex="10" FieldName="Remarks" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field1" Name="Field1" ShowInCustomizationForm="True" VisibleIndex="11" FieldName="Field1" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field2" Name="Field2" ShowInCustomizationForm="True" VisibleIndex="12" FieldName="Field2" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field3" Name="Field3" ShowInCustomizationForm="True" VisibleIndex="13" FieldName="Field3" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field4" Name="Field4" ShowInCustomizationForm="True" VisibleIndex="14" FieldName="Field4" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field5" Name="Field5" ShowInCustomizationForm="True" VisibleIndex="15" FieldName="Field5" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field6" Name="Field6" ShowInCustomizationForm="True" VisibleIndex="16" FieldName="Field6" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field7" Name="Field7" ShowInCustomizationForm="True" VisibleIndex="17" FieldName="Field7" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field8" Name="Field8" ShowInCustomizationForm="True" VisibleIndex="18" FieldName="Field8" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Width="100px" Caption="Field9" Name="Field9" ShowInCustomizationForm="True" VisibleIndex="19" FieldName="Field9" UnboundType="String" HeaderStyle-Wrap="True" 
                                                            HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" Settings-AllowSort="False"></dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:ASPxGridView>
                                            </dx:LayoutItemNestedControlContainer>
    ...
    <asp:ObjectDataSource ID="odsHeader" runat="server" SelectMethod="getdata" TypeName="Entity.CashReimbursement" DataObjectTypeName="Entity.CashReimbursement" InsertMethod="InsertData" UpdateMethod="UpdateData">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="" Name="DocNumber" QueryStringField="docnumber" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsDetail" runat="server" SelectMethod="getdetail" TypeName="Entity.CashReimbursement+CashReimbursementDetail" DataObjectTypeName="Entity.CashReimbursement+CashReimbursementDetail" DeleteMethod="DeleteCashReimbursementDetail" InsertMethod="AddCashReimbursementDetail" UpdateMethod="UpdateCashReimbursementDetail">
        <SelectParameters>
            <asp:QueryStringParameter Name="DocNumber" QueryStringField="docnumber" Type="String" />
            <asp:SessionParameter Name="Conn" SessionField="ConnString" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsReference" runat="server" SelectMethod="getreftransaction" TypeName="Entity.CashReimbursement+RefTransaction" >
        <SelectParameters>
            <asp:QueryStringParameter Name="DocNumber" QueryStringField="docnumber" Type="String" />
            <asp:SessionParameter Name="Conn" SessionField="ConnString" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsJournalEntry" runat="server" SelectMethod="getJournalEntry" TypeName="Entity.CashReimbursement+JournalEntry" >
        <SelectParameters>
            <asp:QueryStringParameter Name="DocNumber" QueryStringField="docnumber" Type="String" />
            <asp:SessionParameter Name="Conn" SessionField="ConnString" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM Accounting.CashReimbursementDetail WHERE DocNumber IS NULL " OnInit="ConnectionInit_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsCashAdvance" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT DocNumber, DocDate FROM Accounting.CashAdvance WHERE ISNULL(SubmittedBy,'') = ''" OnInit="ConnectionInit_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsFundSource" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT FundCode, FundDescription FROM Masterfile.PettyCashFundSetup WHERE ISNULL(IsInactive,0) = 0" OnInit="ConnectionInit_Init"></asp:SqlDataSource>
