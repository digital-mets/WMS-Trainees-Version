 ...
 background: #FFF;
   ...
   <script>
    ...
    function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
       ...
       function NumPostDefault(s, e) {
           if (txtNumPost.GetText() == "" || txtNumPost.GetText() == null || txtNumPost.GetText() == '') {
               txtNumPost.SetValue('1');
           }
       }
       ...
       function DateEnd(s, e) {
           ...
           console.log(date);
		   // 11-21-2016	GC	Added (-1) on equation as per Sir Jaboy
           //var newdate = new Date(date.setMonth((parseInt(date.getMonth())) + parseInt(txtNumPost.GetText())));		   
           var newdate = new Date(date.setMonth((parseInt(date.getMonth())) + parseInt(txtNumPost.GetText()) - 1));
		   //end
...
<body style="height: 400px">
    ...
    <form id="form1" runat="server" class="Entry">
        ...
        <dx:ASPxCallbackPanel ID="cp" runat="server" Width="850px" Height="200px" ClientInstanceName="cp" OnCallback="cp_Callback">
            <ClientSideEvents EndCallback="gridView_EndCallback"></ClientSideEvents>
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="200px" Width="850px" style="margin-left: -3px">
...
<%--                                                             <ClientSideEvents Validation="OnValidation" Init="function(s,e){ s.SetDate(new Date());}" />
                                             ...
                                             <dx:LayoutItem Caption="Monthly Amortization:" Name="MonthlyAmortization">
                                              ...
                                              <dx:LayoutItem Caption="Total Amount:" Name="TotalAmount">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtTotal" ClientInstanceName="txtTotal" runat="server" Width="170px" ReadOnly="true">
                                            ...
                                            <dx:LayoutItem Caption="Number of Posting:" Name="NumPosting">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtNumPost" runat="server" ClientInstanceName="txtNumPost" MinValue="1" MaxValue="999999999" OnLoad="SpinEdit_Load" Width="170px">
                                                            <SpinButtons ShowIncrementButtons="False">
                                                            </SpinButtons>
                                                            <ClientSideEvents ValueChanged="autocalculate"  LostFocus="NumPostDefault"/>
                                                        </dx:ASPxSpinEdit>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem Caption="This Month">
                                                    ...
                                                    <dx:LayoutItem Caption="Status">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxComboBox ID="txtStatus" runat="server" ReadOnly="True" Width="170px" DropDownButton-ClientVisible="False" DropDownButton-Enabled="False" Enabled="false" DisabledStyle-ForeColor="Black">
                                                                    <Items>
                                                   ...
                                                   <%-- <dx:LayoutItem Caption="Remarks">
                                                    ...
                                                    <dx:LayoutItem Caption="Remarks">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxMemo ID="memRemarks" runat="server" OnLoad="MemoLoad" Width="545px" Height="120px" >
                                                                </dx:ASPxMemo>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
