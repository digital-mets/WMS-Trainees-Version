<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAddPartsToProperty.aspx.cs" Inherits="GWL.frmAddPartsToProperty" %>
...
<head runat="server">
    ...
    <title>Add Parts To Property</title>
   ...
   <script>
       ...
       function OnStartEditing(s, e) {//On start edit grid function     
           ...
           if (entry != "V") {
               ...
               if (e.focusedColumn.fieldName === "SizeCode") {
                   CINLife.GetInputElement().value = cellInfo.value;
               }
           }
       ...
       function OnEndEditing(s, e) {//end edit grid function, sets text after select/leaving the current lookup
           ...
           if (currentColumn.fieldName === "Life") {
               cellInfo.value = CINLife.GetValue();
               cellInfo.text = CINLife.GetText();
           }
       ...
       function lookup(s, e) {
           if (isSetTextRequired) {//Sets the text during lookup for item code
               ...
               gl.GetGridView().PerformCallback('checkdoc' + '|' + getallpropertynum + '|' + 'itemc');
       ...
       //        if (gv1.batchEditHelper.IsNewItem(indicies[i])) {
       //            propertynum = gv1.batchEditApi.GetCellValue(indicies[i], "PropertyNumber");
       //            console.log(propertynum + "trans")
       //            getalltrans += transdoc;
       //            console.log(getalltrans + " aw")
       //        }
       //        else {
       //            var keyB = gv1.GetRowKey(indicies[i]);
       //            if (gv1.batchEditHelper.IsDeletedItem(keyB))
       //                console.log("deleted row " + indicies[i]);
       //            else {
       //                transdoc = gv1.batchEditApi.GetCellValue(indicies[i], "PropertyNumber") + ";";
       //                getalltrans += transdoc;

       //            }
       //        }
       //    }
       //    gl.GetGridView().PerformCallback('checkdoc' + '|' + getalltrans + '|' + 'itemc');
       //    e.processOnServer = false;
       //}
...
<body style="height: 910px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Add Parts To Property" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                ...
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="565px" Width="850px" style="margin-left: -3px">
                        ...
                        <Items>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Life" Name="Life">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtLife" runat="server" Width="170px" ReadOnly="true">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>   
                                            ...
                                            <dx:LayoutItem Caption="Description" Name="Description">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxMemo ID="memodescription" runat="server" Width="500px" Height="150" ReadOnly="true">
                                                        </dx:ASPxMemo>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>    
                            ...
                            <dx:LayoutGroup Caption="Property Detail">
                                <Items>
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="850px" 
                                                    ...
                                                    <Settings HorizontalScrollBarMode="Visible" VerticalScrollBarMode="Auto" ColumnMinWidth="120" VerticalScrollableHeight="300" ShowFooter="true" ShowStatusBar="Hidden"/>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="PropertyNumber" VisibleIndex="2" Width="200px" Name="glPropertyNumber" Caption="PropertyNumber">
                                                             <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glPropertyNumber" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="lookup_Init"
                                                                    DataSourceID="PropertyNumberLookup" KeyFieldName="PropertyNumber" ClientInstanceName="gl" TextFormatString="{0}" Width="200px" OnLoad="gvLookupLoad">
                                                                    ...
                                                                    <Columns>
                                                                        <dx:GridViewDataTextColumn FieldName="PropertyNumber" ReadOnly="True" VisibleIndex="0" Width="300px">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="ItemCode" ReadOnly="True" VisibleIndex="1" Width="300px">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                    </Columns>
                                                                    <ClientSideEvents  KeyPress="gridLookup_KeyPress" DropDown="lookup" KeyDown="gridLookup_KeyDown"  ValueChanged="function(s,e){
                                                                    setTimeout(function(){
                                                                    CINColorCode.GetGridView().PerformCallback('PropertyNumber' + '|' + gl.GetValue() + '|' + 'itemc');
                                                                    e.processOnServer = false;
                                                                    valchange = true
                                                                    }, 1000);
                                                                  }"/>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ColorCode" VisibleIndex="5" Width="165px" Caption="ColorCode">   
                                                              <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glColorCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" 
                                                                    KeyFieldName="ColorCode" ClientInstanceName="CINColorCode" TextFormatString="{0}" Width="165px" OnInit="lookup_Init" ReadOnly="true" DropDownButton-Enabled="false">
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" />
                                                                    </GridViewProperties>
                                                                    <Columns>
                                                                    ...
                                                                    <ClientSideEvents EndCallback="GridEnd" KeyPress="gridLookup_KeyPress" KeyDown="gridLookup_KeyDown"
                                                                        ...
                                                                        CINColorCode.GetGridView().PerformCallback('ColorCode' + '|' + itemc + '|' + s.GetInputElement().value);
                                                                        e.processOnServer = false;
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="Life" Caption="Life" ReadOnly="true" VisibleIndex="8" Width="165px">
                                                        <PropertiesTextEdit ClientInstanceName="CINLife"></PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
    ...
    <asp:ObjectDataSource ID="odsDetail" runat="server" SelectMethod="getdetail" TypeName="Entity.AddPartsToProperty+AddPartsToPropertyDetail" DataObjectTypeName="Entity.AddPartsToProperty+AddPartsToPropertyDetail" DeleteMethod="DeleteAddPartsToPropertyDetail" InsertMethod="AddAddPartsToPropertyDetail" UpdateMethod="UpdateAddPartsToPropertyDetail">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="AssetAcquisitionLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT PropertyNumber,ItemCode,Description,ColorCode,ClassCode,SizeCode,Life FROM Accounting.[AssetInv]"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
