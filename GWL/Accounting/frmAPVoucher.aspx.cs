    ...
    public partial class frmAPVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    gv1.KeyFieldName = "DocNumber;LineNumber;Transtype";
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            LastEditedCheck = Gears.RetriveData2("SELECT LastEditedDate AS LastEdited FROM Accounting.APVoucher WHERE DocNumber = '" + _Entity.DocNumber + "'", Session["ConnString"].ToString());
            ...
            switch (e.Parameter)
            {
                ...
                case "Update":
                    ...
                    string strError = Functions.Submitted(_Entity.DocNumber, "Accounting.APVoucher", 1, Session["ConnString"].ToString());
