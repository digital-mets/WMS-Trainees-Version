    ...
    public partial class frmJournalVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                cboType.Value = _Entity.TemplateType;
                ...
                switch (Request.QueryString["entry"].ToString())
                {
                    case "N":
                        ...
                        if (_Entity.TemplateType == null || _Entity.TemplateType == "")
                        {
                            cboType.Value = "M";
                        }
        ...
        public void gridView_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (e.Parameters == null || String.IsNullOrEmpty(e.Parameters.ToString())) return;
            ...
            if (e.Parameters.Contains("AccountCode"))
            {
                ...
                DataTable getDescription = Gears.RetriveData2("SELECT AccountCode,Description from Accounting.ChartOfAccount where Isnull(AllowJV,0)=1 and isnull(IsInactive,0)=0 and AccountCode='" + code + "'", Session["ConnString"].ToString());
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            //  12-16-2016  GC  Added code to check if transaction has been updated by other user
            DataTable LastEditedCheck = new DataTable();
            LastEditedCheck = Gears.RetriveData2("SELECT ISNULL(LastEditedDate,'') AS LastEdited FROM Accounting.JournalVoucher WHERE DocNumber = '" + _Entity.DocNumber + "'", Session["ConnString"].ToString());
            ...
            switch (e.Parameter)
            {
                ...
                case "Update":
                    ...
                    //  12-16-2016  GC  Added code to check if transaction has been updated by other user
                    if (txtLastEditedDate.Text != (LastEditedCheck.Rows[0]["LastEdited"].ToString() == "1/1/1900 12:00:00 AM" || LastEditedCheck.Rows[0]["LastEdited"].ToString() == "" ? "" : LastEditedCheck.Rows[0]["LastEdited"].ToString()))
                    {
                ...
                case "JVT":
                    ...
                    ds.SelectCommand = string.Format("SELECT ISNULL(TotalDebit,0) AS TotalDebit, ISNULL(TotalCredit,0) AS TotalCredit, ISNULL(Description,'') AS Memo FROM Accounting.JVTemplate WHERE DocNumber = '" + glRef.Text + "'");
                    ...
                    if (tran.Count > 0)
                    {
                        ...
                        txtMemo.Text = tran[0][2].ToString();
                    }
        ...
        protected void gv1_BatchUpdate(object sender, ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["Datatable"] == "1" && check == true)
            {
                ...
                foreach (ASPxDataDeleteValues values in e.DeleteValues)
                {
                    try
                    {
                        object[] keys = { values.Keys[0], values.Keys[1] }; //2016-01-05    KMM     Ticket #13553 Add Value Key(1) for Linenumber
                ...
                foreach (ASPxDataInsertValues values in e.InsertValues)
                {
                    ...
                    source.Rows.Add(DocNumber, LineNumber, AccountCode, Description, SubsiCode, ProfitCenterCode, CostCenterCode, BizPartnerCode, Debit, Credit,
