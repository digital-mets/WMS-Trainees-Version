    ...
    public partial class frmAmortization : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                // 6/13/2017    GC  Changed .Value to .Text
                glAccount.Text = _Entity.AccountCode;
                glSubsi.Text = _Entity.SubsiCode;
                glProfit.Text = _Entity.ProfitCenterCode;
                glCost.Text = _Entity.CostCenterCode;
                ...
                // 11-21-2016	GC	Added code to fill Number of Posting when blank or zero
                if (String.IsNullOrEmpty(_Entity.NumPosting) || _Entity.NumPosting == "0")
                {
                    txtNumPost.Value = "1";
                }
                // end
                ...
                // 6/13/2017    GC  Changed .Value to .Text
                glRevAcc.Text = _Entity.ReversalGLCode;
                glRevSubsi.Text = _Entity.ReversalSubsiCode;
                glRevProfit.Text = _Entity.ReversalProfitCode;
                glRevCost.Text = _Entity.ReversalCostCode;
                glRevBiz.Text = _Entity.ReversalBizPartnerCode;
                // end
            ...
            switch (e.Parameter)
            {
                case "Add":
                    ...
                    if (error == false)
                    {
                        ...
                        _Entity.UpdateMonthlyAmortization(Request.QueryString["docnumber"].ToString(), Session["ConnString"].ToString());
