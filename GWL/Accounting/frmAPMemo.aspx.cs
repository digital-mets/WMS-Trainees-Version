...
namespace GWL
{
    public partial class frmAPMemo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["APMemoDatatable"] = null;
                Session["APMemoFilterExpression"] = null;
                Session["APMemoDetail"] = null;
        ...
        protected void lookup_Init(object sender, EventArgs e)
        {
            ...
            if (Session["APMemoFilterExpression"] != null)
            {
                gridLookup.GridView.DataSourceID = "Masterfileitemdetail";
                Masterfileitemdetail.FilterExpression = Session["APMemoFilterExpression"].ToString();
                //Session["APMemoFilterExpression"] = null;
            }
        }
        public void gridView_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            Session["APMemoFilterExpression"] = Masterfileitemdetail.FilterExpression;
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            LastEditedCheck = Gears.RetriveData2("SELECT LastEditedDate AS LastEdited FROM Accounting.APMemo WHERE DocNumber = '" + _Entity.DocNumber + "'", Session["ConnString"].ToString());
            ...
            switch (e.Parameter)
            {
                ...
                case "Update":                    
                    ...
                    string strError = Functions.Submitted(_Entity.DocNumber, "Accounting.APMemo", 1, Session["ConnString"].ToString());
        ...
        protected void gv1_BatchUpdate(object sender, ASPxDataBatchUpdateEventArgs e)
        {
            ...
            //if (Session["APMemoDatatable"] == "1" && check == true)
            //{
            //    e.Handled = true;
        ...
        //    Session["APMemoRRdet"] = RR.FilterExpression;
        ...
        protected void gv1_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["APMemoRRdet"] = null;
            }

            if (Session["APMemoRRdet"] != null)
            {
                gv1.DataSourceID = RR.ID;
                RR.FilterExpression = Session["APMemoRRdet"].ToString();
