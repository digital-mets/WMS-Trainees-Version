                                    ...
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Document Number:" Name="DocNumber">
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="spTotalDebit" runat="server" ClientInstanceName="spTotalDebit" Number="0.00" ReadOnly="True" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                 ...
                                                 <LayoutItemNestedControlCollection>
                                                     <dx:LayoutItemNestedControlContainer runat="server">
                                                         <dx:ASPxMemo ID="txtDesc" runat="server" Height="50px" OnLoad="memoremarks_Load" Width="170px">
                                                         </dx:ASPxMemo>
                                                     </dx:LayoutItemNestedControlContainer>
                                                 </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                             <dx:LayoutItem Caption="IsInactive">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxCheckBox ID="chkIsInactive" runat="server" CheckState="Unchecked" ClientInstanceName="chkIsInactive" OnLoad="CheckBoxLoad" Text=" ">
                                                        </dx:ASPxCheckBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="747px" DataSourceId="sdsDetail"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ProfitCenterCode" VisibleIndex="5" Width="100px" Name="glProfitCenterCode" Caption="ProfitCenterCode" >
                                                             <EditItemTemplate>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="CostCenterCode" VisibleIndex="6" Width="100px" Name="glCostCenterCode" Caption="CostCenterCode" >
                                                             <EditItemTemplate>
                                                             ...
                                                             <dx:GridViewDataTextColumn FieldName="BizPartnerCode" VisibleIndex="6" Width="100px" Name="glBizPartnerCode" Caption="BizPartnerCode" >
                                                             <EditItemTemplate>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn Caption="Debit" FieldName="Debit" Name="spDebit" ShowInCustomizationForm="True" VisibleIndex="14">
                                                            <PropertiesSpinEdit Increment="0" DisplayFormatString="g" ClientInstanceName="spDebit" MinValue="0" MaxValue="9999999999">
                                                            
                                                         <ClientSideEvents ValueChanged="autocalculate" />
                                                            <SpinButtons ShowIncrementButtons ="false" />
                                                            </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
                                                        <dx:GridViewDataSpinEditColumn Caption="Credit" FieldName="Credit" Name="spCredit" ShowInCustomizationForm="True" VisibleIndex="15">
                                                            <PropertiesSpinEdit Increment="0" DisplayFormatString="g" ClientInstanceName="spCredit" MinValue="0" MaxValue="9999999999">
