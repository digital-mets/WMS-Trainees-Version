...
<body style="height: 910px;">
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="TotalAmountReplenished" Name="TotalAmountReplenished">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv1" OnBatchUpdate="gv1_BatchUpdate" OnCellEditorInitialize="gv1_CellEditorInitialize" 
                                                        ...
                                                        <Settings ColumnMinWidth="120" HorizontalScrollBarMode="Visible" VerticalScrollableHeight="250" VerticalScrollBarMode="Auto" />
                                                        <ClientSideEvents Init="OnInitTrans"></ClientSideEvents>
                                                         <Columns>
                                                            ...
                                                            <dx:GridViewDataCheckColumn FieldName="Checkbox" Name="Checkbox" ShowInCustomizationForm="True" VisibleIndex="2" ReadOnly="false">
                                                            ...
                                                            <dx:GridViewDataTextColumn FieldName="TransDocNumber" VisibleIndex="4" Width="100px"></dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataDateColumn FieldName="TransDate" Visible="True" VisibleIndex="5" Caption="DocDate" ReadOnly="true" Width="100px"></dx:GridViewDataDateColumn>
                                                            <dx:GridViewDataTextColumn FieldName="LineNumber" Visible="True" VisibleIndex="3" Caption="LineNumber" ReadOnly="true" Width="0"></dx:GridViewDataTextColumn>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="TransType" Name="TransType" ShowInCustomizationForm="True" VisibleIndex="6" FieldName="TransType" ReadOnly="true"></dx:GridViewDataTextColumn>
    ...
    <%--PR Number Look Up--%>
    <asp:SqlDataSource ID="PRNumberlookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM Sales.[DeliveryReceipt] WHERE ISNULL (SubmittedBy,'')!='' and ISNULL(InvoiceDocNum,'') =''"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
