    ...
    public partial class frmCollection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                txtHDue.Value = _Entity.TotalAmountDue.ToString();
                txtHApplied.Value = _Entity.TotalApplied.ToString();
                txtHAdjustment.Value = _Entity.TotalAdjustment.ToString();
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
                ...
                _Entity.TotalAmountDue = String.IsNullOrEmpty(txtHDue.Text) ? 0 : Convert.ToDecimal(txtHDue.Value.ToString());
                _Entity.TotalApplied = String.IsNullOrEmpty(txtHApplied.Text) ? 0 : Convert.ToDecimal(txtHApplied.Value.ToString());
                _Entity.TotalAdjustment = String.IsNullOrEmpty(txtHAdjustment.Text) ? 0 : Convert.ToDecimal(txtHAdjustment.Value.ToString());
