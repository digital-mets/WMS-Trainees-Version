...
<body style="height: 910px">
                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="1">
                                        <Items>
                                            <dx:LayoutGroup Caption="Property Transfer Information" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Transfer Document Number" Name="DocNumber">
                                                    ...
                                                    <dx:LayoutItem Caption="Transfer Document Date" Name="DocDate" RequiredMarkDisplayMode="Required">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv1" OnCommandButtonInitialize="gv_CommandButtonInitialize" OnCustomButtonInitialize="gv1_CustomButtonInitialize" Width="100%" SettingsBehavior-AllowSort="False"
                                                                    ...
                                                                    <ClientSideEvents BatchEditConfirmShowing="OnConfirm" CustomButtonClick="OnCustomClick" BatchEditEndEditing="OnEndEditing"  BatchEditStartEditing="OnStartEditing" Init="OnInitTrans"
                                                                        ...
                                                                        <Settings  VerticalScrollBarMode="Auto" VerticalScrollBarStyle="Virtual"  VerticalScrollableHeight="200" HorizontalScrollBarMode="Visible" />
                                                                ...
                                                                <Image IconID="support_info_16x16" ToolTip="Details"></Image>
                                                                        ...
                                                                        <dx:GridViewDataSpinEditColumn FieldName="Qty" Name="Qty"  ShowInCustomizationForm="True" VisibleIndex="11" Width="100" UnboundType="Bound" ReadOnly="true">
                                                                            <PropertiesSpinEdit Increment="0" ClientInstanceName="txtOrderQty" SpinButtons-ShowIncrementButtons="false" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}">
                                                                        ...
                                                                        <dx:GridViewDataTextColumn Caption="NewLocation" FieldName="NewLocation" VisibleIndex="13" Width="150px" Name="NewLocation">
                                                                             <EditItemTemplate>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn Caption="Department" FieldName="Department" Name="Department" ShowInCustomizationForm="True" VisibleIndex="14" Width="150px" ReadOnly="true">
                                                                        </dx:GridViewDataTextColumn>

                                                                        <dx:GridViewDataTextColumn Caption="NewDepartment" FieldName="NewDepartment" VisibleIndex="15" Width="150px" Name="NewDepartment">
                                                                             <EditItemTemplate>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn Caption="AccountablePerson" FieldName="AccountablePerson" Name="AccountablePerson" ShowInCustomizationForm="True" VisibleIndex="16" Width="150" ReadOnly="true">
                                                                        </dx:GridViewDataTextColumn>
                                                                        
                                                                        <dx:GridViewDataTextColumn Caption="NewAccountablePerson" FieldName="NewAccountablePerson" VisibleIndex="17" Width="150px" Name="NewAccountablePerson">
                                                                             <EditItemTemplate>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn Caption="WarehouseCode" FieldName="WarehouseCode" Name="WarehouseCode" ShowInCustomizationForm="True" VisibleIndex="18" Width="150px" ReadOnly="true">
                                                                        </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="PropertyNumberLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT PropertyNumber, FullDesc FROM Accounting.[AssetInv] AI LEFT JOIN Masterfile.Item I ON AI.ItemCode = I.ItemCode WHERE Status IN ('O','H')"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="NewLocationLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT LocationCode,LocationDescription FROM Masterfile.[Location] WHERE ISNULL(IsInactive,0) = 0"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="NewAccountablePersonLookup" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT EmployeeCode,EmployeeID FROM Masterfile.[BPEmployeeInfo] WHERE ISNULL(IsInactive,0) = 0"
        OnInit = "Connection_Init">
    </asp:SqlDataSource>
