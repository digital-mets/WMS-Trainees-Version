...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
        ...
        function autocalculate(s, e) {
            ...
            setTimeout(function () { //New Rows
                ...
                for (var i = 0; i < indicies2.length; i++) {
                    if (gv2.batchEditHelper.IsNewItem(indicies2[i])) {
                ...
                txttotalcheck.SetText(totalcheck.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
                txttotalapplied.SetText(totalapplied.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
            }, 500);
            //console.log(totalapplied + 'here');
        ...
        function autocalculate2(s, e) {
            ...
            var total = 0.00;
            var total2 = 0.00;
            var numcheck = txttotalcheck.GetValue();
            var totalapplied = 0.00;
            setTimeout(function () { //New Rows
            ...
            setTimeout(function () {
                ...
                // totalapplied = Math.abs(totalapplied); //RA 2016-05-30
                //}
                // if (total2 > 0) {
                //      totalapplied = (totalapplied + total2);
                //  }
                //  else if (total2 < 0) {
                //  total2 = Math.abs(total2); //RA 2016-05-30
                //     totalapplied = (totalapplied - total2);
                //  }

                console.log(totalapplied.toFixed(2) + ' ' + total2 + ' ' + numcheck)
                console.log(parseFloat(numcheck) + parseFloat(totalapplied.toFixed(2)));
                var pretotal = parseFloat(numcheck) + parseFloat(totalapplied.toFixed(2));
                
                total2 =  pretotal.toFixed(2) - parseFloat(total2);
                ...
                //console.log(total2);
                if (glTrans.GetValue() == 'P') {
                    txtVar.SetText(total2.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'));
                }
            }, 500);
...
<form id="form1" runat="server" class="Entry">
                                    ...
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            <dx:LayoutItem Caption="Document Number">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtDocNumber" runat="server" ReadOnly="true" AutoCompleteType="Disabled" OnLoad="TextboxLoad" Width="170px">
                                                        </dx:ASPxTextBox>
                                            ...
                                            <dx:LayoutItem Caption="Supplier Code" Name="Supplier">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="gvSupplier" ClientInstanceName="gvSup"  Width="170px" runat="server" DataSourceID="Masterfilebiz" KeyFieldName="SupplierCode" OnLoad="LookupLoad" TextFormatString="{0}">
                                                            <GridViewProperties>
                                                            ...
                                                            <Columns><dx:GridViewDataTextColumn FieldName="SupplierCode" >
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxComboBox ID="TransType" runat="server" Width="170px" ClientInstanceName="glTrans" OnLoad="ComboBox_Load">
                                                            ...
                                                            <Items>
                                                                <dx:ListEditItem Text="Payment" Value="P" />
                                                                <dx:ListEditItem Text="Advances" Value="A" />
                                                                <dx:ListEditItem Text="Fund Transfer" Value="F" />
                                                            </Items>
                                                        </dx:ASPxComboBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            ...
                                            <dx:LayoutItem Caption="Remarks">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxMemo ID="txtRemarks" runat="server" Height="71px" OnLoad="MemoLoad" Width="170px">
                                                        </dx:ASPxMemo>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="850"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="BankAccount" VisibleIndex="3" ReadOnly="true">
                                                            <EditItemTemplate>
                                                                    <dx:ASPxGridLookup ID="glBankAccount" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="lookup_Init3"
                                                                        DataSourceID="Masterfilebank" KeyFieldName="BankAccountCode" ClientInstanceName="gl" TextFormatString="{0}" Width="80px">
                                                                        ...
                                                                        <ClientSideEvents DropDown="lookup" EndCallback="GridEnd" KeyPress="gridLookup_KeyPress" KeyDown="gridLookup_KeyDown" RowClick="function(s,e){
                                                                       loader.Show();
                                                         ...
                                                         <dx:GridViewDataTextColumn FieldName="Bank" ShowInCustomizationForm="True" VisibleIndex="4" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Branch" ShowInCustomizationForm="True" VisibleIndex="5" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="PayeeName" VisibleIndex="6" PropertiesTextEdit-EncodeHtml="false">
                                                            <%--<EditItemTemplate>
                                                        ...
                                                        <dx:GridViewDataDateColumn FieldName="CheckDate" ShowInCustomizationForm="True" VisibleIndex="7" PropertiesDateEdit-ClientInstanceName="txtCheckDate">
                                                            <PropertiesDateEdit>
                                                                <ClientSideEvents ValueChanged="function(){gv1.batchEditApi.EndEdit();}" />
                                                            </PropertiesDateEdit>
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataTextColumn FieldName="CheckNumber" ShowInCustomizationForm="True" VisibleIndex="8" Width="120px">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataSpinEditColumn FieldName="CheckAmount" ShowInCustomizationForm="True" VisibleIndex="9" Width="100px" UnboundType="Decimal">
                                                        ...
                                                        <dx:GridViewDataCheckColumn FieldName="IsCross" ShowInCustomizationForm="True" VisibleIndex="10">
                                                            <PropertiesCheckEdit>
                                                            <ClientSideEvents CheckedChanged="function(){gv1.batchEditApi.EndEdit();}"/>
                                                            </PropertiesCheckEdit>
                                                        </dx:GridViewDataCheckColumn>
                                                         <dx:GridViewDataDateColumn FieldName="ReleasedDate" ShowInCustomizationForm="True" VisibleIndex="10" ReadOnly="true" PropertiesDateEdit-ClientInstanceName="txtReleasedDate">
                                                        </dx:GridViewDataDateColumn>
                                                         <dx:GridViewDataDateColumn FieldName="ClearedDate" ShowInCustomizationForm="True" VisibleIndex="11" ReadOnly="true" PropertiesDateEdit-ClientInstanceName="txtClearedDate">
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Field1" VisibleIndex="11" Caption="Field1" Name="Field1">
                                                        </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv3" runat="server" AutoGenerateColumns="False" Width="960" KeyFieldName="DocNumber;LineNumber"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewCommandColumn ButtonType="Image" ShowDeleteButton="True" ShowInCustomizationForm="True" VisibleIndex="1" Width="40px" Name="NewButtonCol">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="AccountCode" VisibleIndex="3" ReadOnly="true">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glAccountCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" 
                                                                        DataSourceID="COA" KeyFieldName="AccountCode" ClientInstanceName="gl3" TextFormatString="{0}" Width="80px">
                                                                        <GridViewProperties Settings-ShowFilterRow="true" SettingsBehavior-FilterRowMode="OnClick" SettingsPager-PageSize="5">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="AccountDescription" VisibleIndex="4" ReadOnly="true">
                                                            <EditItemTemplate>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="SubsidiaryCode" VisibleIndex="5" ReadOnly="true" >
                                                        <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glSubsidiaryCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="lookup_Init" 
                                                                        DataSourceID="Subsi" KeyFieldName="SubsiCode" ClientInstanceName="gl4" TextFormatString="{0}" Width="80px">
                                                                        <GridViewProperties Settings-ShowFilterRow="true" SettingsBehavior-FilterRowMode="OnClick" SettingsPager-PageSize="5">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="SubsidiaryDescription" ShowInCustomizationForm="True" VisibleIndex="6" UnboundType="Bound" ReadOnly="True" Width="80px">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="ProfitCenterCode" ShowInCustomizationForm="True" VisibleIndex="7" UnboundType="Bound" Width="80px"> 
                                                        <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glProfitCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" 
                                                                        DataSourceID="Profitsql" KeyFieldName="ProfitCenterCode" ClientInstanceName="gl5" TextFormatString="{0}" Width="80px" OnLoad="gvLookupLoad">
                                                                        <GridViewProperties Settings-ShowFilterRow="true" SettingsBehavior-FilterRowMode="OnClick" SettingsPager-PageSize="5">
                                                                            <SettingsBehavior AllowSelectByRowClick="True" AllowSelectSingleRowOnly="true"
                                                                                AllowFocusedRow="true" />
                                                                        </GridViewProperties>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="CostCenterCode" ShowInCustomizationForm="True" VisibleIndex="8">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glCostcode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="lookup_Init2" 
                                                                        DataSourceID="Costsql" KeyFieldName="CostCenterCode" ClientInstanceName="gl6" TextFormatString="{0}" Width="80px" OnLoad="gvLookupLoad">
                                                                        <GridViewProperties Settings-ShowFilterRow="true" SettingsBehavior-FilterRowMode="OnClick" SettingsPager-PageSize="5">
                                                                            <SettingsBehavior AllowSelectByRowClick="True" AllowFocusedRow="true"
                                                                                AllowSelectSingleRowOnly="True" />
                                                                        </GridViewProperties>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="DebitAmount" ShowInCustomizationForm="True" VisibleIndex="9">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="CreditAmount" ShowInCustomizationForm="True" VisibleIndex="10">
                                                        <PropertiesSpinEdit Increment="0" DisplayFormatString="{0:N}" MinValue="0"
                                                                 SpinButtons-ShowIncrementButtons="false">
                                                        <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                            <ClientSideEvents ValueChanged="autocalculate2" />
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="TotalAmount" ShowInCustomizationForm="True" VisibleIndex="11" Width="0px">
                                                        <PropertiesSpinEdit Increment="0" DisplayFormatString="{0:N}" MinValue="0"
                                                                 SpinButtons-ShowIncrementButtons="false">
                                                        <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                        </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Field1" ShowInCustomizationForm="True" Name="Field1" Caption="Field1" VisibleIndex="11"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Field2" ShowInCustomizationForm="True" Name="Field2" Caption="Field2" VisibleIndex="12"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Field3" Caption="Field3"  Name="Field3" ShowInCustomizationForm="True" VisibleIndex="13" UnboundType="Bound">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Field4" Caption="Field4"  Name="Field4" ShowInCustomizationForm="True" VisibleIndex="14" UnboundType="Bound">
                                                        </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="sdsDetail2" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM  accounting.CheckVoucherTagging where DocNumber is null " OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsDetail3" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM  accounting.CheckVoucherAdjEntry where DocNumber is null " OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="COA" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select AccountCode,Description from Accounting.ChartOfAccount where ISNULL(AllowJV,0) = 1" OnInit="Connection_Init"></asp:SqlDataSource>
