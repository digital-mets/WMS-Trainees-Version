...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
       ...
       function autocalculate(s, e) {
           ...
           if (txtCashAmount.GetText() == null || txtCashAmount.GetText() == "")
               cashAmount = 0;
           else
               cashAmount = txtCashAmount.GetText();
...
<body style="height: 910px">
                                    ...
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Supplier Name" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtSupplierName" runat="server" ReadOnly="false" Width="170px">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutGroup Caption="Application Detail" >
                                                <Items>
                                                    <dx:LayoutItem Caption="Reference Numbers:" Name ="RC">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="glReferenceChecks" runat="server" AutoGenerateColumns="False" DataSourceID="sdsApplicationDetail" KeyFieldName="LineNumber" OnLoad="LookupLoad" SelectionMode="Multiple" TextFormatString="{0}" OnInit="glReferenceChecks_Init">
                                                                    <GridViewProperties>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="TransDocNumber" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                         <dx:GridViewDataTextColumn FieldName="TransType" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="2">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataDateColumn Caption="TransDate" FieldName="TransDate" ShowInCustomizationForm="True" VisibleIndex="3" ReadOnly ="true">
                                                                        ...
                                                                        <dx:GridViewDataDateColumn Caption="DueDate" FieldName="DueDate" ShowInCustomizationForm="True" VisibleIndex="4" ReadOnly ="true">
                                                                            <PropertiesDateEdit DisplayFormatString="MM/dd/yyyy" AllowMouseWheel="false" DropDownButton-Enabled="false" DropDownButton-ClientVisible ="false">
                                                                            <DropDownButton Enabled="False" ClientVisible="False"></DropDownButton>
                                                                            </PropertiesDateEdit>
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataDateColumn>
                                                                         <dx:GridViewDataTextColumn FieldName="AccountCode" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="5">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="SubsidiaryCode" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="6">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="ProfitCenterCode" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="7">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="CostCenterCode" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="8">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="TransAmount" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="9">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="TransAppliedAmount" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="10">
                                                                            <Settings AutoFilterCondition ="Contains" />
                                                                        </dx:GridViewDataTextColumn>
                                                                    </Columns>
                                                                ...
                                                                <dx:ASPxGridView ID="gv2" runat="server" AutoGenerateColumns="False" Width="985px" OnCommandButtonInitialize="gv_CommandButtonInitialize" 
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataSpinEditColumn FieldName="TransAppliedAmount" VisibleIndex="12" Width="130px" Caption="TransAppliedAmount" >   
                                                                             <PropertiesSpinEdit ClientInstanceName="gl9" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" DisplayFormatString="{0:N}" MaxValue="2147483647">
                                                                                <ClientSideEvents ValueChanged="autocalculate" />
                                                                            </PropertiesSpinEdit>
                                                                        </dx:GridViewDataSpinEditColumn>
                                                        ...
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="985px" OnCustomButtonInitialize="gv1_CustomButtonInitialize"
                                                                    OnCellEditorInitialize="gv2_CellEditorInitialize" ClientInstanceName="gv1"  OnBatchUpdate="gv1_BatchUpdate" KeyFieldName="DocNumber;LineNumber">
                                                                    <ClientSideEvents CustomButtonClick="OnCustomClick_2" />
                                                                    <ClientSideEvents BatchEditConfirmShowing="OnConfirm_2" BatchEditStartEditing="OnStartEditing_2" BatchEditEndEditing="OnEndEditing_2"/>
                                                                    <SettingsPager Mode="ShowAllRecords"/><SettingsEditing Mode="Batch" />
                                                                    <Settings HorizontalScrollBarMode="Visible" VerticalScrollBarMode="Auto" ColumnMinWidth="120" VerticalScrollableHeight="150" ShowFooter="True"  /> 
                                                                    <SettingsCommandButton>
                                                                        <NewButton><Image IconID="actions_addfile_16x16"></Image></NewButton>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataSpinEditColumn FieldName="DebitAmount" ShowInCustomizationForm="True" VisibleIndex="9" Width="130px">
                                                                            <PropertiesSpinEdit DisplayFormatString="{0:N}" SpinButtons-ShowIncrementButtons="false" MaxValue="2147483647">
    ...
    <%--<!--#region Region Header --> --%>
    <asp:ObjectDataSource ID="odsHeader" runat="server" SelectMethod="getdata" TypeName="Entity.CashPaymentVoucher" DataObjectTypeName="Entity.CashPaymentVoucher" InsertMethod="InsertData" UpdateMethod="UpdateData">
        <SelectParameters>
