                            ...
                            <dx:TabbedLayoutGroup>
                                <Items>
                                            ...
                                            <dx:LayoutGroup Caption="Amount" ColCount="2">
                                                <Items>
                                                    <dx:LayoutItem Caption="Total Cash Amount">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtHCash" runat="server" Width="170px" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" ReadOnly="true" ClientInstanceName ="txtHCash" DisplayFormatString ="{0:N}">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Total Amount Due">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtHDue" runat="server" Width="170px"  NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" ReadOnly="true" ClientInstanceName ="txtHDue" DisplayFormatString ="{0:N}">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Total Bank Credit Amount">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtHCredit" runat="server" Width="170px" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" ReadOnly="true" ClientInstanceName ="txtHCredit" DisplayFormatString ="{0:N}">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Total Amount Applied">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtHApplied" runat="server" Width="170px" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" ReadOnly="true" ClientInstanceName ="txtHApplied" DisplayFormatString ="{0:N}">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Total Check Amount">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtHCheck" runat="server" Width="170px" NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" ReadOnly="true" ClientInstanceName ="txtHCheck" DisplayFormatString ="{0:N}">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Total Adjustment Amount">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="txtHAdjustment" runat="server" Width="170px"  NullDisplayText="0.00" ConvertEmptyStringToNull="False" NullText="0.00" ReadOnly="true" ClientInstanceName ="txtHAdjustment" DisplayFormatString ="{0:N}">
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                    ...
                                    <dx:LayoutGroup Caption="Collection Reconciliation">
                                        <Items>
                                            <dx:LayoutGroup Caption="Application of Sales Invoice">
                                                <Items>
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
		                                                                    <dx:ASPxButton ID="btnGenerate" runat="server" AutoPostBack="False" Width="100px" Theme="MetropolisBlue" Text="Populate Detail" OnLoad="Button_Load">
...
<Settings ShowStatusBar="Hidden"></Settings>
    ...
    <asp:SqlDataSource ID="sdsRefTrans" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT DISTINCT RecordID, TransType, DocNumber, DocDate, AccountCode, SubsiCode, ProfitCenter, CostCenter, BizPartnerCode, ISNULL(Amount,0) - ISNULL(Applied,0) AS Amount, CounterDocNumber AS CounterReceiptNo FROM Accounting.SubsiLedgerNonInv WHERE TransType IN ('ACTSIN','ACTARM','ACTSEB') AND ISNULL(Applied,0) <> ISNULL(Amount,0)" OnInit ="Connection_Init"></asp:SqlDataSource>	
