...
<body style="height: 910px">
                                                        ...
                                                        <dx:ASPxGridLookup ID="glRef" ClientInstanceName="glRef" runat="server" Onload="LookupLoad" AutoGenerateColumns="False" DataSourceID="JVTemplate" KeyFieldName="DocNumber"  TextFormatString="{0}" Width="170px">
                                                            ...
                                                            <Columns>
                                                               ...
                                                               <Settings AutoFilterCondition="Contains" />
                                                                ...
                                                                <dx:GridViewDataTextColumn FieldName="TotalDebit" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                                               <Settings AutoFilterCondition="Contains" />
                                                                     </dx:GridViewDataTextColumn>
                                                                <dx:GridViewDataTextColumn FieldName="TotalCredit" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                                               <Settings AutoFilterCondition="Contains" />
                                                                     </dx:GridViewDataTextColumn>
                                             ...
                                             <dx:LayoutItem Caption="Memo">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxMemo ID="txtMemo" runat="server" Height="50px" OnLoad="memoremarks_Load" Width="170px">
                                                        </dx:ASPxMemo>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer26" runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="747px" DataSourceId="sdsDetail"
                                                    ...
                                                    <SettingsPager Mode="ShowAllRecords" />  
                                                            <SettingsEditing Mode="Batch" />
                                                    <Settings HorizontalScrollBarMode="Visible" VerticalScrollBarMode="Auto" ColumnMinWidth="120" VerticalScrollableHeight="400"  /> 
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="LineNumber" VisibleIndex="2" Caption="Line" ReadOnly="True" Width="0px" Visible="True">
                                                         ...
                                                         <dx:GridViewDataTextColumn FieldName="AccountCode" VisibleIndex="3" Width="100px" Name="glAccountCode" Caption="AccountCode" >
                                                             <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glAccountCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" 
                                                                    DataSourceID="AccountCode" KeyFieldName="AccountCode" ClientInstanceName="gl" TextFormatString="{0}" Width="80px">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="SubsiCode" VisibleIndex="4" Width="80px" Caption="SubsiCode" Name="glSubsiCode" >   
                                                                                                                        <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glSubsiCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" DataSourceID="SubsiCode" 
                                                                    KeyFieldName="SubsiCode" ClientInstanceName="gl2" TextFormatString="{0}" Width="80px" OnInit="lookup_Init">
                                                                    <GridViewProperties Settings-ShowFilterRow="true" >
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True"  />
                                                                    </GridViewProperties>
                                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ProfitCenterCode" VisibleIndex="5" Width="110px" Name="glProfitCenterCode" Caption="ProfitCenterCode" >
                                                             <EditItemTemplate>
                                                                ...
                                                                KeyFieldName="ProfitCenterCode" ClientInstanceName="gl3" TextFormatString="{0}" Width="80px" >
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True"
                                                                            />
                                                                    </GridViewProperties>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="CostCenterCode" VisibleIndex="6" Width="110px" Name="glCostCenterCode" Caption="CostCenterCode" >
                                                             <EditItemTemplate>
                                                                ...
                                                                KeyFieldName="CostCenterCode" ClientInstanceName="gl4" TextFormatString="{0}" Width="80px" >
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" 
                                                                             />
                                                                    </GridViewProperties>
                                                             ...
                                                             <dx:GridViewDataTextColumn FieldName="BizPartnerCode" VisibleIndex="7" Width="110px" Name="glBizPartnerCode" Caption="BizPartnerCode" >
                                                             <EditItemTemplate>
                                                                ...
                                                                KeyFieldName="BizPartnerCode" ClientInstanceName="gl5" TextFormatString="{0}" Width="80px" >
                                                                    <GridViewProperties Settings-ShowFilterRow="true">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True"
                                                                             />
                                                                    </GridViewProperties>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn Caption="Debit" FieldName="Debit" Name="spDebit" ShowInCustomizationForm="True" VisibleIndex="8">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn Caption="Credit" FieldName="Credit" Name="spCredit" ShowInCustomizationForm="True" VisibleIndex="9">
                                                            <PropertiesSpinEdit Increment="0" DisplayFormatString="{0:N}"  ClientInstanceName="spCredit" MinValue="0" MaxValue="9999999999">
                                                                <ClientSideEvents ValueChanged="autocalculate" />
                                                                <SpinButtons ShowIncrementButtons ="false" />
                                                            </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field1" Name="Field1" ShowInCustomizationForm="True" VisibleIndex="10" FieldName="Field1" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field2" Name="Field2" ShowInCustomizationForm="True" VisibleIndex="11" FieldName="Field2" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field3" Name="Field3" ShowInCustomizationForm="True" VisibleIndex="12" FieldName="Field3" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field4" Name="Field4" ShowInCustomizationForm="True" VisibleIndex="13" FieldName="Field4" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field5" Name="Field5" ShowInCustomizationForm="True" VisibleIndex="14" FieldName="Field5" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field6" Name="Field6" ShowInCustomizationForm="True" VisibleIndex="15" FieldName="Field6" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field7" Name="Field7" ShowInCustomizationForm="True" VisibleIndex="16" FieldName="Field7" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field8" Name="Field8" ShowInCustomizationForm="True" VisibleIndex="17" FieldName="Field8" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Field9" Name="Field9" ShowInCustomizationForm="True" VisibleIndex="18" FieldName="Field9" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM  Accounting.JournalVoucherDetail where DocNumber  is null " OnInit = "Connection_Init" >
        ...
        <asp:SqlDataSource ID="SubsiCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select A.AccountCode,B.SubsiCode,B.Description from Accounting.ChartOfAccount A inner join Accounting.GLSubsiCode B on A.AccountCode = B.AccountCode" OnInit = "Connection_Init"></asp:SqlDataSource>
            <asp:SqlDataSource ID="ProfitCenterCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT ProfitCenterCode, Description FROM Accounting.ProfitCenter" OnInit = "Connection_Init"></asp:SqlDataSource>
     ...
     <asp:SqlDataSource ID="Currency" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select Currency,CurrencyName from masterfile.Currency where isnull(IsInactive,0)=0" OnInit = "Connection_Init"></asp:SqlDataSource>
        <asp:SqlDataSource ID="ItemCategory" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select ItemCategoryCode,Description from Masterfile.ItemCategory where isnull(IsInactive,0)=0" OnInit = "Connection_Init"></asp:SqlDataSource>
                <asp:SqlDataSource ID="JVTemplate" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select DocNumber,DocDate, TotalDebit, TotalCredit,Description from Accounting.JVTemplate where isnull(IsInactive,0)=0" OnInit = "Connection_Init"></asp:SqlDataSource>
                        <asp:SqlDataSource ID="sdsJVTDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select A.DocNumber, A.LineNumber, A.AccountCode, A.SubsiCode, A. ProfitCenterCode, A. CostCenterCode, A.BizPartnerCode, A.Debit, A. Credit,A.Field1,A.Field2,A.Field3,A.Field4,A.Field5,A.Field6,A.Field7,A.Field8,A.Field9 from Accounting.JVTemplateDetail A inner join Accounting.JVTemplate B on A.DocNumber = B.DocNumber" OnInit = "Connection_Init"></asp:SqlDataSource>
