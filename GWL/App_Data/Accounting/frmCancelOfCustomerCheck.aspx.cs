    ...
    public partial class frmCancelOfCustomerCheck : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dtpCheckDate.Value = String.IsNullOrEmpty(_Entity.CheckDate) ? DateTime.Now : Convert.ToDateTime(_Entity.CheckDate);
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            _Entity.CancelledBy = txtCancelledBy.Text;
            _Entity.CancelledDate = txtCancelledDate.Text;
            ...
            switch (e.Parameter)
            {
                ...
                case "Update": 
                    string strError1 = Functions.Submitted(_Entity.DocNumber, "Accounting.CancellationOfCustomerCheck", 1, Connection);//NEWADD factor 1 if submit, 2 if approve
                ...
                case "CheckNumber":
                    ...
                    ds.SelectCommand = string.Format("select DISTINCT DocNumber, CheckNumber, CheckDate, CheckAmount From Accounting.CollectionChecks where CheckNumber = '" + Check + "' AND DocNumber = '" + Num + "'");
        ...
        public void typefilter()
        {
            ...
            if (type == "Pull-out")
            {
                sdsCheckNumber.SelectCommand = "select DocNumber, CheckNumber from accounting.CollectionChecks A Where ISNULL(DepositedDate,'') = '' AND ISNULL(DateCleared,'') = ''";
