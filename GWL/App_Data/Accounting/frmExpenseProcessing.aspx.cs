...
namespace GWL
{
    public partial class frmExpenseProcessing : System.Web.UI.Page
    {
        ...
        public void gridView_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable getqty = Gears.RetriveData2("SELECT DISTINCT A.ServiceCode, A.Description, A.AccountCode, A.SubsiCode, ISNULL(A.IsVatable,0) AS IsVatable, A.VATCode, "
        ...
        {
            if (Session["ExpProSupplier"] != null && Session["ExpProSupplier"].ToString() != "")
            {
