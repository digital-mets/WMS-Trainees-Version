                                    ...
                                    <dx:LayoutGroup Caption="General">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Group Code">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="gvGroupCode" runat="server" DataSourceID="Group" KeyFieldName="GroupCode" OnLoad="LookupLoad" 
                                            ...
                                            <%--<dx:LayoutItem Caption="Account Code:" Name="AccountCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox1" runat="server"  Width="170px" OnLoad="TextboxLoad" MaxLength="4">
                                            ...
                                            <dx:LayoutItem Caption="Account Code:" Name="AccountCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxSpinEdit ID="txtAccount" runat="server"  Width="170px" OnLoad="SpinEdit_Load" MaxLength="4" OnInit="txtAccount_Init">
                                                            <ClientSideEvents Validation="OnValidation" />
                                                            <ValidationSettings Display="None" ErrorDisplayMode="ImageWithTooltip">
                                                                <RequiredField IsRequired="True" />
                                                            </ValidationSettings>
                                            ...
                                            <dx:LayoutItem Caption="Fixed Cost Center">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glCost" runat="server" DataSourceID="CostCenterCode" KeyFieldName="CostCenterCode" 
                                        ...
                                        <Items>
                                            <dx:LayoutItem ShowCaption="False">
                                                <LayoutItemNestedControlCollection>
                                                    ...
                                                    OnRowValidating="grid_RowValidating" OnBatchUpdate="gv1_BatchUpdate" KeyFieldName="AccountCode">
...
<%--                                                        <dx:GridViewCommandColumn ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="1" Width="60px" ShowNewButtonInHeader="true">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="SubsiCode" VisibleIndex="14" Caption="SubsiCode" Name="SubsiCode">   
                                                                                                                     
                                                        </dx:GridViewDataTextColumn>
                                                         <dx:GridViewDataTextColumn FieldName="Description" VisibleIndex="15" Width="170px" Caption="Description" >
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataCheckColumn Caption="IsInactive" FieldName="IsInactive" Name="IsInactive" ShowInCustomizationForm="True" VisibleIndex="16">
    ...
    <asp:SqlDataSource ID="ItemCategory" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select ItemCategoryCode,Description from Masterfile.ItemCategory where isnull(IsInactive,'')=0" OnInit = "Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SubsiCode" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select B.SubsiCode,B.Description from Accounting.ChartOfAccount A inner join Accounting.GLSubsiCode B on A.AccountCode = B.AccountCode" OnInit = "Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="Group" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select GroupCode, GroupLevel, Description, AccountFr, AccountTo from accounting.GLAccountGroup" OnInit = "Connection_Init"></asp:SqlDataSource>
