        ...
        function autocalculate(s, e) {
            ...
            setTimeout(function () {
                ...
                for (var x = 0; x <= indicies.length; x++) {
                    if (gv1.batchEditHelper.IsNewItem(indicies[x])) {
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ExpenseCode" VisibleIndex="3" Width="100px">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glExpenseCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="lookup_Init"
                                                                    DataSourceID="MasterfileExpense" KeyFieldName="ServiceCode" ClientInstanceName="gl" TextFormatString="{0}" Width="100px" OnLoad="gvLookupLoad">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="VATCode" VisibleIndex="13" Width="100px">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glVATCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false"  OnInit="lookup_Init"
                                                                    DataSourceID="MasterfileTax" KeyFieldName="TCode" ClientInstanceName="gl3" TextFormatString="{0}" Width="100px" OnLoad="gvLookupLoad">
                                                                    <GridViewProperties Settings-ShowFilterRow="true" SettingsBehavior-FilterRowMode="OnClick">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True"
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ATCCode" ShowInCustomizationForm="True" VisibleIndex="16" Width="100px">
                                                            <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glATCCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="lookup_Init"  
                                                                    DataSourceID="MasterfileATC" KeyFieldName="ATCCode" ClientInstanceName="gl2" TextFormatString="{0}" Width="100px" OnLoad="gvLookupLoad"
                                                                        >
                                                                    <GridViewProperties Settings-ShowFilterRow="true" SettingsBehavior-FilterRowMode="OnClick">
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True"
                                                                            AllowSelectSingleRowOnly="True" />
...
<form id="form2" runat="server" visible="false">
    ...
    <asp:SqlDataSource ID="sdsBizPartner" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT BizPartnerCode, RTRIM(LTRIM(Name)) AS Name, Address FROM Masterfile.BizPartner WHERE ISNULL(IsInactive,0) = 0" OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT * FROM Accounting.ExpenseProcessingDetail WHERE DocNumber IS NULL" OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="MasterfileExpense" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT ServiceCode, Description,Type FROM Masterfile.[Service] where Type = 'expense' and isnull(isinactive,0) = 0" OnInit="Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="MasterfileTax" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT TCode, Description, Rate FROM Masterfile.[Tax]" OnInit="Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsSubsi" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT AccountCode, SubsiCode, Description FROM Accounting.GLSubsiCode WHERE ISNULL(IsInactive,0) = 0" OnInit = "Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsSupplier" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT DISTINCT SupplierCode AS Supplier, Name AS Name FROM Masterfile.BPSupplierInfo WHERE ISNULL(IsInactive,0) = 0" OnInit = "Connection_Init"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsPOReference" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT A.DocNumber AS PONumber, B.DocDate AS PODate, B.SupplierCode, C.Name, B.TargetDeliveryDate, B.CommitmentDate, A.PRNumber, A.ServiceType AS ServiceCode, A.Description AS ServDesc, 
        ...
        ISNULL(B.SubmittedBy,'') != '' AND ISNULL(B.CancelledBy,'') = '' AND B.Status IN ('N','P') AND ISNULL(A.IsClosed,0) = 0 AND 1=0" OnInit ="Connection_Init"></asp:SqlDataSource>	
    <asp:SqlDataSource ID="sdsTransDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT '' AS DocNumber, RIGHT('00000'+ CAST(ROW_NUMBER() OVER (ORDER BY A.DocNumber, A.LineNumber) AS VARCHAR(5)),5) AS LineNumber, A.DocNumber AS PONumber,
        ...
        A.Field1, A.Field2, A.Field3, A.Field4, A.Field5, A.Field6, A.Field7, A.Field8, A.Field9, '2' AS Version, A.RecordID FROM Procurement.PurchaseOrderService A INNER JOIN Masterfile.Service B ON A.ServiceType = B.ServiceCode WHERE 1=0" OnInit = "Connection_Init"></asp:SqlDataSource>--%>
    <asp:SqlDataSource ID="Masterfilebiz" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT SupplierCode, Name FROM Masterfile.[BPSupplierInfo] WHERE 1 = 0" ></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsBizPartner" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT BizPartnerCode, RTRIM(LTRIM(Name)) AS Name, Address FROM Masterfile.BizPartner WHERE ISNULL(IsInactive,0) = 0" ></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="MasterfileExpense" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT ServiceCode, Description,Type FROM Masterfile.[Service] where Type = 'expense' and isnull(isinactive,0) = 0" ></asp:SqlDataSource>
    <asp:SqlDataSource ID="MasterfileTax" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT TCode, Description, Rate FROM Masterfile.[Tax]" ></asp:SqlDataSource>
    <asp:SqlDataSource ID="MasterfileATC" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT ATCCode, Description, Rate FROM Masterfile.[ATC]" ></asp:SqlDataSource>
