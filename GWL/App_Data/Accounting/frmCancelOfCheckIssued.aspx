<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCancelOfCheckIssued.aspx.cs" Inherits="GWL.frmCancelOfCheckIssued" %>
...
<head runat="server">
    ...
    <title>Cancellation of Check Issued</title>
...
<body style="height: 910px">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxLabel runat="server" Text="Cancellation of Check Issued" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                </dx:PanelContent>
            </PanelCollection>
        </dx:ASPxPanel>
                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="Header" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Transaction Type" Name="TransType" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glTransType" runat="server" Width="170px" DataSourceID="sdsTransType" KeyFieldName="TransType" 
                                            ...
                                            <dx:LayoutItem Caption="Check Number" Name="CheckNumber" >
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxGridLookup ID="glCheckNumber" runat="server" Width="170px" DataSourceID="sdsCheckNumber" 
                                                            KeyFieldName="CheckNumber" OnLoad="LookupLoad" TextFormatString="{0}|{1}" AutoGenerateColumns="false">
                                                            <ClientSideEvents ValueChanged="function (s, e){ cp.PerformCallback('CheckNumber');  e.processOnServer = false;}" />
                                                            <ValidationSettings Display="None" ValidateOnLeave="true" ErrorDisplayMode="ImageWithTooltip">
                                                            </ValidationSettings>
                                                            <InvalidStyle BackColor="Pink">
                                                            </InvalidStyle>
                                                            ...
                                                            <Columns>
                                                                <dx:GridViewDataTextColumn FieldName="CheckNumber" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:LayoutItem Caption="Bank Account Code:" Name="BankAccountCode">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtBankAccountCode" runat="server" Width="170px" ReadOnly="true">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Check Voucher DocNumber:" Name="CheckVoucherDocNum">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtCheckVoucherDocNum" runat="server" Width="170px" ReadOnly="true">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
    ...
    <%-- <!--#endregion --> --%>
    <asp:ObjectDataSource ID="odsHeader" runat="server" SelectMethod="getdata" TypeName="Entity.CancelCheckIssued" DataObjectTypeName="Entity.CancelCheckIssued" DeleteMethod="DeleteData" InsertMethod="InsertData" UpdateMethod="UpdateData">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="" Name="DocNumber" QueryStringField="DocNumber" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsJournalEntry" runat="server" SelectMethod="getJournalEntry" TypeName="Entity.CancelCheckIssued+JournalEntry" >
        <SelectParameters>
            <asp:QueryStringParameter Name="DocNumber" QueryStringField="docnumber" Type="String" />
            <asp:SessionParameter Name="Conn" SessionField="ConnString" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsReference" runat="server" SelectMethod="getreftransaction" TypeName="Entity.CancelCheckIssued+RefTransaction" >
        <SelectParameters>
            <asp:QueryStringParameter Name="DocNumber" QueryStringField="docnumber" Type="String" />
            <asp:SessionParameter Name="Conn" SessionField="ConnString" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:SqlDataSource ID="sdsCheckNumber" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select DISTINCT B.CheckNumber, A.DocNumber from Accounting.CheckVoucher A INNER JOIN Accounting.CheckVoucherDetail B ON A.DocNumber = B.DocNumber WHERE ISNULL(SubmittedBy,'') != '' AND ISNULL(B.ClearedDate,'') = '' AND ISNULL(ReleasedDate,'') = '' AND ISNULL(CancelledBy,'') = ''" OnInit="Connection_Init"></asp:SqlDataSource> 
    <asp:SqlDataSource ID="sdsTransType" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT 'Back to Accounts Payable' AS TransType UNION ALL SELECT 'Record to Other Income' AS TransType" OnInit="Connection_Init"></asp:SqlDataSource> 
