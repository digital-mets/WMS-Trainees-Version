...
<%--                                            <dx:LayoutItem Caption="Broker Code">
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                       <dx:ASPxGridLookup ID="glInvoice" ClientInstanceName="glTranslook" runat="server" AutoGenerateColumns="False" DataSourceID="refnum"
                                                            KeyFieldName="DocNumber" OnLoad="LookupLoad" TextFormatString="{0}:{8}" SelectionMode="Multiple" Width="170px" OnInit="glInvoice_Init">
                                                                ...
                                                                <Templates>
                                                                    <StatusBar>
                                                                        <table class="OptionsTable" style="float: right">
                                                                            <tr>
                                                                                <td>
                                                                                    <dx:ASPxButton ID="Confirm" runat="server" AutoPostBack="false" Text="Confirm" ClientSideEvents-Click="CloseGridLookup" />
                                                                                </td>
                                                                                <td>
                                                                                    <dx:ASPxButton ID="Clear" runat="server" AutoPostBack="false" Text="Clear" ClientSideEvents-Click="Clear" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </StatusBar>
                                                           ...
                                                           <GridViewProperties SettingsPager-PageSize="5" Settings-ShowFilterRow="true">
                                                        <Templates><StatusBar>
                                                                        <table class="OptionsTable" style="float: right">
                                                                            <tr>
                                                                                <td>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataDateColumn FieldName="DocDate" ShowInCustomizationForm="True" VisibleIndex="3" Width="100px" ReadOnly ="true">
                                                                 ...
                                                                 <dx:GridViewDataTextColumn FieldName="SubmittedBy" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                                                 <dx:GridViewDataTextColumn FieldName="Supplier/Broker" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                                                 <dx:GridViewDataTextColumn FieldName="APAmount" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                                                 <dx:GridViewDataTextColumn FieldName="VatAmount" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                                                 <dx:GridViewDataTextColumn FieldName="EWTAmount" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                                                 ...
                                                                 <dx:GridViewDataTextColumn FieldName="ReferenceNumber" ReadOnly="true">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dx:GridViewDataTextColumn>
                                                            </Columns>
                                                        </dx:ASPxGridLookup>
                                            ...
                                            <dx:LayoutItem Caption="Remarks">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxMemo ID="Remarks" runat="server" Height="71px" Width="170px" OnLoad ="Memo_Load">
                                                        </dx:ASPxMemo>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
...
<SettingsBehavior AllowSort="False"></SettingsBehavior>
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="TransDocNumber" VisibleIndex="4" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataDateColumn FieldName="TransDate" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="5">
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataSpinEditColumn FieldName="TransAPAmount" VisibleIndex="6" Width="100px">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="TransVatAmount" ShowInCustomizationForm="True" VisibleIndex="7" Width="100px" ReadOnly="true">
                                                        <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0" NumberFormat="Custom" NumberType="Float" DisplayFormatString="{0:N}"
                                                            ><SpinButtons ShowIncrementButtons="False"></SpinButtons></PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
                                                        <dx:GridViewDataSpinEditColumn FieldName="TransEWTAmount" ShowInCustomizationForm="True" VisibleIndex="8" Width="100px" ReadOnly="true">
                                                        <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0" NumberFormat="Custom" NumberType="Float" DisplayFormatString="{0:N}"
                                                            ><SpinButtons ShowIncrementButtons="False"></SpinButtons></PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
	...
	group by a.DocNumber,DocDate,SubmittedBy,SupplierCode,TotalAmount,Currency, A.ReferenceNumber 
	union all
	select DocNumber,DocDate,SubmittedBy,PayableTo AS SupplierCode,TotalAmountDue,TotalVatAmount,TotalWitholdingTax,'PHP',
	...
	group by a.DocNumber,DocDate,SubmittedBy,SupplierCode,TotalAmount,Currency, A.ReferenceNumber
	union all
	select DocNumber,DocDate,SubmittedBy,PayableTo AS SupplierCode,TotalAmountDue,TotalVatAmount,TotalWitholdingTax,'PHP' as Currency,
	'ACTEXP' as TransType, '' AS ReferenceNumber
	from Accounting.ExpenseProcessing
    where isnull(SubmittedBy,'')!=''
    union all
    ...
    union all
    select DocNumber,'' as LineNumber,'ACTEXP' as Transtype,DocNumber as TransDocNumber,DocDate as TransDate,isnull(TotalAmountDue,0) as TransAPAmount, isnull(TotalVatAmount,0) as TransVatAmount,
