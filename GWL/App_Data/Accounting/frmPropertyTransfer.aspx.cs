    ...
    public partial class frmPropertyTransfer : System.Web.UI.Page
    {
            ...
            switch (e.Parameter)
            {
                case "Add":
                    ...
                    if (error == false)
                    {
                        ...
                        gv1ODS.SelectParameters["DocNumber"].DefaultValue = txtDocNumber.Text;//Set select parameter to prevent error
                        gv1.UpdateEdit();//2nd initiation to insert grid  
                        // -- END OF ADDING DETAIL -- //
       ...
       //     }
        ...
        protected void Connection_Init(object sender, EventArgs e)
        {
            ...
            NewLocationLookup.ConnectionString = Session["ConnString"].ToString();
            NewAccountablePersonLookup.ConnectionString = Session["ConnString"].ToString();
            NewWarehouseCodeLookup.ConnectionString = Session["ConnString"].ToString();
            NewDepartmentLookup.ConnectionString = Session["ConnString"].ToString(); 
        }
        ...
        protected void glPropertyNumber_Init(object sender, EventArgs e)
        {
            ...
            if (Session["FilterExpression"] != null)
            {
                ...
                PropertyNumberLookup.FilterExpression = Session["FilterExpression"].ToString();
