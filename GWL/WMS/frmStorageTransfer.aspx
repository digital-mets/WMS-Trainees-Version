<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStorageTransfer.aspx.cs" Inherits="GWL.frmStorageTransfer" %>
       ...
       function OnStartEditing(s, e) {//On start edit grid function     
           ...
           if (entry != "V") {
               ...
               if (e.focusedColumn.fieldName === "ItemCode" || e.focusedColumn.fieldName === "FullDesc" || e.focusedColumn.fieldName === "LineNumber" 
                   || e.focusedColumn.fieldName === "BulkUnit" || e.focusedColumn.fieldName === "BaseUnit" || e.focusedColumn.fieldName === "BulkQty" || e.focusedColumn.fieldName === "BaseQty"
           ...
           if (entry != "V") {
               ...
               if (e.focusedColumn.fieldName === "ItemCode" || e.focusedColumn.fieldName === "FullDesc" || e.focusedColumn.fieldName === "LineNumber" || e.focusedColumn.fieldName === "BulkQty"
                   ...
                   || e.focusedColumn.fieldName === "NewItemCode" || e.focusedColumn.fieldName === "NewBulkQty" || e.focusedColumn.fieldName === "NewBulkUnit"
                    || e.focusedColumn.fieldName === "NewBaseQty" || e.focusedColumn.fieldName === "NewBaseUnit"
                   || e.focusedColumn.fieldName === "PalletID" || e.focusedColumn.fieldName === "Location" || e.focusedColumn.fieldName === "BatchNumber"
                   || e.focusedColumn.fieldName === "ExpiryDate" || e.focusedColumn.fieldName === "MfgDate" || e.focusedColumn.fieldName === "RRdate") { //Check the column name
                   e.cancel = true;
               }
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" ID="ASPxLabel" Text="Storage Transfer" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
        ...
        <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="400px" Width="1280px" style="margin-left: -3px">
           <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="600" />
             ...
             <dx:LayoutItem Caption="">
                  ...
                  <LayoutItemNestedControlCollection>
                      <dx:LayoutItemNestedControlContainer>
                                  <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Height="400px" Width="1280px" style="margin-left: -3px">
                      <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="600" />
                          <Items>
                                                    ...
                                                    OnBatchUpdate="gv1_BatchUpdate" KeyFieldName="DocNumber;LineNumber;PalletID" ClientSideEvents-Init="InitTrans">
                                                     ...
                                                     <Columns>
                                                        ...
                                                        <%--<dx:GridViewDataTextColumn  FieldName="NewItemCode" VisibleIndex="8" Width="120px" Name="glItemCode" CellStyle-BackColor="#99ccff">
                                                         ...
                                                         <dx:GridViewDataTextColumn FieldName="NewItemCode" VisibleIndex="8" Width="130px" Name="glItemCode" CellStyle-BackColor="#99ccff">
                                                               <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glItemCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false"
                                                                    ...
                                                                    <Columns>
                                                                        <dx:GridViewDataTextColumn FieldName="ItemCode" Width="130px" ReadOnly="True" VisibleIndex="0">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                            </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="FullDesc" Width="170px" ReadOnly="True" VisibleIndex="1">
                                                                            <Settings AutoFilterCondition="Contains" />
                                                                            </dx:GridViewDataTextColumn>
                                                                    </Columns>
                                                         ...
                                                         <dx:GridViewDataSpinEditColumn FieldName="NewBulkQty" VisibleIndex="9" Width="90px" CellStyle-BackColor="#99ccff">
                                                                <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                         ...
                                                         <dx:GridViewDataSpinEditColumn  FieldName="NewBaseQty" VisibleIndex="11" Width="90px" CellStyle-BackColor="#99ccff">
                                                                <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                                    MinValue="0">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </PropertiesSpinEdit>
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                      <dx:ASPxGridView ID="gvd1" runat="server" AutoGenerateColumns="False" Width="608px"  KeyFieldName="DocNumber;Linenumber" ClientInstanceName="gvd1" Settings-ShowStatusBar="Hidden">
                                                               <ClientSideEvents BatchEditConfirmShowing="OnConfirm"
                                                        BatchEditStartEditing="OnStartEditing1"  Init="OnInitTrans"  />
                                                            <SettingsEditing Mode="Batch" />
...
<%--                            <dx:LayoutGroup Caption="Lines">
    ...
    <%--<!--#region Region Header --> --%>
     ...
     <asp:SqlDataSource ID="ToLocation" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT LocationCode,LocationDescription FROM Masterfile.Location (UPDLOCK) where ISNULL(IsInactive,0)=0 " OnInit="Connection_Init"></asp:SqlDataSource>
      ...
      <asp:SqlDataSource ID="StorerKey" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT BizPartnerCode, Name FROM Masterfile.BizPartner WHERE (ISNULL(IsInactive, 0) = '0') AND (IsCustomer = '1') AND ISNULL(Field4,'')!=''" OnInit="Connection_Init"></asp:SqlDataSource>
