<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStorageRelocationModuleOpen.aspx.cs" Inherits="GWL.frmStorageRelocationModuleOpen" %>
...
<head runat="server">
    ...
    <title>Storage Type Transfer</title>
 ...
 background: #FFF;
   ...
   <script>
       ...
       function OnStartEditing(s, e) {//On start edit grid function     
           ...
           if (entry != "V") {
               ...
               if (e.focusedColumn.fieldName === "ItemCode" || e.focusedColumn.fieldName === "FullDesc" || e.focusedColumn.fieldName === "LineNumber"
                   || e.focusedColumn.fieldName === "PalletID" || e.focusedColumn.fieldName === "FromLoc" || e.focusedColumn.fieldName === "ConvertedQty" || e.focusedColumn.fieldName === "ConvertedBulkQty"
                   || e.focusedColumn.fieldName === "ToPalletID" || e.focusedColumn.fieldName === "Qty" || e.focusedColumn.fieldName === "BatchNumber" || e.focusedColumn.fieldName === "FromBulkUnit" || e.focusedColumn.fieldName === "FromBaseUnit") { //Check the column name
                   e.cancel = true;
               }
       ...
       function grid_SelectionChanged(s, e) {
           ...
           //s.GetSelectedFieldValues("CheckedField", GetSelectedFieldValuesCallback);
           //if (gv1.batchEditApi.GetCellValue(e.visibleIndex, 'CheckedField') == 0) {
           //    gv1.batchEditApi.SetCellValue(e.visibleIndex, 'CheckedField', 1)
           //}
         
           //else {
           //    gv1.batchEditApi.SetCellValue(e.visibleIndex, 'CheckedField', 0)
           //}
           var indicies = gv1.batchEditHelper.GetDataItemVisibleIndices();
           for (var i = 0; i < indicies.length; i++) {
               if (gv1.batchEditHelper.IsNewItem(indicies[i])) {

                   if (gv1.batchEditApi.GetCellValue(indicies[i], 'CheckedField') == 0) {
                       gv1.batchEditApi.SetCellValue(indicies[i], 'CheckedField', 1)
                   }
                   else {
                       gv1.batchEditApi.SetCellValue(e.visibleIndex, 'CheckedField', 0)
                   }
...
<body style="height: 475px">
    <% if (DesignMode){ %>
    <script src="~/js/ASPxScriptIntelliSense.js" type="text/javascript">
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" ID="ASPxLabel" Text="Storage Type Transfer" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                ...
                                <Items>
                                        ...
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Document Date:" Name="DocDate" ColSpan="1">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxDateEdit ID="dtpdocdate" runat="server"  Width="170px" OnLoad="Date_Load" Oninit="dtpdocdate_Init1" >
                                                              <ClientSideEvents Validation="OnValidation"    ValueChanged="function(s,e){cp.PerformCallback('valid1') ;}" />
                                       ...
                                       <dx:LayoutItem Caption="From Storage Type:" Name="StorageType">
                                                          <LayoutItemNestedControlCollection>
                                                              <dx:LayoutItemNestedControlContainer runat="server">
                                                                  <dx:ASPxGridLookup ID="txtStorageType" runat="server" AutoGenerateColumns="False" DataSourceID="StorageType" KeyFieldName="StorageType" OnLoad="LookupLoad" TextFormatString="{0}" Width="170px">
                                                                      <GridViewProperties>
                                                                          <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                      ...
                                                      <dx:LayoutItem Caption="To Storage Type:" Name="StorageType">
                                                          <LayoutItemNestedControlCollection>
                                                              <dx:LayoutItemNestedControlContainer runat="server">
                                                                  <dx:ASPxGridLookup ID="txtToStorage" runat="server" AutoGenerateColumns="False" DataSourceID="StorageType" KeyFieldName="StorageType" OnLoad="LookupLoad" TextFormatString="{0}" Width="170px">
                                                                      <GridViewProperties>
                                                                          <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" />
                                                                          <Settings ShowFilterRow="True" />
                                                                      </GridViewProperties>
                                            ...
                                            <dx:LayoutItem Caption="From Unit of Measure" Name="FromUOM"  Visible="false">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtfromcontract" runat="server" Visible="false" Width="170px" ReadOnly="true">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>

                                                <dx:LayoutItem Caption="To Unit of Measure" Name="ToUOM"  Visible="false">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txttocontract" runat="server" Visible="false" Width="170px" ReadOnly="true">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                                                                ...
                                                                                <dx:ASPxGridLookup ID="cmbStorerKey" runat="server" Width="170px"  AutoGenerateColumns="False" DataSourceID="StorerKey" KeyFieldName="BizPartnerCode" OnLoad="LookupLoad"  TextFormatString="{0}">
                                                                                        ...
                                                                                        <Columns>
                                                                                           ...
                                                                                           <ClientSideEvents  Validation="OnValidation"  ValueChanged="function(){
                                                                                               ...
                                                                                               txtRRDocno.SetValue(null); 
                                                                                               cp.PerformCallback('valid1')
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="747px" SettingsBehavior-AllowSort="false" OnCustomCallback="gv1_CustomCallback"
                                                    ...
                                                    OnBatchUpdate="gv1_BatchUpdate" KeyFieldName="DocNumber;LineNumber;PalletID" ClientSideEvents-Init="InitTrans">
                                                       <ClientSideEvents Init="OnInitTrans" SelectionChanged="grid_SelectionChanged"/>
                                                     <Columns>
                                                        ...
                                                        <dx:GridViewCommandColumn name="selected" SelectAllCheckboxMode="page" ShowSelectCheckbox="true"  Caption="Selected Details" VisibleIndex="0" CellStyle-HorizontalAlign="Center">
                                                       ...
                                                       <dx:GridViewDataTextColumn FieldName="LineNumber" VisibleIndex="1" Caption="RecordID" ReadOnly="True" Width="70px">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ItemCode" VisibleIndex="2" Width="120px" Name="glItemCode">
                                                          ...
                                                          <dx:GridViewDataTextColumn FieldName="FullDesc" Caption="Description"  VisibleIndex="3" Width="200px" Name ="glFullDesc">          
                                                         </dx:GridViewDataTextColumn>

                                                        

                                                        <%-- <dx:GridViewDataTextColumn FieldName="FromBulkUnit" VisibleIndex="6" Width="100px">
                                                            </dx:GridViewDataTextColumn>

                                                         <dx:GridViewDataTextColumn FieldName="FromBaseUnit" VisibleIndex="7" Width="100px">
                                                            </dx:GridViewDataTextColumn>

                                                         <dx:GridViewDataTextColumn FieldName="ToBulkUnit" VisibleIndex="8" Width="100px" CellStyle-BackColor="#99ccff">
                                                            </dx:GridViewDataTextColumn>

                                                         <dx:GridViewDataTextColumn FieldName="ToBaseUnit" VisibleIndex="9" Width="100px" CellStyle-BackColor="#99ccff">
                                                            </dx:GridViewDataTextColumn>

                                                         <dx:GridViewDataSpinEditColumn FieldName="ConvertedQty" VisibleIndex="10" Width="90px"  >
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="ConvertedBulkQty" VisibleIndex="11" Width="90px" ShowInCustomizationForm="True">
                                                                <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                           ...
                                                           <dx:GridViewDataTextColumn FieldName="PalletID" VisibleIndex="4" Width="80px">
                                                            </dx:GridViewDataTextColumn>
                                                          <dx:GridViewDataTextColumn FieldName="ToPalletID" VisibleIndex="5" Width="100px" PropertiesTextEdit-ClientSideEvents-Init="InitTrans" > 
                                                          </dx:GridViewDataTextColumn>    
                                                          <dx:GridViewDataTextColumn FieldName="FromLoc" VisibleIndex="6" Width="80px" Name="FromLoc">
                                                        </dx:GridViewDataTextColumn>
     
                                                                 <dx:GridViewDataTextColumn FieldName="ToLoc" VisibleIndex="7" Width="80px" Name="ToLoc"> 
                                                             <EditItemTemplate>
                                                          ...
                                                          <dx:GridViewDataSpinEditColumn FieldName="Qty" VisibleIndex="8" Width="90px">
                                                                <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                                    MinValue="0">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </PropertiesSpinEdit>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="BulkQty" VisibleIndex="9" Width="90px" ShowInCustomizationForm="True" >
                                                                <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                                    ClientInstanceName="gBulkQty" MinValue="0">
                                                                    <ClientSideEvents Init="InitTrans" />
                                                                </PropertiesSpinEdit>
                                                            </dx:GridViewDataSpinEditColumn>
                                                         <dx:GridViewDataTextColumn Name="BatchNumber" ShowInCustomizationForm="True" VisibleIndex="10" FieldName="BatchNumber" UnboundType="String">
                                                        </dx:GridViewDataTextColumn>
                                                         
                                                        <dx:GridViewDataTextColumn Caption="Expiry Date" FieldName="Field1" ShowInCustomizationForm="True" VisibleIndex="11">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn   Caption="Manufacturing Date" FieldName="Field2" ShowInCustomizationForm="True" VisibleIndex="12" Width="120px">
                                                        </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn   Caption="RRDate" FieldName="Field3" ShowInCustomizationForm="True" VisibleIndex="13">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="CheckedField" VisibleIndex="14" Width="00px">
                                                        </dx:GridViewDataTextColumn>
                                                         <dx:GridViewDataTextColumn Caption="From Unit of Measure" FieldName="FromUnitofMeasure" VisibleIndex="15" Width="0px" Name="FromUnitofMeasure">
                                                        </dx:GridViewDataTextColumn>
     
                                                      <dx:GridViewDataTextColumn  Caption="To Unit of Measure" FieldName="ToUnitofMeasure" VisibleIndex="16" Width="0px" Name="ToUnitofMeasure">
                                                         <EditItemTemplate>
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    ...
                                                    <Settings HorizontalScrollBarMode="Visible" VerticalScrollBarMode="Visible" ColumnMinWidth="200" VerticalScrollableHeight="0"  /> 
                                                       <ClientSideEvents BatchEditConfirmShowing="OnConfirm"  CustomButtonClick="OnCustomClick"  />
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="LineNumber" VisibleIndex="1" Caption="LineNumber" ReadOnly="True" Width="70px">
                                                        </dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="ItemCode" VisibleIndex="2" Width="120px" Name="glItemCode">
                                                          ...
                                                          <dx:GridViewDataTextColumn FieldName="FullDesc" Caption="Description"  VisibleIndex="3" Width="150px" Name ="glFullDesc">          
                                                         </dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="ConvertedBulkQty" VisibleIndex="11" Width="90px" ShowInCustomizationForm="True">
                                                           ...
                                                           <dx:GridViewDataTextColumn FieldName="PalletID" VisibleIndex="4" Width="80px" Caption="PalletID">
                                                            </dx:GridViewDataTextColumn>
                                                          <dx:GridViewDataTextColumn FieldName="ToPalletID" VisibleIndex="5" Width="100px" Caption="To PalletID" PropertiesTextEdit-ClientSideEvents-Init="InitTrans">
                                                          </dx:GridViewDataTextColumn>    
                                                      ...
                                                      <dx:GridViewDataTextColumn FieldName="ToLoc" VisibleIndex="7" Width="80px" Name="ToLoc" >
                                                         <EditItemTemplate>
                                                            ...
                                                            <dx:GridViewDataSpinEditColumn FieldName="BulkQty" VisibleIndex="9" Width="90px" >
                                                                <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                                    ClientInstanceName="gBulkQty" MinValue="0">
                                                                </PropertiesSpinEdit>
                                                            </dx:GridViewDataSpinEditColumn>
...
<%--                            <dx:LayoutGroup Caption="Lines">
    ...
    <asp:SqlDataSource ID="ContractDetail" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select nullif(UnitOfMeasure,'') as  UnitOfMeasure  from wms.Contractdetail  group by UnitOfMeasure" OnInit="Connection_Init"></asp:SqlDataSource>
