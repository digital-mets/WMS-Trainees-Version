                                ...
                                <Items>
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Internal Transfer">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxCheckBox ID="CheckIntExt" runat="server" CheckState="Unchecked" OnLoad="CheckboxLoad" Text=" ">
                                                        </dx:ASPxCheckBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                    ...
                                    <dx:LayoutGroup Caption="Customer Trucking Details" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Consignee Address">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtConAddress" runat="server" Width="170px" ReadOnly="True">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItem Caption="Seal Number">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtSealNo" runat="server" Width="170px" OnLoad="TextboxLoad">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            <dx:LayoutItem Caption="Container Number">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtContainerNo" runat="server" Width="170px" OnLoad="TextboxLoad" ReadOnly="True">
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                ...
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="850px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataDateColumn Caption="MfgDate" FieldName="ManufacturingDate" PropertiesDateEdit-CalendarProperties-ShowTodayButton="false" ShowInCustomizationForm="True" VisibleIndex="14">
                                                        ...
                                                        <dx:GridViewDataDateColumn FieldName="ExpiryDate" PropertiesDateEdit-CalendarProperties-ShowTodayButton="false" ShowInCustomizationForm="True" VisibleIndex="15" Name="dtpExpiryDate">
                                                        </dx:GridViewDataDateColumn>
                                                        ...
                                                        <dx:GridViewDataDateColumn Caption="RRDocDate" FieldName="RRDocDate" ShowInCustomizationForm="True" VisibleIndex="14" Name="dtpRRDocDate" PropertiesDateEdit-DropDownButton-Enabled="false" ReadOnly="true">
                                                            <PropertiesDateEdit>
