...
function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
     ...
     function OnStartEditing(s, e) {//On start edit grid function 
         if (entry != "V") {
             ...
             if (e.focusedColumn.fieldName === "ServiceTypeCode") {
                 isSetTextRequired = true;
                 glServiceTypeCode.GetInputElement().value = cellInfo.value;
             }
     ...
     function OnEndEditing(s, e) {//end edit grid function, sets text after select/leaving the current lookup
         if (entry != "V") {
             ...
             if (currentColumn.fieldName === "ServiceTypeCode") {
                 cellInfo.value = glServiceTypeCode.GetValue();
                 cellInfo.text = glServiceTypeCode.GetText();
             }
     ...
     function ProcessCells3(selectedIndex, e, column, s) {//Auto Color,class,size,full desc, qty function :D
         ...
         if (selectedIndex == 0) {
             ...
             if (column.fieldName == "ServiceTypeCode") {
     ...
     function autocalculate(s, e) {
         ...
         setTimeout(function () {
             ...
             txtField2.SetValue(TotalQuantity.toFixed(2));
...
<TimeSectionProperties Visible="True"></TimeSectionProperties>
                                            ...
                                            <dx:LayoutItem Caption="ICN Number" Name="ICNNumber">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxGridLookup ID="gvICN" runat="server" AutoGenerateColumns="False" ClientEnabled="False" ClientInstanceName="gl" DataSourceID="ICNNumber" KeyFieldName="DocNumber" OnLoad="LookupLoad" TextFormatString="{0}" Width="170px">
                                                                    <GridViewProperties>
                                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" />
                                                                        <Settings ShowFilterRow="True" />
                                                                    </GridViewProperties>
                                            ...
                                            <dx:LayoutItem Caption="Direct Outbound">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxCheckBox ID="chkDirectOut" runat="server" CheckState="Unchecked" OnLoad="CheckboxLoad" Text=" ">
                                                        </dx:ASPxCheckBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
...
<PropertiesTextEdit Native="True"></PropertiesTextEdit>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="BulkQty" Caption="Qty" VisibleIndex="8" Width="80px">
                                                            <PropertiesSpinEdit NullDisplayText="0" ConvertEmptyStringToNull="False" DecimalPlaces="0" NullText="0" DisplayFormatString="{0:N}"
...
<SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                    ...
                                                    <dx:GridViewDataTextColumn Name="PalletID" ShowInCustomizationForm="True" Width="120px" VisibleIndex="12" FieldName="PalletID" PropertiesTextEdit-Native="true"
                                                        PropertiesTextEdit-MaskSettings-Mask=">LLL<01..12><01..99>-<0000>a" PropertiesTextEdit-MaskSettings-IncludeLiterals="All"
                                                    ...
                                                    <dx:GridViewCommandColumn ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="1" Width="95px" ShowNewButtonInHeader="True">
                                                        ...
                                                        <%--<dx:GridViewDataTextColumn Name="ReceivedQty" Caption="Kilos" ShowInCustomizationForm="True" VisibleIndex="10" FieldName="ReceivedQty" PropertiesTextEdit-Native="true">
                                                         ...
                                                         <dx:GridViewDataSpinEditColumn FieldName="ReceivedQty" Name="ReceivedQty" Caption="Kilos"  ShowInCustomizationForm="True" VisibleIndex="10"  >
                                                                  <PropertiesSpinEdit Increment="0" DecimalPlaces="2" ClientInstanceName="glReceivedQty" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0"  DisplayFormatString="{0:N}"  MaxValue="9999999999" MinValue="0"  SpinButtons-ShowIncrementButtons ="false" AllowMouseWheel="false">
                                                            <ClientSideEvents ValueChanged="autocalculate" /> 
                                                            </PropertiesSpinEdit>
                                                        </dx:GridViewDataSpinEditColumn>
...
<PropertiesTextEdit ClientInstanceName="gbulkunit"></PropertiesTextEdit>
                                                        <EditItemTemplate>
                                                           ...
                                                           <dx:GridViewDataTextColumn PropertiesTextEdit-Native="true" FieldName="ServiceTypeCode" Caption="Storage Type" VisibleIndex="9" Name="ServiceTypeCode" >
                                                        <EditItemTemplate>
                                                            <dx:ASPxGridLookup ID="ServiceTypeCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" GridViewStylesEditors-Native="true" OnInit="glStorageType_Init"
                                                                        DataSourceID="StorageType" KeyFieldName="StorageType" ClientInstanceName="glServiceTypeCode" TextFormatString="{0}" Width="80px" OnLoad="gvLookupLoad"
                                                                        >
                                                                        <GridViewProperties Settings-ShowFilterRow="true">
                                                                            <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True"
                                                                                AllowSelectSingleRowOnly="True" />
                                                                        ...
                                                                        <ClientSideEvents KeyPress="gridLookup_KeyPress" KeyDown="gridLookup_KeyDown" 
                                                                                   DropDown="function (s,e){glServiceTypeCode.GetGridView().PerformCallback( itemc + '|' + 'StorageType'  );
                                                                                           e.processOnServer = false; }"  RowClick="gridLookup_CloseUp" />
                                                                    </dx:ASPxGridLookup>
                                                        </EditItemTemplate>
                                                        </dx:GridViewDataTextColumn>
...
<PropertiesTextEdit Native="True"></PropertiesTextEdit>
                                                        ...
                                                        <dx:GridViewDataTextColumn PropertiesTextEdit-Native="true" FieldName="Field2" Caption="Field2"  Name="Field2" ShowInCustomizationForm="True" VisibleIndex="27" UnboundType="Bound">
<PropertiesTextEdit Native="True"></PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
...
<PropertiesTextEdit Native="True"></PropertiesTextEdit>
                                                        ...
                                                        <dx:GridViewDataTextColumn PropertiesTextEdit-Native="true" FieldName="Field9"  Caption="Field9" Name="Field9" ShowInCustomizationForm="True" VisibleIndex="34" UnboundType="Bound">
<PropertiesTextEdit Native="True"></PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="TranType" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT DocNumber,TransType from WMS.ICN" OnInit ="Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="Location" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT PlantCode,LocationCode from Masterfile.Location where LocationType != 'N'" OnInit ="Connection_Init"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="Plant" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="SELECT WarehouseCode,Plantcode from Masterfile.Plant" OnInit ="Connection_Init"></asp:SqlDataSource>
