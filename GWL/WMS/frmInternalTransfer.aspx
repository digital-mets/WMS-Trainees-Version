                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="747px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn Caption="Qty" FieldName="Qty" Name="Qty" ShowInCustomizationForm="True" VisibleIndex="17" ReadOnly="true" Width="0">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn Caption="BulkQty" FieldName="BulkQty" Name="BulkQty" ShowInCustomizationForm="True" VisibleIndex="18" ReadOnly="true" Width="0">
                                                                    <PropertiesSpinEdit Increment="0" ConvertEmptyStringToNull="False" DisplayFormatString="g" NullDisplayText="0.00" NullText="0.00">
                                                                    </PropertiesSpinEdit>
                                                                </dx:GridViewDataSpinEditColumn>
                                            ...
                                            <dx:LayoutItem ShowCaption="False">
                                                <LayoutItemNestedControlCollection>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="RecordId" VisibleIndex="2" Visible="true" Width="60px" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
