...
<head runat="server">
    ...
    <script>
        ...
        function OnValidation(s, e) { //Validation function for header controls (Set this for each header controls)
            if (glStorerKey.GetText() == "" || glWarehouseCode.GetText() == "" || txtOvertime.GetText() == "" || txtTBSB.GetText() == "" || txtTProvided.GetText() == "" || txtHTranstype.GetText() == "" || txtShipType.GetText() == "") {
...
<body style="height: 910px">
                                                ...
                                                <div id="loadingcont">
                                                    <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="747px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn FieldName="LineNumber" Visible="false" VisibleIndex="3" Caption="LineNumber" ReadOnly="True" Width="100px">
                                                            </dx:GridViewDataTextColumn>
                                                            ...
                                                            <dx:GridViewDataSpinEditColumn Caption="Documented Kilos" Name="InputBaseQty" ShowInCustomizationForm="True" VisibleIndex="11" FieldName="InputBaseQty" PropertiesSpinEdit-DisplayFormatString="{0:N}" UnboundType="Decimal" Width="100px">
                                                            ...
                                                            <dx:GridViewDataSpinEditColumn Caption="Received Kilos" Name="DocBaseQty" ShowInCustomizationForm="True" VisibleIndex="14" FieldName="DocBaseQty" PropertiesSpinEdit-DisplayFormatString="{0:N}" UnboundType="Decimal" Width="100px">
                                                                <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="False" NullText="0" DisplayFormatString="{0:N}" MaxValue="9999999999" MinValue="0" SpinButtons-ShowIncrementButtons="false" AllowMouseWheel="false">
                                                                </PropertiesSpinEdit>
                                                            </dx:GridViewDataSpinEditColumn>
                                                            ...
                                                            <dx:GridViewDataDateColumn FieldName="ManufacturingDateICN" Caption="Mfg Date" ShowInCustomizationForm="True" VisibleIndex="16">
                                                            ...
                                                            <dx:GridViewDataDateColumn FieldName="ExpiryDateICN" Caption="ExpiryDate" ShowInCustomizationForm="True" VisibleIndex="17" Name="dtpExpiryDate">
                                                            </dx:GridViewDataDateColumn>
                                                            ...
                                                            <dx:GridViewDataTextColumn FieldName="BulkUnit" VisibleIndex="19" Width="0px">
                                                                <EditItemTemplate>
    ...
    <asp:SqlDataSource ID="TruckT" runat="server" ConnectionString="<%$ ConnectionStrings:GEARS-METSITConnectionString %>" SelectCommand="select TruckType from [PORTAL-DEV].it.TruckType" OnInit="Connection_Init"></asp:SqlDataSource>
