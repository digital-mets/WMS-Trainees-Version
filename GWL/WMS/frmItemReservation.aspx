    ...
    ASPxClientUtils.AttachEventToElement(s.GetMainElement(), "keydown", function (event) {
       ...
       function OnStartEditing(s, e) {//On start edit grid function     
           ...
           if (e.focusedColumn.fieldName === "ItemCode" || e.focusedColumn.fieldName === "RecordID"
               || e.focusedColumn.fieldName === "ItemDescription" || e.focusedColumn.fieldName === "PalletID"
                || e.focusedColumn.fieldName === "FromLoc" || e.focusedColumn.fieldName === "CurrentQty"
           ...
           if (txtRelocationType.GetText() != "Reserved By Weight")

           {

               if (    e.focusedColumn.fieldName === "ToPalletID" || e.focusedColumn.fieldName === "ToLoc"
                   ) {
        ...
        <dx:ASPxPanel id="toppanel" runat="server" FixedPositionOverlap="true" fixedposition="WindowTop" backcolor="#2A88AD" Height="30px">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxLabel runat="server" Text="Item Reservation" Font-Bold="true" ForeColor="White"  Font-Size="X-Large"></dx:ASPxLabel>
                            </dx:PanelContent>
                        </PanelCollection>
                    </dx:ASPxPanel>
                                            ...
                                            <dx:LayoutItem Caption="Document Date:" Name="DocDate" ColSpan="1">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                       ...
                                                       <dx:LayoutItem Caption="Reservation Type:" Name="txtRelocationType">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                       <dx:ASPxComboBox ID="txtRelocationType" ClientInstanceName="txtRelocationType" runat="server" Width="170px" >
...
<SettingsBehavior AllowSort="False"></SettingsBehavior>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="PalletID" VisibleIndex="5" Width="100px" Caption="PalletID">
                                                            </dx:GridViewDataTextColumn>
                                                          ...
                                                          <dx:GridViewDataTextColumn FieldName="FromLoc" VisibleIndex="5" Width="80px" Name="FromLoc">
                                                        </dx:GridViewDataTextColumn>
     
                                                                 <dx:GridViewDataTextColumn FieldName="ToLoc" VisibleIndex="5" Width="80px" Name="ToLoc">
                                                             <EditItemTemplate>
                                                     ...
                                                     <dx:GridViewDataSpinEditColumn FieldName="CurrentBulkQty" VisibleIndex="7" Width="100px">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="TargetBulkQty" Caption="Reserved Bulk Qty" VisibleIndex="8" Width="100px" UnboundType="Decimal"  CellStyle-BackColor="#99ccff">
                                                                <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
...
<CellStyle BackColor="#99ccff"></CellStyle>
                                                         ...
                                                         <dx:GridViewDataSpinEditColumn FieldName="BulkQty" VisibleIndex="9" Width="0px" Caption="Adjusted BulkQty">
                                                                <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                      ...
                                                      <dx:GridViewDataSpinEditColumn Caption="Reserved Qty" FieldName="TargetQty" Name="TargetQty" ShowInCustomizationForm="True" VisibleIndex="11" CellStyle-BackColor="#99ccff">
                                                       <PropertiesSpinEdit Increment="0" ClientInstanceName="TargetQty" MinValue="0" ConvertEmptyStringToNull="False" DisplayFormatString="g" NullDisplayText="0" NullText="0" >
                                                       <ClientSideEvents ValueChanged="Statusautocalculate" Init="InitTrans" />
                                                        </PropertiesSpinEdit>
...
<CellStyle BackColor="#99ccff"></CellStyle>
                                                      ...
                                                      <dx:GridViewDataSpinEditColumn Caption="Adjustment Qty" Width="0px" FieldName="AdjustedQty" Name="Qty" ShowInCustomizationForm="True" VisibleIndex="12">
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            ...
                                            <ClientSideEvents Init="OnInitTrans"  />
                                                    <Columns>
                                                           ...
                                                           <dx:GridViewDataTextColumn FieldName="ItemCode" VisibleIndex="3" Width="150px" Name="glItemCode">
                                                            <EditItemTemplate>
                                                              ...
                                                              <dx:GridViewDataTextColumn FieldName="FullDesc" Caption="Description" VisibleIndex="4" Width="150px" Name="glItemCode">
                                                                  ...
                                                                  <dx:GridViewDataTextColumn FieldName="PalletID" VisibleIndex="5" Width="80px" Caption="PalletID">
                                                            </dx:GridViewDataTextColumn>
                                                          <dx:GridViewDataTextColumn FieldName="ToPalletID" VisibleIndex="5" Width="100px" Caption="To PalletID" PropertiesTextEdit-ClientSideEvents-Init="InitTrans">
                                                          </dx:GridViewDataTextColumn>    
                                                          <dx:GridViewDataTextColumn FieldName="FromLoc" VisibleIndex="5" Width="80px" Name="FromLoc">
                                                        ...
                                                        <dx:GridViewDataSpinEditColumn FieldName="BulkQty" VisibleIndex="9" Width="100px" Caption="Reserved Bulk Qty">
                                                                <PropertiesSpinEdit Increment="0" NullDisplayText="0" ConvertEmptyStringToNull="True" NullText="0" DisplayFormatString="{0:N}"
                                                                    ClientInstanceName="gBulkQty" MinValue="0">
                                                                    <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                             ...
                                                             <dx:GridViewDataSpinEditColumn Caption="Reserved Qty" FieldName="Qty" Width="100px"  Name="Qty" ShowInCustomizationForm="True" VisibleIndex="12">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="BatchNumber" Name="BatchNumber" ShowInCustomizationForm="True" VisibleIndex="15">
                                                        </dx:GridViewDataTextColumn>
                                                       <dx:GridViewDataDateColumn   Caption="RR Date" FieldName="Field1" ShowInCustomizationForm="True" VisibleIndex="16">
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataDateColumn Caption="Expiry Date" FieldName="Field2" ShowInCustomizationForm="True" VisibleIndex="17">
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataDateColumn   Caption="Manufacturing Date" FieldName="Field3" ShowInCustomizationForm="True" VisibleIndex="18" Width="150px">
                                                        </dx:GridViewDataDateColumn>
