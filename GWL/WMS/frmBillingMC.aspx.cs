...
namespace GWL
{
    public partial class frmBillingMC : System.Web.UI.Page
    {
        ...
        Entity.BillingMC _Entity = new BillingMC();//Calls entity odsHeader
        Entity.BillingMC.BillingDetail _EntityDetail = new BillingMC.BillingDetail();//Call entity sdsDetail
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gv1.KeyFieldName = "DocNumber;Date;RefRecordID";
            ...
            if (!IsPostBack)
            {
                Session["WMSBMCServType"] = null;
                Session["WMSBMCBizPartner"] = null;
                ...
                Session["WMSBMCServType"] = _Entity.ServiceType;
                Session["WMSBMCBizPartner"] = _Entity.BizPartnerCode + "|";
        ...
        protected void cp_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            switch (param)
            {
                    ...
                    if (error == false)
                    {
                        ...
                        if (_cnt["Row"].ToString() == "0")
                        {
                            ...
                            foreach (DataRow dtRow in source.Rows)
                            {
                                ...
                                _EntityDetail.QtyPalletOut = Convert.ToDecimal(Convert.IsDBNull(dtRow["QtyPalletOut"]) ? 0 : dtRow["QtyPalletOut"]);
                ...
                case "CallbackServType":
                    Session["WMSBMCServType"] = null;
                    Session["WMSBMCServType"] = aglServiceType.Text;
                    DisableFields();
                    if (!String.IsNullOrEmpty(aglBizPartnerCode.Text))
                    {
                ...
                case "CallbackBizPartner":
                    ...
                    Session["WMSBMCBizPartner"] = filters;
                    break;
            }
        }
        ...
        {
            DataTable billing = Gears.RetriveData2("EXEC sp_generate_BillingMC '" + aglBizPartnerCode.Text + "','" + dtpDateFrom.Text + "','" + dtpDateTo.Text + "','" + aglServiceType.Text + "','" + txtDocNumber.Text + "'", Session["ConnString"].ToString());
        ...
        {
            if (Session["WMSBMCServType"] == null || Session["WMSBMCServType"] == "")
            {
        ...
        protected void DefaultValueForFields()
        {
            ...
            " B.BillingType, A.WarehouseCode FROM WMS.Contract A INNER JOIN WMS.ContractDetail B ON A.Docnumber = B.Docnumber INNER JOIN Masterfile.WMSInventory D on A.BizPartnerCode = D.BizPartnerCode and B.ServiceType = D.ServiceType LEFT JOIN Masterfile.WMSBillingPeriod E on B.Period = E.BillingPeriodCode where A.BizPartnerCode = '" + aglBizPartnerCode.Text + "' AND B.ServiceType = '" + aglServiceType.Text + "' And ISNULL(A.SubmittedBy,'')!='' order by A.Docnumber desc,D.AsOfDate desc");
