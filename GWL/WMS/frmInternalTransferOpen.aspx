<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmInternalTransferOpen.aspx.cs" Inherits="GWL.frmInternalTransferOpen" %>
                ...
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxFormLayout ID="frmlayout1" runat="server" Height="565px" Width="850px " Style="margin-left: -3px; margin-right: 0px;">
                     <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="600" />
                                    ...
                                    <dx:LayoutGroup Caption="General" ColCount="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxRoundPanel ID="rpFilter" runat="server" Width="500px" HeaderText="Filter" OnLoad="rpFilter_Load">
                                                            <PanelCollection>
                                                                    ...
                                                                    <table>
                                                                        <tr align="left">
                                                                            <td>
                                                                             ...
                                                                             <td>
                                                                            <dx:ASPxLabel Text="" runat="server" Width="10px"> </dx:ASPxLabel>
                                                                            </td>
                                                                           <%-- <td>
                            ...
                            <dx:LayoutGroup Caption="Internal Transfer Detail">
                                <Items>
                                    <dx:LayoutItem Caption="">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gv1" runat="server" AutoGenerateColumns="False" Width="747px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="RecordId" VisibleIndex="2" Visible="true" Width="80px" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
                                                         <dx:GridViewDataTextColumn FieldName="OldItemCode" VisibleIndex="3" Visible="true" Width="80px" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
                                                           <dx:GridViewDataTextColumn FieldName="ItemCode" VisibleIndex="3" Width="80px" Name="glItemCode">
                                                               <EditItemTemplate>
                                                                <dx:ASPxGridLookup ID="glItemCode" runat="server" AutoGenerateColumns="False" AutoPostBack="false" OnInit="glItemCode_Init"
                                                                    ...
                                                                    <ClientSideEvents KeyPress="gridLookup_KeyPress" KeyDown="gridLookup_KeyDown" 
                                                                        DropDown="lookup" RowClick="function(){gv1.batchEditApi.EndEdit();}" />
                                                                </dx:ASPxGridLookup>
                                                            </EditItemTemplate>
                                                        </dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataDateColumn Caption="Expiry Date" FieldName="ExpiryDate" ShowInCustomizationForm="True" VisibleIndex="11">
                                                         ...
                                                         <dx:GridViewDataDateColumn Caption="Old Client Name" FieldName="OldClientName" ShowInCustomizationForm="True" VisibleIndex="11" ReadOnly="true">
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataDateColumn Caption="Client Name" FieldName="ClientName" ShowInCustomizationForm="True" VisibleIndex="11">
                                                        </dx:GridViewDataDateColumn>
