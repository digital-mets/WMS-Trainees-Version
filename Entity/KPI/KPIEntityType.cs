...
namespace Entity
{
   public class KPIEntityType
    {
        private string _TableName = "KPI.EntityType";

        public virtual string EntityType { get; set; }
        public virtual string Description { get; set; }
        public virtual string EntityGroup { get; set; }
        public virtual string KPIGroup { get; set; }
        ...
        public int GetObject(string _EntityType)
        {
            DataTable dtResult;

            dtResult = Gears.RetriveData2("SELECT * FROM " + _TableName + " WHERE EntityType = '" + _EntityType + "'");
            ...
            else
            {
                ...
                EntityType = _Row["EntityType"].ToString();
                Description = _Row["Description"].ToString();
                EntityGroup = _Row["EntityGroup"].ToString();
                KPIGroup = _Row["KPIGroup"].ToString();
        ...
        public string InsertData()
        {
            ...
            dtObject.Rows.Add(_TableName, "0", "EntityType", EntityType);
            dtObject.Rows.Add(_TableName, "0", "Description", Description);
            dtObject.Rows.Add(_TableName, "0", "EntityGroup", EntityGroup);
            dtObject.Rows.Add(_TableName, "0", "KPIGroup", KPIGroup);
        ...
        public string UpdateData()
        {
            ...
            dtObject.Rows.Add(_TableName, "cond", "EntityType", EntityType);

            dtObject.Rows.Add(_TableName, "set", "Description", Description);
            dtObject.Rows.Add(_TableName, "set", "EntityGroup", EntityGroup);
            dtObject.Rows.Add(_TableName, "set", "KPIGroup", KPIGroup);
            ...
            if (strErr == "")
            {
                Functions.AuditTrail("KPI Entity Type", EntityType,
        ...
        public string DeleteData()
        {
            ...
            if (strErr == "")
            {
                Functions.AuditTrail("KPI Entity Type", EntityType, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "DELETE");
            }
            return strErr;
        }
    }
