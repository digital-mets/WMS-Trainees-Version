...
namespace Entity
{
   public class KPIEntity
    {
        private string _TableName = "KPI.Entity";
        ...
        public int GetObject(string _EntityCode)
        {
            DataTable dtResult;

            dtResult = Gears.RetriveData2("SELECT * FROM " + _TableName + " WHERE EntityCode = '" + _EntityCode + "'");
            ...
            else
            {
                ...
                EntityCode = _Row["EntityCode"].ToString();
                EntityName = _Row["EntityName"].ToString();
                CompanyCode = _Row["CompanyCode"].ToString();
                EntityID = _Row["EntityID"].ToString();
        ...
        public string InsertData()
        {
            ...
            dtObject.Rows.Add(_TableName, "0", "EntityCode", EntityCode);
            dtObject.Rows.Add(_TableName, "0", "EntityName", EntityName);
        ...
        public string UpdateData()
        {
            ...
            dtObject.Rows.Add(_TableName, "cond", "EntityCode", EntityCode);

            dtObject.Rows.Add(_TableName, "set", "EntityName", EntityName);
            dtObject.Rows.Add(_TableName, "set", "CompanyCOde", CompanyCode);
            dtObject.Rows.Add(_TableName, "set", "EntityType", EntityType);
            dtObject.Rows.Add(_TableName, "set", "EntityID", EntityID);
            ...
            if (strErr == "")
            {
                Functions.AuditTrail("KPI Entity", EntityType,
        ...
        public string DeleteData()
        {
            ...
            if (strErr == "")
            {
                Functions.AuditTrail("KPI Entity", EntityType, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "DELETE");
            }
            return strErr;
        }
    }
