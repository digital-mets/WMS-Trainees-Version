...
namespace Entity
{
    ...
    {
        private string _TableName = "Enterprise.Company";

        public virtual string CompanyCode { get; set; }
        public virtual string CompanyName { get; set; }
        public virtual string ShortName { get; set; }
        public virtual decimal PercentShare { get; set; }
        public virtual string CompanyGroup { get; set; }
        ...
        public int GetObject(string _CompanyCode)
        {
            ...
            else
            {
                ...
                CompanyName = _Row["CompanyName"].ToString();
                ShortName = _Row["ShortName"].ToString();
                PercentShare = Convert.ToDecimal(_Row["PercentShare"]);
                CompanyGroup = _Row["CompanyGroup"].ToString();
                BusinessType = _Row["BusinessType"].ToString();
                SortOrder = Convert.ToInt16(_Row["SortOrder"]);
        ...
        public string InsertData()
        {
            ...
            dtObject.Rows.Add(_TableName, "0", "CompanyName", CompanyName);
            dtObject.Rows.Add(_TableName, "0", "ShortName", ShortName);
            dtObject.Rows.Add(_TableName, "0", "PercentShare", PercentShare);
            dtObject.Rows.Add(_TableName, "0", "CompanyGroup", CompanyGroup);
            dtObject.Rows.Add(_TableName, "0", "BusinessType", BusinessType);
            dtObject.Rows.Add(_TableName, "0", "SortOrder", SortOrder);
        ...
        public string UpdateData()
        {
            ...
            dtObject.Rows.Add(_TableName, "set", "CompanyName", CompanyName);
            dtObject.Rows.Add(_TableName, "set", "ShortName", ShortName);
            dtObject.Rows.Add(_TableName, "set", "PercentShare", PercentShare);
            dtObject.Rows.Add(_TableName, "set", "CompanyGroup", CompanyGroup);
            dtObject.Rows.Add(_TableName, "set", "BusinessType", BusinessType);
            dtObject.Rows.Add(_TableName, "set", "SortOrder", SortOrder);
            ...
            if (strErr == "")
            {
                Functions.AuditTrail("Company", CompanyCode,
        ...
        public string DeleteData()
        {
            ...
            if (strErr == "")
            {
                Functions.AuditTrail("Company", CompanyCode, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "DELETE");
            }
            return strErr;
        }
    }
