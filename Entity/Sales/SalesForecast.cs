...
namespace Entity
{
    public class SalesForecast
    {
        ...
        public class ForecastWorksheet
        {
            ...
            public DataTable getdetail(string yr,string itemcat,string version,string Conn)
            {
                Connection = Conn;
                ...
                try
                {
                    a = Gears.RetriveData2("select * from sales.ForecastWorksheet where year ='" + yr + "' and ItemCategoryCode = '"+itemcat+"' "+ 
                                           " and Version = '"+version+"' order by Customer",Conn);
                    return a;
                }
                catch (Exception e)
                {
            ...
            public void UpdateForecastWorksheet(ForecastWorksheet ForecastWorksheet)
            {
                ...
                DT1.Rows.Add("Sales.ForecastWorksheet", "set", "NewCreditLimit", ForecastWorksheet.NewCreditLimit);
