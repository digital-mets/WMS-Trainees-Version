...
namespace Entity
{
    public class BillingMC
    {
        ...
        public void InsertData(BillingMC _ent)
        {
        ...
        public void UpdateData(BillingMC _ent)
        {
            Conn = _ent.Connection;
            Docnum = _ent.DocNumber;
            ...
            Functions.AuditTrail("WMSBMC", Docnum, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "UPDATE", _ent.Connection); 
        }
        public void DeleteData(BillingMC _ent)
        {
            Conn = _ent.Connection;
            Docnum = _ent.DocNumber;
            ...
            Functions.AuditTrail("WMSBMC", Docnum, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "DELETE", _ent.Connection); 
        }
        #endregion
        ...
        {
            public virtual BillingMC Parent { get; set; }
            public virtual string DocNumber { get; set; }
            public virtual DateTime Date { get; set; }
            public virtual string DocOut { get; set; }
            public virtual decimal QtyOut { get; set; }
            public virtual decimal QtyPalletOut { get; set; }
            ...
            {                
                ...
                if (Convert.ToString(BillingDetail.Date) != "1/1/0001 12:00:00 AM" && BillingDetail.Date != null && Convert.ToString(BillingDetail.Date) != "")
                {
                ...
                DT1.Rows.Add("WMS.BillingDetail", "0", "QtyPalletOut", BillingDetail.QtyPalletOut);
            ...
            public void UpdateBillingDetail(BillingDetail BillingDetail)
            {
                ...
                DT1.Rows.Add("WMS.BillingDetail", "set", "QtyPalletOut", BillingDetail.QtyPalletOut);
        ...
        public class JournalEntry
        {
            ...
            public DataTable getJournalEntry(string DocNumber, string Conn)
            {
                ...
                try
                {
                    ...
                    + " AND A.AccountCode = C.AccountCode WHERE A.DocNumber = '" + DocNumber + "' AND TransType ='WMSBMC' ", Conn);
