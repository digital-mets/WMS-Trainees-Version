...
namespace Entity
{
    public class ItemMasterfileWMS
    {
        ...
        public virtual IList<ItemMasterDetailWMS> Detail { get; set; }
        public virtual IList<ItemCustomerPriceDetail> Detail2 { get; set; }
        public class ItemMasterDetailWMS
        {
            public virtual ItemMasterfileWMS Parent { get; set; }
            ...
            public void AddItemDetail(ItemMasterDetailWMS ITMDetail)
            {
                int linenum = 0;
            ...
            public void UpdateItemDetail(ItemMasterDetailWMS ITMDetail)
            {
            ...
            public void DeleteItemDetail(ItemMasterDetailWMS ITMDetail)
            {
            ...
            public void AddFabricComp(ItemMasterDetailWMS ITMDetail)
            {
                string Type = "";
            ...
            public void UpdateFabricComp(ItemMasterDetailWMS ITMDetail)
            {
                string Type = "";
                DataTable getType = Gears.RetriveData2("Select Code from it.GenericLookup where LookUpKey = 'COMTP' and Description = '" + ITMDetail.Description + "'", Conn);
                foreach (DataRow dtRow in getType.Rows)
            ...
            public void DeleteFabricComp(ItemMasterDetailWMS ITMDetail)
            {
                Gears.CRUDdatatable DT1 = new Gears.CRUDdatatable();
                DT1.Rows.Add("MasterFile.FabricCompositionDetail", "cond", "FabricCode", ITMDetail.FabricCode);
        ...
        public void InsertData(ItemMasterfileWMS _ent)
        {
            Item = _ent.ItemCode;
        ...
        public void UpdateData(ItemMasterfileWMS _ent)
        {
            Item = _ent.ItemCode;
            Conn = _ent.Connection;
        ...
        public void DeleteData(ItemMasterfileWMS _ent)
        {
            Item = _ent.ItemCode;
            Conn = _ent.Connection;
