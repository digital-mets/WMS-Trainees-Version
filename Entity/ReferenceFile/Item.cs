...
namespace Entity
{
    public class Item
    {
        ...
        public virtual IList<ItemCustomerPriceDetail> Detail3 { get; set; }
        ...
        public class ItemMasterUnit
        {
            ...
            public DataTable getdetail(string ItemCode, string Conn)
            {
                ...
                try
                {
                    ...
                    a = Gears.RetriveData2(string.Format("SELECT * FROM Masterfile.ItemUnit where ItemCode='{0}' order by LineNumber", ItemCode), Conn);
                    return a;
                }
                catch (Exception e)
                {
            ...
            public void AddItemDetail(ItemMasterUnit ITMDetail)
            {
                int linenum = 0;

                DataTable count = Gears.RetriveData2("select max(convert(int,LineNumber)) as LineNumber from Masterfile.ItemUnit where ItemCode = '" + ItemString + "'", Conn);
                ...
                DT1.Rows.Add("MasterFile.ItemUnit", "0", "ItemCode", ItemString);
                DT1.Rows.Add("MasterFile.ItemUnit", "0", "LineNumber", strLine);
                DT1.Rows.Add("MasterFile.ItemUnit", "0", "FromUnit", ITMDetail.FromUnit);
                DT1.Rows.Add("MasterFile.ItemUnit", "0", "ToUnit", ITMDetail.ToUnit);
                DT1.Rows.Add("MasterFile.ItemUnit", "0", "UnitFactor", ITMDetail.UnitFactor);

                DT2.Rows.Add("MasterFile.Item", "cond", "ItemCode", ItemString);
            ...
            public void UpdateItemDetail(ItemMasterUnit ITMDetail)
            {

                Gears.CRUDdatatable DT1 = new Gears.CRUDdatatable();
                DT1.Rows.Add("MasterFile.ItemUnit", "cond", "ItemCode", ITMDetail.ItemCode);
                DT1.Rows.Add("MasterFile.ItemUnit", "cond", "FromUnit", ITMDetail.FromUnit);
                DT1.Rows.Add("MasterFile.ItemUnit", "cond", "ToUnit", ITMDetail.ToUnit);
                DT1.Rows.Add("MasterFile.ItemUnit", "set", "FromUnit", ITMDetail.FromUnit);
                DT1.Rows.Add("MasterFile.ItemUnit", "set", "ToUnit", ITMDetail.ToUnit);
                DT1.Rows.Add("MasterFile.ItemUnit", "set", "UnitFactor", ITMDetail.UnitFactor);

                Gears.UpdateData(DT1, Conn);
            }
            public void DeleteItemDetail(ItemMasterUnit ITMDetail)
            {
                ...
                DataTable count = Gears.RetriveData2("select * from MasterFile.ItemUnit where ItemCode = '" + ItemString + "'", Conn);
        ...
        public class ItemMasterDetail
        {
            ...
            public void AddItemDetail(ItemMasterDetail ITMDetail)
            {
                ...
                DataTable count = Gears.RetriveData2("select max(convert(int,LineNumber)) as LineNumber from MasterFile.ItemDetail where ItemCode = '" + ItemString + "'", Conn);
                ...
                Gears.CRUDdatatable DT1 = new Gears.CRUDdatatable();
                Gears.CRUDdatatable DT2 = new Gears.CRUDdatatable();
                DT1.Rows.Add("MasterFile.ItemDetail", "0", "ItemCode", ItemString);
            ...
            public void DeleteItemDetail(ItemMasterDetail ITMDetail)
            {
                ...
                DataTable count = Gears.RetriveData2("select * from MasterFile.ItemDetail where ItemCode = '" + ItemString + "'", Conn);
            ...
            public void AddFabricComp(ItemMasterDetail ITMDetail)
            {
                ...
                Gears.CRUDdatatable DT1 = new Gears.CRUDdatatable();
                DT1.Rows.Add("MasterFile.FabricCompositionDetail", "0", "FabricCode", ItemString);
        ...
        public class ItemCustomerPriceDetail
        {
            ...
            {
                Gears.CRUDdatatable DT1 = new Gears.CRUDdatatable();
                DT1.Rows.Add("MasterFile.ItemCustomerPrice", "0", "ItemCode", ItemString);
            ...
            public void UpdateItemPriceDetail(ItemCustomerPriceDetail ITMDetail)
            {
                ...
                Gears.CRUDdatatable DT1 = new Gears.CRUDdatatable();
                DT1.Rows.Add("MasterFile.ItemCustomerPrice", "cond", "ItemCode", ItemString);
        ...
        public void InsertData(Item _ent)
        {
            ItemString = _ent.ItemCode;
        ...
        public void UpdateData(Item _ent)
        {
            ItemString = _ent.ItemCode;
            Conn = _ent.Connection;
		...
		DT2.Rows.Add("Masterfile.Fabric", "set", "FabricSupplier", _ent.KeySupplier);
            ...
            Functions.AuditTrail("ITMMAST", ItemString, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "UPDATE", _ent.Connection);

        }
        public void DeleteData(Item _ent)
        {
            ItemString = _ent.ItemCode;
            Conn = _ent.Connection;
            ...
            Functions.AuditTrail("ITMMAST", ItemString, LastEditedBy, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "DELETE", _ent.Connection);
        }
    }
}
